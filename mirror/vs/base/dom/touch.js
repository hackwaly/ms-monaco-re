define('vs/base/dom/touch', [
  ...
  ! function(e) {
    e.Tap = '-monaco-gesturetap', e.Change = '-monaco-gesturechange', e.Start = '-monaco-gesturestart', e.End =
      '-monaco-gesturesend';
  ...
  var r = t.EventType,
    s = function() {
      ...
      return e.prototype.dispose = function() {
        ...
        set: function(e) {
          var t = this;
          i.cAll(this.callOnTarget), this.activeTouches = {}, this._target = e, this._target && (this.callOnTarget.push(
            o.addListener(this._target, 'touchstart', function(e) {
        ...
        t.preventDefault(), o.cancelAtNextAnimationFrame(this.handle);
        ...
        for (var s = Object.keys(this.activeTouches).length, a = 0, u = t.changedTouches.length; u > a; a++) {
          ...
          if (this.activeTouches.hasOwnProperty(String(l.identifier))) {
            ...
            if (d < e.HOLD_DELAY && Math.abs(c.initialPageX - n.tail(c.rollingPageX)) < 30 && Math.abs(c.initialPageY -
              ...
              h.initialTarget = c.initialTarget, h.pageX = n.tail(c.rollingPageX), h.pageY = n.tail(c.rollingPageY),
                this._target.dispatchEvent(h);
            } else if (1 === s) {
              var p = n.tail(c.rollingPageX),
                f = n.tail(c.rollingPageY),
                g = n.tail(c.rollingTimestamps) - c.rollingTimestamps[0],
                m = p - c.rollingPageX[0],
                v = f - c.rollingPageY[0],
                y = m > 0 ? 1 : -1,
                _ = v > 0 ? 1 : -1,
                b = function(t, n, s, a, u) {
                  i.handle = o.scheduleAtNextAnimationFrame(function() {
                    var o = Date.now(),
                      ...
                      d = 0,
                      h = !0;
                    n += e.SCROLL_FRICTION * l, a += e.SCROLL_FRICTION * l, n > 0 && (h = !1, c = y * n * l), a > 0 &&
                      (h = !1, d = _ * a * l);
                    var p = e.newGestureEvent(r.Change);
                    p.translationX = c, p.translationY = d, i._target.dispatchEvent(p), h || b(o, n, s + c, a, u +
                      d);
                  });
                };
        ...
        for (var i = 0, o = t.changedTouches.length; o > i; i++) {
          ...
          if (this.activeTouches.hasOwnProperty(String(s.identifier))) {
            var a = this.activeTouches[s.identifier],
              u = (Date.now() - a.initialTimeStamp, e.newGestureEvent(r.Change));
            u.translationX = s.pageX - n.tail(a.rollingPageX), u.translationY = s.pageY - n.tail(a.rollingPageY),
              this._target.dispatchEvent(u), a.rollingPageX.length > 3 && (a.rollingPageX.shift(), a.rollingPageY.shift(),
                a.rollingTimestamps.shift()), a.rollingPageX.push(s.pageX), a.rollingPageY.push(s.pageY), a.rollingTimestamps
              .push(t.timeStamp);
          } else
            console.warn('end of an UNKNOWN touch', s);
        }
      }, e.TAP_DELAY = 500, e.HOLD_DELAY = 2000, e.SCROLL_FRICTION = -0.005, e;
    }();
  t.Gesture = s;
})