  ...
  var d = function() {
    ...
    p = function() {
      ...
      return e.prototype.consumeCharacter = function(e) {
        ...
        if (this.tagName && 'attribute' !== t)
          if (this.isClosing) {
            if (e.openElements[e.openElements.length - 1].tagName !== this.tagName)
    ...
    v = function() {
      ...
      return e.prototype.parse = function(e) {
        ...
        if ('error' === this.activeState.name)
          throw new Error(this.activeState.message);
        if (0 !== this.openElements.length)
          throw new Error('Elements not closed: ' + this.openElements.map(function(e) {
            return e.tagName;
          }).join());
        return this.root;
      }, e;
