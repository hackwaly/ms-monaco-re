...
define("vs/base/worker/workerServer", ["require", "exports", "vs/base/worker/workerProtocol"], function(e, r, s) {
  ...
  var o = function() {
    ...
    r.prototype._bindConsole = function() {
      self.console = {
    ...
    r.prototype._sendPrintMessage = function(e) {
      for (var r = [], n = 0; n < arguments.length - 1; n++) {
        r[n] = arguments[n + 1];
      }
    ...
    r.prototype.loadModule = function(r, s, t) {
      ...
      e([r], function() {
        for (var e = [], r = 0; r < arguments.length - 0; r++) {
          e[r] = arguments[r + 0];
        }
        s(e[0]);
    ...
    r.prototype.onmessage = function(e) {
      ...
      var t = this._sendReply.bind(this, e.id, s.ReplyType.COMPLETE);

      var n = this._sendReply.bind(this, e.id, s.ReplyType.ERROR);

      var o = this._sendReply.bind(this, e.id, s.ReplyType.PROGRESS);
      switch (e.type) {
        case s.MessageType.INITIALIZE:
          this._workerId = e.payload.id;
          var i = e.payload.loaderConfiguration;
          if (i) {
            if ("undefined" != typeof i.baseUrl) {
              delete i.baseUrl;
            }
          ...
          if (a) {
            self.MonacoEnvironment = a;
          }

          this.loadModule(e.payload.moduleId, function(e) {
            r._requestHandler = e.value;
    ...
    r.prototype._handleMessage = function(e, r, s, n) {
      ...
      if (e.type in this._requestHandler && "function" == typeof this._requestHandler[e.type]) try {
        ...
        this._requestHandler.request(this, r, s, n, e);
      }
    };
