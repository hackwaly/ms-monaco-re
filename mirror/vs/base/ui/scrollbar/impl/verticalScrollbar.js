define('vs/base/ui/scrollbar/impl/verticalScrollbar', [
  'require',
  'exports',
  ...
  var r = function(e) {
    function t(t, i, o) {
      var r = this,
        s = new n.ScrollbarState(o.verticalHasArrows ? o.arrowSize : 0, o.verticalScrollbarSize, o.horizontalScrollbarSize);
      if (e.call(this, i, s, o.vertical, 'vertical'), this.scrollable = t, this._createDomNode(), o.verticalHasArrows) {
        var a = (o.arrowSize - n.AbstractScrollbar.ARROW_IMG_SIZE) / 2,
          u = (o.verticalScrollbarSize - n.AbstractScrollbar.ARROW_IMG_SIZE) / 2;
    ...
    return __extends(t, e), t.prototype._createMouseWheelEvent = function(e) {
      ...
      o(this.domNode, 'width', t + 'px'), o(this.domNode, 'height', e + 'px'), o(this.domNode, 'right', '0'), o(this.domNode,
        'top', '0');
