define('vs/base/ui/scrollbar/impl/scrollableElement', [
  'require',
  'exports',
  'vs/base/dom/dom',
  ...
  'vs/base/ui/scrollbar/impl/domNodeScrollable',
  'vs/base/ui/scrollbar/impl/horizontalScrollbar',
  'vs/base/ui/scrollbar/impl/verticalScrollbar',
  'vs/base/lifecycle',
  'vs/css!./scrollbars'
  ...
  var c = 500,
    ...
    h = function() {
      function e(e, t) {
        var i = this;
        this.originalElement = e, this.originalElement.style.overflow = 'hidden', this.options = this._createOptions(
          t), this.scrollable = this.options.scrollable ? this.options.scrollable : new s.DomNodeScrollable(this.originalElement),
          this.verticalScrollbarWidth = this.options.verticalScrollbarSize, this.horizontalScrollbarHeight = this.options
          .horizontalScrollbarSize, this.verticalScrollbar = new u.VerticalScrollbar(this.scrollable, this, this.options),
          this.horizontalScrollbar = new a.HorizontalScrollbar(this.scrollable, this, this.options), this.domNode =
          document.createElement('div'), this.domNode.className = 'monaco-scrollable-element ' + this.options.className,
          this.domNode.setAttribute('aria-hidden', 'true'), this.domNode.setAttribute('role', 'presentation'), this.domNode
          .style.position = 'relative', this.domNode.style.overflow = 'hidden', this.domNode.appendChild(this.originalElement),
          this.domNode.appendChild(this.horizontalScrollbar.domNode), this.domNode.appendChild(this.verticalScrollbar
            .domNode), this.options.useShadows && (this.leftShadowDomNode = document.createElement('div'), this.leftShadowDomNode
            .className = 'shadow', this.domNode.appendChild(this.leftShadowDomNode)), this.options.useShadows && (
          ...
          this.options.listenOnDomNode || this.domNode, this.toDispose = [], this.toDispose.push(this.scrollable.addScrollListener(
            function() {
              return i._onScroll();
            })), this.options.handleMouseWheel && this.handleMouseWheel(), this.toDispose.push(n.addDisposableListener(
            this.listenOnDomNode, 'mouseover', function(e) {
          ...
          })), this.onElementDimensionsTimeout = -1, this.onElementInternalDimensionsTimeout = -1, this.hideTimeout = -
          1, this.isDragging = !1, this.mouseIsOver = !1, this.onElementDimensions(!0), this.onElementInternalDimensions(!
            0);
      }
      return e.prototype.dispose = function() {
        this.toDispose = l.disposeAll(this.toDispose), this.verticalScrollbar.destroy(), this.horizontalScrollbar.destroy(), -
          1 !== this.onElementDimensionsTimeout && (window.clearTimeout(this.onElementDimensionsTimeout), this.onElementDimensionsTimeout = -
            1), -1 !== this.onElementInternalDimensionsTimeout && (window.clearTimeout(this.onElementInternalDimensionsTimeout),
        ...
        this.onElementDimensionsTimeout = -1, this.dimensions = this._computeDimensions(), this.verticalScrollbar.onElementSize(
          this.dimensions.height), this.horizontalScrollbar.onElementSize(this.dimensions.width);
        ...
        this.onElementInternalDimensionsTimeout = -1, this.horizontalScrollbar.onElementScrollSize(this.scrollable.getScrollWidth()),
          this.verticalScrollbar.onElementScrollSize(this.scrollable.getScrollHeight());
      }, e.prototype.updateClassName = function(e) {
        this.options.className = e, o.browser.isMacintosh && (this.options.className += ' mac'), this.domNode.className =
        ...
        this.toDispose.push(n.addDisposableListener(this.listenOnDomNode, 'mousewheel', t)), this.toDispose.push(n.addDisposableListener(
          this.listenOnDomNode, 'DOMMouseScroll', t));
        ...
        if (this.options.handleMouseWheel) {
          ...
          if (e.deltaY || e.deltaX) {
            ...
            if (this.options.flipAxes && (i = e.deltaX, o = e.deltaY), i) {
              ...
              t = this.verticalScrollbar.validateScrollPosition((-1 !== t ? t : r) - d * i), t === r && (t = -1);
            }
            if (o) {
              var s = this.scrollable.getScrollLeft();
              n = this.horizontalScrollbar.validateScrollPosition((-1 !== n ? n : s) - d * o), n === s && (n = -1);
            }
        ...
        var e = this.scrollable.getScrollHeight(),
          t = this.scrollable.getScrollTop(),
          i = this.scrollable.getScrollWidth(),
          o = this.scrollable.getScrollLeft();
        if (this.verticalScrollbar.onElementScrollPosition(t), this.horizontalScrollbar.onElementScrollPosition(o),
          ...
          var r = e > 0 && t > 0,
            s = this.options.useShadows && i > 0 && o > 0;
          this.topShadowDomNode && n.toggleClass(this.topShadowDomNode, 'top', r), this.topLeftShadowDomNode && n.toggleClass(
            this.topLeftShadowDomNode, 'top', r), this.leftShadowDomNode && n.toggleClass(this.leftShadowDomNode,
            'left', s), this.topLeftShadowDomNode && n.toggleClass(this.topLeftShadowDomNode, 'left', s);
        }
        this._reveal();
        ...
        -1 !== this.hideTimeout && window.clearTimeout(this.hideTimeout), this.hideTimeout = window.setTimeout(this._hide
          .bind(this), c);
      }, e.prototype._computeDimensions = function() {
        var e = this.domNode.clientWidth,
          t = this.domNode.clientHeight,
          n = t - (this.options.verticalHasArrows ? 2 * this.options.arrowSize : 0) - this.options.horizontalScrollbarSize,
          i = e - (this.options.horizontalHasArrows ? 2 * this.options.arrowSize : 0) - this.options.verticalScrollbarSize;
        return {
          width: e,
          height: t,
        ...
        return n.horizontalSliderSize = t(e, 'horizontalSliderSize', n.horizontalScrollbarSize), n.verticalSliderSize =
          t(e, 'verticalSliderSize', n.verticalScrollbarSize), o.browser.isMacintosh && (n.className += ' mac'), n;
      }, e;
    }();
