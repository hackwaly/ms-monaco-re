define('vs/base/ui/scrollbar/impl/abstractScrollbar', [
  'require',
  'exports',
  'vs/base/dom/dom',
  ...
  function u(e, t, n, i, o) {
    null !== t && (e.style.top = a(t)), null !== n && (e.style.left = a(n)), null !== i && (e.style.bottom = a(i)),
  ...
  var c = function() {
    function e(e, t, n) {
      this.visibleSize = 0, this.scrollSize = 0, this.scrollPosition = 0, this.scrollbarSize = t, this.oppositeScrollbarSize =
        n, this.arrowSize = e, this.refreshComputedValues();
    }
    return e.prototype.setVisibleSize = function(e) {
      ...
      if (this.computedAvailableSize = Math.max(0, this.visibleSize - this.oppositeScrollbarSize), this.computedRepresentableSize =
        ...
        if (this.computedSliderSize = Math.floor(this.visibleSize * this.computedRatio), this.computedSliderPosition =
          ...
          this.computedSliderSize = e.MINIMUM_SLIDER_SIZE, this.computedSliderPosition -= t, this.computedSliderPosition +
            this.computedSliderSize > this.computedRepresentableSize && (this.computedSliderPosition = this.computedRepresentableSize -
              this.computedSliderSize), this.computedSliderPosition < 0 && (this.computedSliderPosition = 0);
        }
      } else
        this.computedSliderSize = this.computedRepresentableSize, this.computedSliderPosition = 0;
  ...
  var d = function() {
    function e(e, t, i, o, r, a, c, d, h) {
      var f = this;
      this.parent = h, this.mouseWheelEventFactory = d, this.bgDomNode = document.createElement('div'), this.bgDomNode
        .className = 'arrow-background', this.bgDomNode.style.position = 'absolute', l(this.bgDomNode, a, c), u(this.bgDomNode,
          null !== t ? 0 : null, null !== i ? 0 : null, null !== o ? 0 : null, null !== r ? 0 : null), this.domNode =
        document.createElement('div'), this.domNode.className = e, this.domNode.style.position = 'absolute', l(this.domNode,
          p.ARROW_IMG_SIZE, p.ARROW_IMG_SIZE), u(this.domNode, t, i, o, r), this.mouseMoveMonitor = new s.GlobalMouseMoveMonitor(),
        this.toDispose = [], this.toDispose.push(n.addDisposableListener(this.bgDomNode, 'mousedown', function(e) {
          return f._arrowMouseDown(e);
        })), this.toDispose.push(n.addDisposableListener(this.domNode, 'mousedown', function(e) {
          return f._arrowMouseDown(e);
        })), this.toDispose.push(this.mouseMoveMonitor), this.interval = -1, this.timeout = -1;
    }
    return e.prototype.dispose = function() {
      this.toDispose = r.disposeAll(this.toDispose), this._clearArrowTimers();
    }, e.prototype._arrowMouseDown = function(e) {
      var t = this,
        n = function() {
          t.parent.onMouseWheel(t.mouseWheelEventFactory());
        }, o = function() {
          t.interval = window.setInterval(n, 1000 / 24);
        };
      n(), this._clearArrowTimers(), this.timeout = window.setTimeout(o, 200), this.mouseMoveMonitor.startMonitoring(
        s.standardMouseMoveMerger, function() {}, function() {
          t._clearArrowTimers();
        });
      var r = new i.StandardMouseEvent(e);
      r.preventDefault();
    }, e.prototype._clearArrowTimers = function() {
      -1 !== this.interval && (window.clearInterval(this.interval), this.interval = -1), -1 !== this.timeout && (
        window.clearTimeout(this.timeout), this.timeout = -1);
    }, e;
  }(),
    h = function() {
      function e(e, t, n) {
        this.visibility = e, this.visibleClassName = t, this.invisibleClassName = n, this.domNode = null, this.isVisible = !
      ...
      return e.prototype.dispose = function() {
        ...
        this.domNode = e, this.domNode.className = this.invisibleClassName, this.domNode.style.display = 'none', this
          .setShouldBeVisible(!1);
      }, e.prototype.ensureVisibility = function() {
        return this.isNeeded ? (this.shouldBeVisible ? this._reveal() : this._hide(!0), void 0) : (this._hide(!1),
          void 0);
    ...
    p = function() {
      function e(e, t, n, i) {
        this.parent = e, this.scrollbarState = t, this.visibilityController = new h(n, 'visible scrollbar ' + i,
          'invisible scrollbar ' + i), this.mouseMoveMonitor = new s.GlobalMouseMoveMonitor(), this.toDispose = [],
          this.toDispose.push(this.visibilityController), this.toDispose.push(this.mouseMoveMonitor);
      }
      return e.prototype._createDomNode = function() {
        var e = this;
        this.domNode = document.createElement('div'), this.visibilityController.setDomNode(this.domNode), this.domNode
          .style.position = 'absolute', this.toDispose.push(n.addDisposableListener(this.domNode, 'mousedown',
            function(t) {
              return e._domNodeMouseDown(t);
            }));
      }, e.prototype._createArrow = function(e, t, n, i, o, r, s, a) {
        var u = new d(e, t, n, i, o, r, s, a, this.parent);
        this.domNode.appendChild(u.bgDomNode), this.domNode.appendChild(u.domNode), this.toDispose.push(u);
        ...
        this.slider = document.createElement('div'), this.slider.className = 'slider', this.slider.style.position =
          'absolute', u(this.slider, e, t, null, null), l(this.slider, i, o), this.domNode.appendChild(this.slider),
        ...
        this.scrollbarState.setVisibleSize(e) && (this._renderDomNode(this.scrollbarState.getRectangleLargeSize(),
          this.scrollbarState.getRectangleSmallSize()), this._renderSlider(), this.visibilityController.setIsNeeded(
          this.scrollbarState.isNeeded()));
        ...
        this.scrollbarState.setScrollPosition(e) && (this._renderSlider(), this.visibilityController.setIsNeeded(this
          .scrollbarState.isNeeded()));
        ...
        var t = new i.StandardMouseEvent(e),
          o = n.getDomNodePosition(this.domNode),
          r = this._mouseDownRelativePosition(t, o) - this.scrollbarState.getArrowSize() - this.scrollbarState.getSliderSize() /
            2;
        this.setDesiredScrollPosition(this.scrollbarState.convertSliderPositionToScrollPosition(r)), this._sliderMouseDown(
          e);
      }, e.prototype._sliderMouseDown = function(e) {
        var t = this,
          o = new i.StandardMouseEvent(e);
        if (o.leftButton) {
          var r = this._sliderMousePosition(o) - this.scrollbarState.getSliderPosition();
          n.toggleClass(this.slider, 'active', !0), this.mouseMoveMonitor.startMonitoring(s.standardMouseMoveMerger,
            function(e) {
              var n = t._sliderMousePosition(e) - r;
              t.setDesiredScrollPosition(t.scrollbarState.convertSliderPositionToScrollPosition(n));
            }, function() {
              n.toggleClass(t.slider, 'active', !1), t.parent.onDragEnd();
            }), o.preventDefault(), this.parent.onDragStart();
        }
      }, e.prototype.validateScrollPosition = function(e) {
      ...
      }, e.prototype._renderDomNode = function() {}, e.prototype._updateSlider = function() {}, e.prototype._mouseDownRelativePosition =
        function() {
          return 0;
      }, e.prototype._sliderMousePosition = function() {
        return 0;
      }, e.prototype._setScrollPosition = function() {}, e.ARROW_IMG_SIZE = 11, e;
    }();
