define('vs/base/ui/scrollbar/impl/horizontalScrollbar', [
  'require',
  'exports',
  'vs/base/ui/scrollbar/impl/abstractScrollbar',
  ...
  var r = function(e) {
    function t(t, i, o) {
      var r = this,
        s = new n.ScrollbarState(o.horizontalHasArrows ? o.arrowSize : 0, o.horizontalScrollbarSize, o.verticalScrollbarSize);
      if (e.call(this, i, s, o.horizontal, 'horizontal'), this.scrollable = t, this._createDomNode(), o.horizontalHasArrows) {
        var a = (o.arrowSize - n.AbstractScrollbar.ARROW_IMG_SIZE) / 2,
          u = (o.horizontalScrollbarSize - n.AbstractScrollbar.ARROW_IMG_SIZE) / 2;
    ...
    return __extends(t, e), t.prototype._createMouseWheelEvent = function(e) {
      ...
      o(this.domNode, 'width', e + 'px'), o(this.domNode, 'height', t + 'px'), o(this.domNode, 'left', '0'), o(this.domNode,
        'bottom', '0');
