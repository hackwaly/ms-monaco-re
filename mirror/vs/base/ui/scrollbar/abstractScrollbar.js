define(["require", "vs/base/lib/winjs.base", "vs/base/env", "vs/base/dom/dom", "vs/base/dom/mouseEvent"], function(a, b) {
  ...
  function h(a, b, c, d, e) {
    b !== null && (a.style.top = g(b));
    c !== null && (a.style.left = g(c));
    d !== null && (a.style.bottom = g(d));
    e !== null && (a.style.right = g(e))
  }

  function i(a, b, c) {
    b !== null && (a.style.width = g(b));
    c !== null && (a.style.height = g(c))
  }
  var c = 20;
  var d = a("vs/base/env");
  ...
  var j = b.Class.define(function(b, c, d, e, f) {
    this.listenersToRemove = [], this.scrollable = b, this.parent = c, this.options = d, this.visibility = e, this.hasArrows =
      f, this._hookUnbind = [], this.isDragging = !1, this.scrollPosition = 0, this.scrollSize = 0, this.sliderSize =
      0, this.sliderPosition = 0, this.isNeeded = !1, this.isVisible = !1, this.shouldBeVisible = !1, this.ARROW_ID =
      0, this.arrowIntervals = {}, this.arrowTimeouts = {}, this.hideTimeout = -1
  }, {
    ARROW_IMG_SIZE: 11,
    ...
    _createArrow: function(a, b, c, d, f, g) {
      ...
      return j.className = a, j.style.position = "absolute", i(j, this.ARROW_IMG_SIZE, this.ARROW_IMG_SIZE), h(j, b,
        c, d, f), this.ARROW_ID++, this.listenersToRemove.push(e.addListener(j, "mousedown", this._arrowMouseDown.bind(
        this, this.ARROW_ID, g))), this.listenersToRemove.push(e.addListener(j, "mouseup", this._arrowMouseUp.bind(
        this, this.ARROW_ID))), this.arrowIntervals[this.ARROW_ID] = -1, this.arrowTimeouts[this.ARROW_ID] = -1,
        this.domNode.appendChild(j), j
    },
    ...
    _createSlider: function(a, b) {
      this.slider = document.createElement("div"), this.slider.className = "slider", this.slider.style.position =
        "absolute", this.slider.style.left = 0, i(this.slider, a, b), this.domNode.appendChild(this.slider), this.listenersToRemove
        .push(e.addListener(this.slider, "mousedown", this._sliderMouseDown.bind(this)))
    },
    destroy: function() {
    ...
    _renderSlider: function() {
      this.isNeeded = this.scrollSize > this.visibleSize, this.isNeeded || (this._hide(), this.isVisible = !1, this
        .domNode.style.display = "none"), this.sliderSize = Math.floor(this.visibleSize * this.ratio);
      var a = 0,
        b;
