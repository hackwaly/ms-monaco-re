define(["vs/base/lib/winjs.base", "./abstractScrollbar", "vs/base/dom/mouseEvent"], function(a, b, c) {
  ...
  var d = b.AbstractScrollbar,
    f = a.Class.derive(d, function(b, c, e) {
      ...
      if (this.options.verticalHasArrows) {
        ...
        this.topArrow = this._createArrow("up-arrow", f, g, null, null, this._createMouseWheelEvent.bind(this, 1)),
          this.bottomArrow = this._createArrow("down-arrow", null, g, f, null, this._createMouseWheelEvent.bind(
            this, -1))
      }
      ...
      _renderDomNode: function() {
        this.domNode.style.width = e(Math.max(0, this._getScrollbarSize())), this.domNode.style.height = e(Math.max(
          0, this.visibleSize - this._getOppositeScrollbarSize())), this.domNode.style.right = "0", this.domNode.style
          .top = "0"
      },
