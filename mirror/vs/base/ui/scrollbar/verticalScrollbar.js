define(["vs/base/lib/winjs.base", "./abstractScrollbar", "vs/base/dom/mouseEvent"], function(a, b, c) {
  ...
  var f = a.Class.derive(d, function(b, c, e) {
    d.call(this, b, c, e, e.vertical, e.verticalHasArrows);
    ...
    this._createSlider(this._getScrollbarSize(), null);
    ...
    _updateSlider: function(a, b) {
      this.slider.style.height = e(a);

      this.slider.style.top = e(b);
    },
    _renderDomNode: function() {
      this.domNode.style.width = e(Math.max(0, this._getScrollbarSize()));

      this.domNode.style.height = e(Math.max(0, this.visibleSize - this._getOppositeScrollbarSize()));
