define(["vs/base/lib/winjs.base", "./abstractScrollbar", "vs/base/dom/mouseEvent"], function(a, b, c) {
  ...
  var f = a.Class.derive(d, function(b, c, e) {
    d.call(this, b, c, e, e.horizontal, e.horizontalHasArrows);

    this._createDomNode();
    if (this.options.horizontalHasArrows) {
      var f = (this.options.arrowSize - this.ARROW_IMG_SIZE) / 2;

      var g = (this._getScrollbarSize() - this.ARROW_IMG_SIZE) / 2;
    ...
    this._createSlider(null, this._getScrollbarSize());
    ...
    _updateSlider: function(a, b) {
      this.slider.style.width = e(a);

      this.slider.style.left = e(b);
    },
    _renderDomNode: function() {
      this.domNode.style.width = e(Math.max(0, this.visibleSize - this._getOppositeScrollbarSize()));

      this.domNode.style.height = e(Math.max(0, this._getScrollbarSize()));
