    ...
    f = a.Class.derive(d, function(b, c, e) {
      ...
      if (this.options.horizontalHasArrows) {
        ...
        this.leftArrow = this._createArrow("left-arrow", g, f, null, null, this._createMouseWheelEvent.bind(this, 1)),
          this.rightArrow = this._createArrow("right-arrow", g, null, null, f, this._createMouseWheelEvent.bind(
            this, -1))
      }
      ...
      _renderDomNode: function() {
        this.domNode.style.width = e(Math.max(0, this.visibleSize - this._getOppositeScrollbarSize())), this.domNode
          .style.height = e(Math.max(0, this._getScrollbarSize())), this.domNode.style.left = "0", this.domNode.style
          .bottom = "0"
      },
