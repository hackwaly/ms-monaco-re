define(["require", "vs/base/lib/winjs.base", "vs/css!./scrollbars", "vs/base/env", "vs/base/objects", "vs/base/dom/dom",
  ...
  var c = a("vs/base/env"),
    ...
    g = a("./domNodeScrollable").DomNodeScrollable,
    h = a("./verticalScrollbar").VerticalScrollbar,
    i = a("./horizontalScrollbar").HorizontalScrollbar,
    j = 500,
    k = 50,
    l = {
      useNative: !1,
      ...
      useShadows: !0,
      handleMouseWheel: !0
    }, m = b.Class.define(function(b, c) {
      this.originalElement = b, this.originalElement.style.overflow = "hidden", this.options = this._createOptions(
        c), this.scrollable = this.options.scrollable ? this.options.scrollable : new g(this.originalElement), this
        .verticalScrollbarWidth = this.options.verticalScrollbarSize, this.horizontalScrollbarHeight = this.options
        .horizontalScrollbarSize, this.verticalScrollbar = new h(this.scrollable, this, this.options), this.horizontalScrollbar =
        new i(this.scrollable, this, this.options), this.domNode = document.createElement("div"), this.domNode.className =
        "monaco-scrollable-element " + this.options.className, this.domNode.setAttribute("aria-hidden", "true"),
        this.domNode.setAttribute("role", "presentation"), this.domNode.style.position = "relative", this.domNode.style
        .overflow = "hidden", this.domNode.appendChild(this.originalElement), this.domNode.appendChild(this.horizontalScrollbar
          .domNode), this.domNode.appendChild(this.verticalScrollbar.domNode), this.options.useShadows && (this.leftShadowDomNode =
          document.createElement("div"), this.leftShadowDomNode.className = "shadow", this.domNode.appendChild(this
            .leftShadowDomNode), this.topShadowDomNode = document.createElement("div"), this.topShadowDomNode.className =
      ...
      ), this.listenOnDomNode = this.options.listenOnDomNode || this.domNode, this.listenersToRemove = [], this.listenersToRemove
        .push(this.scrollable.addListener("scroll", this._onScroll.bind(this))), this.options.handleMouseWheel &&
        this.handleMouseWheel(), this.listenersToRemove.push(e.addListener(this.listenOnDomNode, "mouseover", this._onMouseOver
          .bind(this))), this.listenersToRemove.push(e.addNonBubblingMouseOutListener(this.listenOnDomNode, this._onMouseOut
          .bind(this))), this.onElementDimensionsTimeout = -1, this.onElementInternalDimensionsTimeout = -1, this.isDragging = !
        1, this.mouseIsOver = !1, this.onElementDimensions(!0), this.onElementInternalDimensions(!0)
    }, {
      destroy: function() {
        this.listenersToRemove.forEach(function(a) {
          a()
        }), this.listenersToRemove = [], this.verticalScrollbar.destroy(), this.horizontalScrollbar.destroy(), this
          .onElementDimensionsTimeout !== -1 && (window.clearTimeout(this.onElementDimensionsTimeout), this.onElementDimensionsTimeout = -
            1), this.onElementInternalDimensionsTimeout !== -1 && (window.clearTimeout(this.onElementInternalDimensionsTimeout),
      ...
      _beginHide: function() {
        this.hideTimeout !== -1 && window.clearTimeout(this.hideTimeout), this.hideTimeout = window.setTimeout(this
          ._hide.bind(this), j)
      },
