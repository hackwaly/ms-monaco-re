define('vs/base/eventEmitter', [
  ...
  var o = function() {
    ...
    return e.prototype.dispose = function() {
      ...
      if (this._allowedEventTypes && !this._allowedEventTypes.hasOwnProperty(e))
      ...
      if (this._listeners.hasOwnProperty(e))
        for (var i = this._listeners[e].slice(0), o = 0, r = i.length; r > o; o++)
          try {
            i[o](t);
          } catch (s) {
      ...
      for (var t = this._bulkListeners.slice(0), i = 0, o = t.length; o > i; i++)
        try {
          t[i](e);
        } catch (r) {
