...
! function(e) {
  var t = _cssPluginGlobal,
    n = function() {
      ...
      return e.prototype.attachListeners = function(e, t, n, r) {
        ...
        t.addEventListener("load", s), t.addEventListener("error", i)
        ...
        s.setAttribute("rel", "stylesheet"), s.setAttribute("type", "text/css"), s.setAttribute("data-name", e);
        var i = function() {
          return o._onLoad(e, n)
        }, a = function(t) {
            return o._onLoadError(e, r, t)
          };
        return this.attachListeners(e, s, i, a), s.setAttribute("href", t), s
      }, e.prototype._linkTagExists = function(e, t) {
        var n, r, o, s, i = document.getElementsByTagName("link");
    ...
    r = function(e) {
      ...
      return __extends(t, e), t.prototype.load = function(e, t, n, r) {
        ...
        var s = o.length,
          i = Math.min(Math.floor(s / 2), t);
        o.sort(function(e, t) {
          return t.rulesLength - e.rulesLength
        });
        var a, l;
        for (e = 0; i > e; e++) a = o.length - 1 - e, l = e % (o.length - i), this._mergeStyleSheet(o[l].linkNode.href,
          o[l].linkNode.styleSheet, o[a].linkNode.href, o[a].linkNode.styleSheet), o[a].linkNode.parentNode.removeChild(
          o[a].linkNode), r--;
    ...
    o = function(e) {
      ...
      return __extends(t, e), t.prototype.attachListeners = function(e, t, n) {
        t.onload = function() {
          t.onload = null, n()
        }
      }, t
    ...
    s = function() {
      ...
      return e.prototype.load = function(t, n, r) {
        ...
        o.charCodeAt(0) === e.BOM_CHAR_CODE && (o = o.substring(1)), r(o)
    ...
    i = function() {
      ...
      return e.prototype.load = function(t, n, r, o) {
        ...
        t.entryPoints = t.entryPoints || {}, t.entryPoints[s] = t.entryPoints[s] || [], t.entryPoints[s].push({
          moduleName: r,
  ...
  var a = function() {
    ...
    return e.startsWith = function(e, t) {
      ...
      function s(e, t) {
        for (; t.length > 0;) {
          var n = t.indexOf("/"),
            r = n >= 0 ? t.substring(0, n + 1) : t;
          t = n >= 0 ? t.substring(n + 1) : "", o(e, r)
        }
      }
      var i = 0;
      i = i || r(t, "//"), i = i || r(t, "http://"), i = i || r(t, "https://");
      var a = [];
      return s(a, t.substr(i)), n.length > 0 && "/" === n.charAt(0) && (a = []), s(a, n), t.substring(0, i) + a.join("")
  ...
  function() {
    ...
    e = "undefined" != typeof process && process.versions && process.versions.node ? new s : navigator.userAgent.indexOf(
      "MSIE 9") >= 0 ? new r : navigator.userAgent.indexOf("MSIE 8") >= 0 ? new o : new n, define("vs/css", new i(e))
  }()
