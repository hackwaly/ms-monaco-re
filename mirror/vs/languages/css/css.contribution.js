define('vs/languages/css/css.contribution', [
  'require',
  'exports',
  ...
  l.registerMode(['text/css'], new i.DeferredDescriptor('vs/languages/css/css', 'CSSMode')), u.enableGlobalCSSRuleChecker &&
    l.registerWorkerParticipant('vs.languages.css', new i.DeferredDescriptor('vs/languages/css/monacoParticipant',
      'WorkerParticipant')), i.Registry.as(r.Extensions.EditorContributions).registerEditorContribution(new i.BaseDescriptor(
      a.ColorContribution));
