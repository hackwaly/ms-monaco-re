define('vs/languages/typescript/lint/rules/javascript', [
  'require',
  'exports',
  'vs/base/strings',
  'vs/base/collections',
  ...
  var s = function() {
    function e() {
      this.code = 'SA9005', this.name = 'ComparisonOperatorsNotStrict', this.filter = [
        o.SyntaxKind.EqualsEqualsToken,
  ...
  var p = function() {
    function e() {
      this.code = 'SA9054', this.name = 'SemicolonsInsteadOfBlocks', this.filter = [
        o.SyntaxKind.IfStatement,
        o.SyntaxKind.ElseClause,
        o.SyntaxKind.WhileStatement,
        o.SyntaxKind.ForStatement,
  ...
  var h = function() {
    function e() {
      this.code = 'SA9055', this.name = 'FunctionsInsideLoops', this.filter = [
        o.SyntaxKind.FunctionExpression,
        o.SyntaxKind.FunctionDeclaration,
        o.SyntaxKind.SimpleArrowFunctionExpression,
