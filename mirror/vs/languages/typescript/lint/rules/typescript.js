define('vs/languages/typescript/lint/rules/typescript', [
  'require',
  'exports',
  'vs/base/strings',
    ...
    return e.prototype.checkElement = function(e, t) {
      ...
      if (!(i.length > 5)) {
        for (var o = 0, s = 0, a = 0, l = 0, c = i.length; c > l; l++)
          o = Math.max(o, n.difference('reference', i[l])), s = Math.max(s, n.difference('path', i[l])), a = Math.max(
            a, (n.startsWith(i[l], '"') || n.startsWith(i[l], '\'') ? 1 : 0) + (n.endsWith(i[l], '"') || n.endsWith(i[
              l], '\'') ? 1 : 0));
  ...
  var c = function() {
    function e() {
      this.code = 'SA9060', this.name = 'UnusedMembers', this.filter = [
        r.SyntaxKind.MemberVariableDeclaration,
        r.SyntaxKind.MemberFunctionDeclaration
      ];
    }
    return e.prototype.checkElement = function(e, t) {
      var n;
      if (e instanceof r.MemberVariableDeclarationSyntax) {
        if (!r.SyntaxUtilities.containsToken(e.modifiers, r.SyntaxKind.PrivateKeyword))
          return;
