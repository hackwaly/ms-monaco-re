define('vs/languages/typescript/lint/lint', [
  'require',
  'exports',
  ...
  var d = function() {
    ...
    return e.prototype._addRule = function(e) {
      ...
      if (e) {
        if (e.isToken()) {
          ...
          for (var r = 0, i = t.count(); i > r; r++)
            this._currentTrivia = t.syntaxTriviaAt(r), this._checkNodeOrToken(this._currentTrivia), r !== n ? this._currentTriviaPosition +=
              this._currentTrivia.fullWidth() : this._currentTriviaPosition = this.end(e) - e.trailingTriviaWidth();
      ...
      for (var t = e.kind(), n = o.lookup(this._rules, t, []).concat(o.lookup(this._rules, -1, [])), r = 0, i = n.length; i >
        r; r++)
        if (this._currentSeverity = n[r].severity, 0 !== this._currentSeverity)
          try {
