...
define("vs/languages/vsxml/vsxml", ["require", "exports", "vs/base/objects", "vs/base/errors",
  ...
  var o = '<>"=/',
    s = "	 ",
    a = n.createKeywordMatcher(["summary", "reference", "returns", "param", "loc"]),
    l = n.createKeywordMatcher(["type", "path", "name", "locid", "filename", "format", "optional"]),
  ...
  function s(e, t, n) {
    var o, s, a = i.findIndexInSegmentsArray(t, n),
      l = t[a];
...
define("vs/languages/typescript/typescript", ["require", "exports", "vs/editor/modes/autoIndentation/autoIndentation",
  ...
  ! function(e) {
    ! function(e) {
      e[e.Start = 0] = "Start", e[e.InMultiLineCommentTrivia = 1] = "InMultiLineCommentTrivia", e[e.InDocMultiLineCommentTrivia =
        2] = "InDocMultiLineCommentTrivia", e[e.InSingleQuoteStringLiteral = 3] = "InSingleQuoteStringLiteral", e[e.InDoubleQuoteStringLiteral =
        4] = "InDoubleQuoteStringLiteral"
    }(e.EndOfLineState || (e.EndOfLineState = {}));
    var t = (e.EndOfLineState, []);
    t[a.SyntaxKind.IdentifierName] = !0, t[a.SyntaxKind.StringLiteral] = !0, t[a.SyntaxKind.NumericLiteral] = !0, t[a
      .SyntaxKind.RegularExpressionLiteral] = !0, t[a.SyntaxKind.ThisKeyword] = !0, t[a.SyntaxKind.PlusPlusToken] = !
      0, t[a.SyntaxKind.MinusMinusToken] = !0, t[a.SyntaxKind.CloseParenToken] = !0, t[a.SyntaxKind.CloseBracketToken] = !
      0, t[a.SyntaxKind.CloseBraceToken] = !0, t[a.SyntaxKind.TrueKeyword] = !0, t[a.SyntaxKind.FalseKeyword] = !0;
    var n = function() {
      function e() {
        this.characterWindow = a.ArrayUtilities.createArray(2048, 0), this.diagnostics = []
      }
      return e.prototype.getClassificationsForLine = function(e, n) {
        var i = 0;
        0 !== n && (4 === n ? e = '"\\\n' + e : 3 === n ? e = "'\\\n" + e : 1 === n ? e = "/*\n" + e : 2 === n && (e =
          "/**\n" + e), i = 3);
        var o = new r;
        ...
        for (var s = a.SyntaxKind.None; this.scanner.absoluteIndex() < e.length;) {
          ...
          s = l.tokenKind, this.processToken(e, i, l, o)
        }
        return o
        ...
        if (this.processTriviaList(e, t, n.leadingTrivia(), r), this.addResult(e, t, r, n.width(), n.tokenKind, n.valueText()),
          ...
          if (this.diagnostics.length > 0 && this.diagnostics[this.diagnostics.length - 1].diagnosticKey() === a.DiagnosticCode
            .AsteriskSlash_expected) return r.finalLexState = -1 !== e.indexOf("/**") ? 2 : 1, void 0;
          if (n.tokenKind === a.SyntaxKind.StringLiteral) {
            var i = n.text();
            if (i.length > 0 && 92 === i.charCodeAt(i.length - 1)) {
              var o = i.charCodeAt(0);
              return r.finalLexState = 34 === o ? 4 : 3, void 0
            }
          }
        }
  ...
  var h = t.TypeScriptClassifier,
    d = function(e) {
      function t(t, n, r, i) {
        e.call(this, t), this.lineTokens = n, this.vsState = r, this.classifier = new h.Classifier, this.endOfLineState =
          i
      }
  ...
  var m = function() {
    ...
    f = function(e) {
      function t() {
        ...
        var t = new m(this);
        this.referenceSupport = t, this.navigateTypesSupport = t, this.extraInfoSupport = t, this.formattingSupport =
          t, this.declarationSupport = t, this.quickFixSupport = t, this.logicalSelectionSupport = t, this.parameterHintsSupport =
          this, this.outlineSupport = this
      }
      return __extends(t, e), t.prototype._newCustomWorker = function(t) {
        return "undefined" == typeof t && (t = {}), c.browser.hasWorkers && this._options && this._options.allowMultipleWorkers ?
          (this.smallWorker = e.prototype._newCustomWorker.call(this, {
          ...
          semanticValidation: !0,
          validateAllFiles: !0
        }, "ts-1"), this.smallWorker = this.bigWorker), this.smallWorker
        ...
        var i = u.findIndexInSegmentsArray(n, r - 1),
          o = n[i];
        return o ? o.type.indexOf("string") > -1 ? '"' !== e && "'" !== e : o.type.indexOf("comment") > -1 ? "'" !==
          e : !0 : !0
