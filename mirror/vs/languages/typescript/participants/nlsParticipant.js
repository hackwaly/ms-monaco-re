...
define("vs/languages/typescript/participants/nlsParticipant", ["require", "exports",
  ...
  var a = function(e) {
    function t(t) {
      e.call(this), this._markers = t
    }
    return __extends(t, e), t.prototype.visitToken = function(i) {
      ...
      i.kind() === s.SyntaxKind.StringLiteral && i.text().charCodeAt(0) === t._DoubleQuote && this._markers.push(o.createTextMarker(
        r.Severity.Info, 0, n.localize("vs_languages_typescript_participants_nlsParticipant", 0), a, l)), e.prototype
        .visitToken.call(this, i)
    ...
    l = function() {
      ...
      return e.prototype.validate = function(e, t, n) {
        var r = this;
        this._markers.length = 0, n.sourceUnit().accept(new a(this._markers)), t.changeMarkers(e.getAssociatedResource(),
          function(e) {
            r._markers.forEach(function(t) {
              return e.addMarker(t)
            })
          })
      }, e.ID = "vs.languages.typescript.nlsParticipant", e
    }();
