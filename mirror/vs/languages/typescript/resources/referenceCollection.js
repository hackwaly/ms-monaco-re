...
define(["require", "exports", "vs/languages/typescript/service/references", "vs/editor/worker/resourceService",
  ...
  "use strict";
  var references = __references__var resourceService = __resourceService__var winjs = __winjs__var emitter =
    __emitter__var constants = __constants__var MirrorModelListener = function(_super) {
  ...
  }(emitter.EventEmitter) exports.MirrorModelListener = MirrorModelListenervar ReferencesState = function(_super) {
  ...
  }(MirrorModelListener) exports.ReferencesState = ReferencesState
})