...
define("vs/base/time/schedulers", ["require", "exports"], function(e, t) {
  ...
  function o() {
    ...
    return r && n.splice(1, 0, ""), i && n.unshift(""), n.join("/")
  }

  function s(e) {
    return "/" === e[0]
  }
  t.normalize = n, t.dirname = r, t.basename = i, t.join = o, t.isAbsolute = s
  ...
  var i = function() {
    ...
    return e.prototype.isNoop = function() {
      ...
      for (t = 0, n = this.children.length; n > t; t++)
        if (r = this.children[t], r.enclosedBy(e)) this.removeChild(r), e.insert(r), n--, t--;
        else if (r.encloses(e)) return r.insert(e), this;
  ...
  var o = function() {
    ...
    return e.prototype.replace = function(e, t, n) {
      ...
      for (var e, t = this.model.getValue();
        (e = this.edit.getRightMostChild()) !== this.edit;) t = n.splice(t, e.offset, e.length, e.text), e.parent.length +=
        e.text.length - e.length, e.remove();
      return t
    }, e
  }();
  t.create = r
...
define("vs/languages/typescript/resources/remoteModels", ["require", "exports", "vs/editor/core/model/mirrorModel"],
  function(e, t, n) {
    ...
    t.DefaultLibModel = i
  }), define("vs/languages/lib/javascriptSnippets", ["require", "exports",
...
}), define("vs/languages/typescript/lint/rules", ["require", "exports",
  ...
  var i = function() {
    function e() {
      this.code = "SA1503", this.name = "CurlyBracketsMustNotBeOmitted", this.filter = [r.SyntaxKind.IfStatement, r.SyntaxKind
        .ElseClause, r.SyntaxKind.DoStatement, r.SyntaxKind.ForInStatement, r.SyntaxKind.ForStatement, r.SyntaxKind.WhileStatement
      ]
    }
  ...
  var i = function() {
    function e() {
      this.code = "SA9002", this.name = "FunctionsWithoutReturnType", this.filter = [r.SyntaxKind.CallSignature]
    }
    return e.prototype.checkElement = function(e, t) {
      if (!e.typeAnnotation) {
        var n = t.parent(e);
  ...
  var o = function() {
    function e() {
      this.code = "SA9056", this.name = "TripleSlashReferenceAlike", this.filter = [r.SyntaxKind.SingleLineCommentTrivia]
    }
    return e.prototype.checkElement = function(e, t) {
      ...
      if (!(i.length > 5)) {
        for (var o = 0, s = 0, a = 0, l = 0, c = i.length; c > l; l++) o = Math.max(o, n.difference("reference", i[l])),
          s = Math.max(s, n.difference("path", i[l])), a = Math.max(a, (n.startsWith(i[l], '"') || n.startsWith(i[l],
            "'") ? 1 : 0) + (n.endsWith(i[l], '"') || n.endsWith(i[l], "'") ? 1 : 0));
        return (a > 0 || s > 5) && o > 5 ? !0 : !1
      }
    }, e._TripleSlashReference = /^(\/\/\/\s*<reference\s+path=)('|")(.+?)\2\s*(static=('|")(.+?)\2\s*)*/im, e
  }();
  t.TripleSlashReferenceAlike = o;
  var s = function() {
    function e() {
      this.code = "SA9057", this.name = "UnusedImports", this.filter = [r.SyntaxKind.ImportDeclaration]
    }
    return e.prototype.checkElement = function(e, t) {
      var n = t.end(e.identifier) - 1,
        r = t.languageService().getOccurrencesAtPosition(t.filename(), n);
  ...
  var a = function() {
    function e() {
      this.code = "SA9058", this.name = "UnusedVariables", this.filter = [r.SyntaxKind.VariableStatement]
    }
    return e.prototype.checkElement = function(e, t) {
        ...
        for (var n, i = e.variableDeclaration.variableDeclarators, o = 0, s = i.childCount(); s > o; o++)
          if (i.childAt(o) instanceof r.VariableDeclaratorSyntax) {
            ...
            var a = t.end(n.propertyName) - 1,
              l = t.languageService().getOccurrencesAtPosition(t.filename(), a);
            if (l.length <= 1) {
              var a = void 0,
                c = void 0;
              n.typeAnnotation && (a = t.start(n.propertyName), c = t.end(n.typeAnnotation) - a), t.reportError(n.propertyName,
                this.name, this.code, a, c)
            }
          }
    }, e
  }();
  ...
  var l = function() {
    function e() {
      this.code = "SA9059", this.name = "UnusedFunctions", this.filter = [r.SyntaxKind.FunctionDeclaration]
    }
    return e.prototype.checkElement = function(e, t) {
      if (!r.SyntaxUtilities.containsToken(e.modifiers, r.SyntaxKind.ExportKeyword) && !r.SyntaxUtilities.containsToken(
        e.modifiers, r.SyntaxKind.DeclareKeyword)) {
        var n = e.identifier,
          i = t.end(n) - 1,
          o = t.languageService().getOccurrencesAtPosition(t.filename(), i);
  ...
  var c = function() {
    function e() {
      this.code = "SA9060", this.name = "UnusedMembers", this.filter = [r.SyntaxKind.MemberVariableDeclaration, r.SyntaxKind
  ...
  t.UnusedMembers = c
}), define("vs/languages/typescript/lint/rules/javascript", ["require", "exports", "vs/base/strings",
  "vs/base/collections", "vs/languages/typescript/lint/rules", "vs/languages/typescript/lib/typescriptServices"
], function(e, t, n, r, i, o) {
  var s = function() {
    function e() {
      this.code = "SA9005", this.name = "ComparisonOperatorsNotStrict", this.filter = [o.SyntaxKind.EqualsEqualsToken,
        o.SyntaxKind.ExclamationEqualsToken
      ]
    }
    return e.prototype.checkElement = function(e, t) {
  ...
  var a = function() {
    function e() {
      this.code = "SA9050", this.name = "MissingSemicolon", this.filter = [o.SyntaxKind.SemicolonToken]
    }
    return e.prototype.checkElement = function(e, t) {
  ...
  var l = function() {
    function e() {
      this.code = "SA9051", this.name = "ReservedKeywords"
    }
    return e.prototype.checkElement = function(e, t) {
  ...
  var c = function() {
    function e() {
      this.code = "SA9052", this.name = "TypeScriptSpecifics"
    }
    return e.prototype.checkElement = function(e, t) {
  ...
  var u = function() {
    function e() {
      this.code = "SA9053", this.name = "UnknownTypeOfResults"
    }
    return e.prototype.checkElement = function(t, s) {
      if (t instanceof o.BinaryExpressionSyntax) {
        ...
        if (i.syntaxHelper.isOfKind(a.left, o.SyntaxKind.TypeOfExpression)) {
          ...
          if (a.right.kind() === o.SyntaxKind.StringLiteral) {
            ...
            c = n.trim(c, "'"), c = n.trim(c, '"'), l = !r.contains(e._AllowedStrings, c)
  ...
  var p = function() {
    function e() {
      this.code = "SA9054", this.name = "SemicolonsInsteadOfBlocks", this.filter = [o.SyntaxKind.IfStatement, o.SyntaxKind
        .ElseClause, o.SyntaxKind.WhileStatement, o.SyntaxKind.ForStatement, o.SyntaxKind.ForInStatement
      ]
    }
    return e.prototype.checkElement = function(e, t) {
  ...
  var h = function() {
    function e() {
      this.code = "SA9055", this.name = "FunctionsInsideLoops", this.filter = [o.SyntaxKind.FunctionExpression, o.SyntaxKind
        .FunctionDeclaration, o.SyntaxKind.SimpleArrowFunctionExpression, o.SyntaxKind.ParenthesizedArrowFunctionExpression
      ]
    }
    return e.prototype.checkElement = function(e, t) {
  ...
  var d = function() {
    function e() {
      this.code = "SA9062", this.name = "NewOnLowercaseFunctions", this.filter = [o.SyntaxKind.ObjectCreationExpression]
    }
    return e.prototype.checkElement = function(e, t) {
      var n;
      n = e.expression instanceof o.MemberAccessExpressionSyntax ? e.expression.name.fullText() : i.syntaxHelper.text(
        e.expression), n && !n.charAt(0).match(/[A-Z_]/) && t.reportError(e.expression, this.name, this.code)
    }, e
  }();
...
define("vs/languages/typescript/lint/lint", ["require", "exports", "vs/nls!vs/languages/typescript/typescriptWorker2",
  ...
  var d = function() {
    function e(e) {
      this._rules = {}, this._errors = [];
      for (var t = 0, n = e.length; n > t; t++) this._addRule(e[t])
    }
    return e.prototype._addRule = function(e) {
      var t = this,
        n = function(n) {
      ...
      return this._lineMap = e.lineMap(), this._syntaxInfo = s.SyntaxInformationMap.create(e.sourceUnit(), !0, !1),
        this._errors.length = 0, this._currentSeverity = r.Severity.Warning, this._visit(e.sourceUnit()), this._errors
        .slice(0)
    }, e.prototype.reportError = function(e, t, n, r, i) {
      "undefined" == typeof r && (r = this.start(e)), "undefined" == typeof i && (i = "function" == typeof e.width ?
        e.width() : e.fullWidth());
      var o = this._lineMap.getLineAndCharacterFromPosition(r),
        s = this._lineMap.getLineAndCharacterFromPosition(r + i);
      this._errors.push({
        message: t,
        code: n,
      ...
      if (e) {
        if (e.isToken()) {
          var t = e.leadingTrivia(),
            n = t.count();
          t.concat(e.trailingTrivia()), this._currentTriviaPosition = this.start(e) - e.leadingTriviaWidth();
          for (var r = 0, i = t.count(); i > r; r++) this._currentTrivia = t.syntaxTriviaAt(r), this._checkNodeOrToken(
            this._currentTrivia), r !== n ? this._currentTriviaPosition += this._currentTrivia.fullWidth() : this._currentTriviaPosition =
            this.end(e) - e.trailingTriviaWidth();
          this._currentTrivia = null, this._currentTriviaPosition = null
        }
  ...
  var m = function(e) {
    function t(t, n) {
      e.call(this, n), this._languageService = t
    }
    return __extends(t, e), t.prototype.languageService = function() {
      return this._languageService
    }, t.prototype.filename = function() {
      return this._filename
    }, t.prototype.check = function(t) {
      return this._filename = t.fileName(), e.prototype.check.call(this, t)
    }, t
  }(d);
  ...
  var f = function(e) {
    ...
    return __extends(t, e), t.prototype.reportError = function(t, n, r, i, o) {
  ...
  t.StyleRuleCheckerWithMessages = f, t.check = h
});
var __extends = this.__extends || function(e, t) {
    function n() {
      this.constructor = e
...
define("vs/languages/typescript/service/outline", ["require", "exports", "vs/base/strings", "vs/base/arrays",
  ...
  function s(e, t) {
    ...
    return e.accept(new a(n, t)), n.children
  }! function(e) {
    e[e.Method = 0] = "Method", e[e.Function = 1] = "Function", e[e.Constructor = 2] = "Constructor", e[e.Variable =
      3] = "Variable", e[e.Class = 4] = "Class", e[e.Interface = 5] = "Interface", e[e.Module = 6] = "Module", e[e.Property =
      7] = "Property", e[e.Enum = 8] = "Enum", e[e.Rule = 9] = "Rule", e[e.File = 10] = "File"
  }(t.Type || (t.Type = {}));
  var a = (t.Type, function(e) {
    function t(t, n) {
      e.call(this), this.currentParent = t, this.range = n, this._parentStack = []
    }
    return __extends(t, e), t.prototype.add = function(e, t, n) {
      var r = {
        label: n,
        type: o(e),
        range: this.range(this.position() + t.leadingTriviaWidth(), t.width())
      };
      return this.currentParent.children ? this.currentParent.children.push(r) : this.currentParent.children = [r],
        r
      ...
      this._parentStack.push(t), e.prototype.visitNode.call(this, t), this._parentStack.pop()
      ...
      this.add(0, t, n.format("{0}{1}", t.propertyName.valueText(), this._callSignatureText(t))), e.prototype.skip.call(
        this, t)
    }, t.prototype.visitMemberVariableDeclaration = function(t) {
      this.add(7, t, t.variableDeclarator.propertyName.valueText()), e.prototype.skip.call(this, t)
    }, t.prototype.visitGetAccessor = function(t) {
      this.add(7, t, t.propertyName.valueText()), e.prototype.skip.call(this, t)
      ...
      var n;
      t.stringLiteral ? n = t.stringLiteral.valueText() : t.name && (n = t.name.fullText()), n && this.add(6, t, n),
      ...
      this.add(1, t, n.format("{0}{1}", t.identifier.valueText(), this._callSignatureText(t))), e.prototype.skip.call(
        this, t)
    }, t.prototype.visitVariableDeclarator = function(t) {
      this.add(3, t, t.propertyName.valueText()), e.prototype.skip.call(this, t)
      ...
      t.operatorToken.kind() === i.SyntaxKind.EqualsToken && t.right.kind() === i.SyntaxKind.FunctionExpression &&
        t.left.kind() === i.SyntaxKind.MemberAccessExpression && this.add(7, t.left, t.left.name.valueText()), e.prototype
        .skip.call(this, t)
    }, t._define = "define", t
...
define("vs/languages/typescript/service/references", ["require", "exports", "../lib/typescriptServices",
  ...
  function o(e, t) {
    ...
    return 0 === n.length ? null : (n.sort(function(e, t) {
      ...
      return 0 === n && (n = t.getOutgoing().length - e.getOutgoing().length), 0 === n && (n = e.getName().localeCompare(
        t.getName())), n
    }), n[0])
  }
  ...
  var u = function() {
    ...
    p = function() {
      ...
      return e.prototype.clone = function() {
        var t = new e;
        return t.store = r.clone(this.store), t
        ...
        return this.hasNode(e) || this.insertNode(e), this.hasNode(t) || this.insertNode(t), this.store[e].outgoing[t] = !
          0, this.store[t].incoming[e] = !0, this.store[t]
      }, e.prototype.removeEdges = function(e) {
        for (var t = [], n = 0; n < arguments.length - 1; n++) t[n] = arguments[n + 1];
        if (this.hasNode(e)) {
          var r, i, o = this.store[e],
            s = t.length;
        ...
        for (var s = 0, a = t.g.length; a > s; s++)
          for (n = t.i[t.g[s]], r = t.g[++s]; r > 0;) i.insertEdge(n, t.i[t.g[++s]]), r -= 1;
        return i
      }, e
    }();
  t.Graph = p, t.computeTransitiveClosure = s, t.buildDependencyGraph = a, t.fillGraph = l;
  var h = function() {
    function e(e, t, n) {
  ...
  var m = function(e) {
    function t(t, n, r) {
      e.call(this, t, n, r), this.isRelative = 0 === this.path.indexOf("./") || 0 === this.path.indexOf("../"), this.isRooted =
        0 === this.path.indexOf("/"), this.isAbsolute = !this.isRelative && !this.isRooted
    }
    return __extends(t, e), t.TS = ".ts", t.DTS = ".d.ts", t.JS = ".js", t
  }(h);
  t.ImportReference = m;
  var f = function(e) {
    function t() {
  ...
  var g = function() {
    ...
    return e.prototype.resolve = function(t, n, r, o) {
      "undefined" == typeof o && (o = {});
      var s = this;
      return this.references = n(this.content), o[this.path] = !0, new i.Promise(function(i, a) {
  ...
  var v = function() {
    function e(e) {
      ...
      this.scanner = new n.Scanner(null, t, 1), this.nextTokens = [], this.offset = 0
    }
      ...
      return e.prototype.consume = function(e) {
        ...
        for (var r, i, o = this.references.length, s = new v(e); t().kind !== n.SyntaxKind.EndOfFileToken;) {
          ...
          if (r.kind === n.SyntaxKind.SingleLineCommentTrivia) {
            ...
            n.SyntaxKind.EqualsToken && (t(), a = !0))); if ((a || !i || i.kind !== n.SyntaxKind.DotToken) && r.kind ===
            n.SyntaxKind.RequireKeyword && (t(), r.kind === n.SyntaxKind.OpenParenToken && (t(), r.kind === n.SyntaxKind
              .StringLiteral))) {
            var h = r.text,
              c = r.offset,
              u = r.length;
            t(), r.kind === n.SyntaxKind.CloseParenToken && (a ? this.references.push(new m(c + 1, -2 + u, h)) : this
              .references.push(new f(c + 1, -2 + u, h)))
          }
          if (r.kind === n.SyntaxKind.IdentifierName && "define" === r.text && (t(), r.kind === n.SyntaxKind.OpenParenToken &&
            (t(!1), r.kind === n.SyntaxKind.StringLiteral && (t(!1), r.kind === n.SyntaxKind.CommaToken && t(!1)),
              r.kind === n.SyntaxKind.OpenBracketToken)))
            for (t(!1); r.kind === n.SyntaxKind.StringLiteral;) "exports" !== r.text && "require" !== r.text &&
              "module" !== r.text && this.references.push(new f(r.offset + 1, -2 + r.length, r.text)), t(!1), r.kind ===
              n.SyntaxKind.CommaToken && t(!1)
        }
        return this.references.slice(o)
      }, e
    }();
  t.ScannerBasedCollector = y, t.collect = c
  ...
  var g = function() {
    function e(e, t, n, r) {
      this._compilationSettings = e, this._suggestSettings = t, this._host = n, this._languageService = r, this._applyTypeScriptCompilationSettings()
    }
    return e.prototype._applyTypeScriptCompilationSettings = function() {
      var e = this._host.getCompilationSettings();
      e.useCaseSensitiveFileResolution = !1, e.noImplicitAny = this._compilationSettings.noImplicitAny, e.codeGenTarget =
        o.equalsIgnoreCase("ES3", this._compilationSettings.codeGenTarget) ? 0 : 1, e.moduleGenTarget = o.equalsIgnoreCase(
          "commonjs", this._compilationSettings.moduleGenTarget) ? 1 : o.equalsIgnoreCase("amd", this._compilationSettings
          .moduleGenTarget) ? 2 : 0
      ...
      for (var n = [], r = 0; r < t.length; r++) {
        var i = t[r],
          o = s.Severity.Error;
        this._compilationSettings.diagnosticClassifier && (o = this._compilationSettings.diagnosticClassifier(i)), o &&
          n.push({
            type: "",
            code: -1,
            text: i.text(),
      ...
      var r = this._host.getScriptSnapshotByUrl(e).model,
        i = r.getAssociatedResource().toExternal(),
        o = r.getOffsetFromPosition({
          lineNumber: t.startLineNumber,
          column: t.startColumn
        }),
        s = r.getOffsetFromPosition({
          lineNumber: t.endLineNumber,
          column: t.endColumn
        }),
        a = this._languageService.getFormattingEditsForRange(i, o, s, this.createFormatOptions(n)),
        l = this.applyTextEdits(a, r, o, s);
      return l.text
    }, e.prototype.formatAfterKeystroke = function(e, t, n) {
      var r = this._host.getScriptSnapshotByUrl(e).model,
        i = r.getAssociatedResource().toExternal(),
        o = r.getOffsetFromPosition(t),
        s = r.getOffsetFromPosition({
          lineNumber: t.lineNumber,
          column: 1
        }),
        a = r.getLineContent(t.lineNumber).length,
        l = r.getValueInRange({
        ...
        c = this._languageService.getFormattingEditsAfterKeystroke(i, 1 + o, l, this.createFormatOptions(n)),
        u = this.applyTextEdits(c, r, s, s + a);
      return u
    }, e.prototype.createFormatOptions = function(e) {
      var t = new u.Services.FormatCodeOptions;
      return t.ConvertTabsToSpaces = e.insertSpaces, t.TabSize = e.tabSize, t.IndentSize = e.tabSize, t.InsertSpaceAfterCommaDelimiter = !
        0, t.InsertSpaceBeforeAndAfterBinaryOperators = !0, t.InsertSpaceAfterSemicolonInForStatements = !0, t
      ...
      for (var i, o = c.create(t), s = 0; s < e.length; s++) o.replace(e[s].minChar, e[s].limChar - e[s].minChar, e[s]
        .text), n = Math.min(n, e[s].minChar), r = Math.max(r, e[s].limChar);
      return i = o.apply(), i = i.substring(n, r + (i.length - t.getValue().length)), {
        text: i,
        range: this.rangeFromMinAndLim({
          minChar: n,
          limChar: r
      ...
      var n = this._host.getScriptSnapshotByUrl(e).model,
        r = n.getAssociatedResource().toExternal(),
        i = n.getOffsetFromPosition(t),
        o = [],
        s = this._languageService.getSyntaxTree(r),
        a = s.sourceUnit().findToken(i);
      ...
      var t = this,
        n = this._host.getScriptSnapshotByUrl(e).model,
        r = n.getAssociatedResource().toExternal(),
        i = this._languageService.getSyntaxTree(r);
      ...
      var n = this,
        r = this._host.getScriptSnapshotByUrl(e).model,
        i = r.getAssociatedResource().toExternal(),
        o = r.getOffsetFromPosition(t),
        s = this._languageService.getOccurrencesAtPosition(i, o),
        a = s.map(function(t) {
          return {
      ...
      var n = this._host.getScriptSnapshotByUrl(e).model,
        r = n.getAssociatedResource().toExternal(),
        i = n.getOffsetFromPosition(t),
        o = this._languageService.getDefinitionAtPosition(r, i);
      ...
      var n = this._host.getScriptSnapshotByUrl(e).model,
        r = n.getOffsetFromPosition(t),
        i = n.getAssociatedResource().toExternal(),
        o = this._languageService.getTypeAtPosition(i, r);
      if (!o) return !0;
      switch (o.kind) {
      ...
      var n = this,
        r = this._host.getScriptSnapshotByUrl(e).model,
        i = r.getOffsetFromPosition(t),
        o = r.getAssociatedResource().toExternal(),
        s = this._languageService.getReferencesAtPosition(o, i),
      ...
      var r = this._host.getScriptSnapshotByUrl(e).model,
        i = e.toExternal(),
        o = r.getWordUntilPosition(t),
        s = r.getOffsetFromPosition(t),
        a = s - o.length,
        l = "." === r.getValue().charAt(a - 1),
        c = this._languageService.getCompletionsAtPosition(i, a, l),
        u = new n.DelegateHashSet(function(e) {
      ...
      var r = this._host.getScriptSnapshotByUrl(e).model,
        i = e.toExternal(),
        o = r.getOffsetFromPosition(t),
        s = this._languageService.getCompletionEntryDetails(i, o, n.label);
      if (!s) return n;
      if (n.documentationLabel = s.docComment, n.typeLabel = s.type, n.codeSnippet = s.name, this._suggestSettings.useCodeSnippetsOnMethodSuggest &&
        ...
        var a = this.parseMethodSignature(s.type),
          l = a.arguments.map(function(e) {
            return "{{" + e.name.trim() + "}}"
          }),
          c = s.name;
        c += l.length > 0 ? "(" + l.join(", ") + "){{}}" : "()", n.codeSnippet = c
      }
      return n
      ...
      var n = this._host.getScriptSnapshotByUrl(e).model,
        r = n.getAssociatedResource().toExternal(),
        i = n.getOffsetFromPosition(t),
        s = n.getWordUntilPosition(t),
        a = i - s.length,
        l = "." === n.getValue().charAt(a - 1),
        c = this._languageService.getCompletionsAtPosition(r, a, l),
        u = [];
      return c.entries.forEach(function(e) {
      ...
      var r = this._host.getScriptSnapshotByUrl(t).model,
        i = r.getOffsetFromPosition(n),
        o = r.getAssociatedResource().toExternal(),
        s = this._languageService.getSignatureAtPosition(o, i);
      if (!s) return null;
      var a = {
      ...
      var t = this,
        n = new Array,
        r = this._host.getScriptSnapshot(e.toExternal()).model;
      return f.collect(r.getValue()).forEach(function(o) {
      ...
      var r = this._host.getScriptSnapshotByUrl(t).model,
        i = e.minChar,
        o = Math.max(1, e.limChar - e.minChar);
      if (n) {
      ...
      for (var i, o = this._languageService.getSyntaxTree(e.getAssociatedResource().toExternal()), s = o.sourceUnit()
          .findToken(t); s && !i;) s.fullWidth() > r && (i = s), s = s.parent();
      i || (i = o.sourceUnit().findToken(t).root());
      var a = e.getValue().substring(i.fullStart(), i.fullEnd()),
        c = new l.MirrorModel(0, a),
        u = t - i.fullStart(),
        p = n - t,
        h = c.getRangeFromOffsetAndLength(u, p);
      return c.dispose(), {
        text: a,
        range: h
      }
    }, e.FILTER = a.or(a.matchesPrefix, a.matchesContiguousSubString, a.matchesCamelCase), e
  }();
...
define("vs/languages/typescript/service/languageServiceHost2", ["require", "exports", "vs/base/collections",
  ...
  var a = function(e) {
    ...
    return __extends(t, e), t.prototype.getDiagnosticsObject = function() {
      return this
  ...
  var l = function() {
    function e(e) {
      this._model = e, this._versionId = e.getVersionId(), this._open = !(e instanceof o.RemoteModel), this._value =
        e.getValue(), this._length = this._value.length
    }
  ...
  var c = function(e) {
    function t(t) {
      e.call(this), this._resourceService = t, this._resourceSet = {}, this._compilationSettings = new i.CompilationSettings
    }
    return __extends(t, e), t.prototype.updateResources = function(e) {
      ...
      if (r) {
        ...
        n.contains(this._resourceSet, t) && n.lookup(this._resourceSet, t).versionId === i || (this._resourceSet[t] =
          new l(r))
      } else console.warn(e.toExternal() + " NOT found"), delete this._resourceService[t]
  ...
  var c = t.Events,
    u = function() {
      ...
      return e.prototype.fetchDependencies = function() {
        return e._Empty
      }, e.prototype.dispose = function() {}, e._Empty = n.TPromise.as(o.EmptyIterable), e
    }();
  ...
  var h = function() {
    function e(e, t) {
      this._resourceService = e, this._requestService = t
    }
    return e.prototype.dispose = function() {}, e.prototype.fetchDependencies = function(t) {
      ...
      return e._Empty
    }, e._Empty = n.TPromise.as(o.EmptyIterable), e
  }();
  t.AbstractDependencyResolver = h;
  var d = function() {
    function e(e, t, n) {
      var r = this;
      this._delegate = e, this._eventbus = t, this._resourceService = n, this._cache = new o.Dictionary, this._callOnDispose =
        new Array, this._callOnDispose.push(this._resourceService.addListener2(s.ResourceEvents.REMOVED, function(e) {
          return r._cache.remove(e.url)
        }))
    }
    return e.prototype.dispose = function() {
      r.disposeAll(this._callOnDispose), this._cache.forEach(function(e) {
      ...
      var t = this,
        n = this._cache.lookup(e.getAssociatedResource());
      clearTimeout(n.scheduledUpdate), n.scheduledUpdate = setTimeout(function() {
...
define("vs/languages/typescript/resources/dependencyResolverFiles", ["require", "exports", "vs/base/lib/winjs.base",
  ...
  function p(e, t) {
    ...
    return e.traverse(t.toExternal(), function(t) {
      var s = t.getName(),
        a = 0 === s.indexOf("error:");
      if (a) {
        e.removeNode(s);
  ...
  var h = function() {
    ...
    return e.prototype.load = function(e, t) {
      ...
      var o = new r.URL(s.join(s.dirname(e), s.normalize(t.path))),
        c = this._requestService.getPath("root", o),
        u = new r.URL(this._requestService.getRequestUrl("root", c, !0));
      ...
      return this._requestService.makeRequest({
        ...
        var t = new l.File(u.toExternal(), e.responseText),
          n = new a.RemoteModel(u, e.responseText);
        return i._resourceService.contains(u) || i._resourceService.insert(u, n), t
      })
    }, e.prototype.dispose = function() {}, e
  }(),
    d = function(e) {
      function n(t, n, r) {
        e.call(this, n, r), this._markerService = t, this._loader = new h(this._resourceService, this._requestService)
      }
      return __extends(n, e), n.prototype.dispose = function() {
        this._loader.dispose()
      }, n.prototype._doFetchDependencies = function(e) {
        var r = this,
          i = this._resourceService.get(e),
          s = new l.File(i.getAssociatedResource().toExternal(), i.getValue()),
          a = this._requestService.getPath("root", i.getAssociatedResource());
        return l.buildDependencyGraph(this._loader, [s], n._Options).then(function(n) {
          var i = t.collectDependenciesAndErrors(n, e);
          return r._markerService.createPublisher().changeMarkers(e, function(e) {
  ...
  t.FileBasedResolver = d, t.collectDependenciesAndErrors = p;
  var m = function() {
    function t(e, t, n, r) {
      this._baselibs = e, this._resourceService = t, this._requestService = n, this._delegate = r
    }
    return t.prototype.dispose = function() {
      ...
      return n.TPromise.join(this._baselibs.map(function(n) {
        return e._resolveBaseLibrary(n).then(function(n) {
          return n && t.push(n), e._delegate.fetchDependencies(n)
        }).then(function(e) {
          r.push(e)
        })
      })).then(function() {
      ...
      return this._resourceService.contains(r) ? n.TPromise.as(r) : 0 === r.toExternal().indexOf(t.MODULE_PREFIX) ?
        new n.TPromise(function(t) {
          e([r.toExternal()], function(e) {
            ...
            i._resourceService.insert(r, n), t(r)
          })
        }) : this._requestService.makeRequest({
          url: r.toExternal()
        }).then(function(e) {
          var t = new a.DefaultLibModel(r, e.responseText);
          return i._resourceService.insert(r, t), r
        }, function() {
          return console.warn("TS - " + r.toExternal() + " can not be loaded as base lib"), null
        })
...
define("vs/languages/typescript/resources/dependencyResolverGraph", ["require", "exports", "vs/base/lib/winjs.base",
  ...
  ! function(e) {
    ...
    function r(e, r) {
      function o(e) {
        if (p) return a("canceled"), void 0;
        var n = e.indexOf("\r\n\r\n", c);
        if (-1 !== n) {
          var r = t(e.substring(c, n)),
            i = Number(r["Content-Length"]);
      ...
      var s, a, l, c = 0,
        u = [],
        p = !1,
        h = new n.Promise(function(e, t, n) {
          s = e, a = t, l = n
        }, function() {
          p = !0
        });
      return e.makeRequest(r).then(function(e) {
        o(e.responseText), s(u)
      }, function(e) {
        a(e)
      }, function(e) {
    ...
    e.parseHeader = t, e.fetchChunkedData = r
  }(p || (p = {}));
  var h = function(e) {
    function t(t, n, i, o, s) {
      e.call(this, o, s), this._moduleType = t, this._basePath = n, this._markerService = i, this._moduleType = this._moduleType ||
        r.empty, this._basePath = this._basePath || r.empty
    }
    return __extends(t, e), t.prototype._doFetchDependencies = function(e) {
      var t, r = this,
        i = this._requestUrl(e, "typeScriptDependencyGraph");
      return this._requestService.makeRequest({
        url: i
      }).then(function(t) {
        var n = r._parseGraph(JSON.parse(t.responseText)),
          i = c.collectDependenciesAndErrors(n, e),
          s = r._requestService.getPath("root", e);
        return r._markerService.createPublisher().changeMarkers(e, function(e) {
        ...
        if ("undefined" == typeof e.header.IsError) {
          var t = e.header.Path,
            n = s.URL.fromEncoded(r._requestService.getRequestUrl("root", t, !0)),
            i = new a.RemoteModel(n, e.body);
      ...
      var n = this._requestService.getPath("root", e),
        i = [];
      return i.push(this._requestService.getRequestUrl(t, n)), i.push(r.format("?type={0}", encodeURIComponent(this._moduleType))),
        i.push(r.format("&baseurl={0}", encodeURIComponent(this._basePath))), i.join(r.empty)
...
}), define("vs/languages/typescript/typescript.configuration", ["require", "exports", "vs/base/objects",
  "vs/base/strings", "vs/base/severity"
], function(e, t, n, r, i) {
  function o(e, n) {
...
define("vs/languages/typescript/typescriptWorker2", ["require", "exports", "vs/base/lib/winjs.base", "vs/base/objects",
  ...
  var T;
  ! function(e) {
    e.StatusIdle = "status.idle", e.StatusLoading = "status.loading", e.StatusTypeScript = "status.typescript", e.StatusError =
      "status.error"
  }(T || (T = {}));
  var _ = function() {
    function e(e, t, n, r, i, o, s) {
      this._compilationSettings = e, this._suggestSettings = t, this._resourceService = n, this._requestService = r,
        this._markerService = i, this._telemetryService = o, this._eventBus = s, this._callOnDispose = [], this._runCounter =
        0
    }
    return e.prototype.dispose = function() {
      p.disposeAll(this._callOnDispose), p.disposeAll([this._noDependencyResolver, this._fileDependencyResolver])
      ...
      this._host = new g.LanguageServiceHost(this._resourceService), this._adapter = new f.LanguageServiceAdapter(
        this._compilationSettings, this._suggestSettings, this._host, new v.Services.LanguageService(this._host)), p.disposeAll(
        [this._noDependencyResolver, this._fileDependencyResolver]), this._noDependencyResolver = new w.NullDependencyResolver,
        this._fileDependencyResolver = new w.CompositeDependencyResolver([new y.BaselibDependencyResolver(this._compilationSettings
          .extraLibs.map(function(e) {
            return new o.URL(e)
          }), this._resourceService, this._requestService, this._createResolver()), this._createResolver()]), this._fileDependencyResolver =
        new w.CachingDependencyResolver(this._fileDependencyResolver, this._eventBus, this._resourceService)
      ...
      return "undefined" == typeof n && (n = null), 0 === this._runCounter++ && this._init(), this._doRun(e, this._fileDependencyResolver,
        t, n)
    }, e.prototype.withNoDependencies = function(e, t, n) {
      return "undefined" == typeof n && (n = null), 0 === this._runCounter++ && this._init(), this._doRun(e, this._noDependencyResolver,
        t, n)
      ...
      return new n.Promise(function(n, l) {
        s._eventBus.emit(T.StatusLoading), t.fetchDependencies(e).then(function(t) {
          if (o) return l(o), void 0;
          e && (t = c.combine([t, c.singleton(e)])), s._host.updateResources(t);
          var u = i;
  ...
  var k = function() {
    ...
    return e.prototype.dispose = function() {
      ...
      return t || (t = i.tail(o)), t
    }, e.prototype.withFileDependencies = function(e, t, n) {
      return "undefined" == typeof n && (n = null), this._findLanguageService(e).withFileDependencies(e, t, n)
    }, e.prototype.withNoDependencies = function(e, t, n) {
      return "undefined" == typeof n && (n = null), this._findLanguageService(e).withNoDependencies(e, t, n)
    ...
    x = function(e) {
      function t() {
        var t = this;
        e.call(this), this.shouldEmitStatus = !1, this.validationQueue = [], this._callOnDispose = [], this._uuid = a
          .v4().asHex(), this._eventBus = new u.EventEmitter, this._callOnDispose.push(this._eventBus.addListener(w.Events
            .OnReferencesChanged, function(e) {
      ...
      return __extends(t, e), t.prototype.dispose = function() {
        ...
        for (var t = S.sanitize(e, S._internalDefaultValidationSettings, S.defaultSuggestSettions), r = 0, o = t.validationSettings
            .length; o > r; r++) this._extraData.semanticValidation || (t.validationSettings[r].semanticValidation = !
          1), this._extraData.syntacticValidation || (t.validationSettings[r].syntaxValidation = !1);
        if (this._options && S.equal(this._options, t)) return n.Promise.as(null);
        p.combinedDispose(this._languageServices), this._languageServices = new k, this._options = t;
        for (var a = i.coalesce([this._requestService.getRequestUrl("root", s.empty, !0), "inMemory://model/"]), r =
            0; r < a.length; r++)
        ...
        return this._validateAll(), n.Promise.as(null)
        ...
        return this._validateOne(e), this._extraData.validateAllFiles && this._validateAll(e), n.Promise.as(null)
        ...
        this.validationScheduler || (this.validationScheduler = new h.RunOnceScheduler(function() {
          if (0 === t.validationQueue.length) return t.validationScheduler.cancel(), void 0;
          try {
        ...
        }, 100)), this.activeValidation && this.activeValidation.cancel();
        ...
        return function() {
          ...
          return t._extraData.syntacticValidation && (c = t._languageServices.withNoDependencies(e, function(n) {
            if (a) throw l;
            ...
            return t._languageServices.withFileDependencies(e, function(r) {
              if (a) throw l;
              var i = [];
              n || (i.push.apply(i, r.getSemanticDiagnostics(e)), i.push.apply(i, r.getExtraDiagnostics(e))), t._publishMarkersForResource(
                e, s.format("{0}/semantic", t._uuid), i)
            })
          }).then(function() {
            if (a) throw l;
        ...
        return this.markerService.createPublisher().batchChanges(function(r) {
        ...
        var t = this._languageServices.getAllLangaugeServices(this._requestService.getRequestUrl("root", s.empty, !0))
          .map(function(t) {
        ...
        var r = e.prototype.computeLinks.call(this, t),
          o = this._languageServices.withNoDependencies(t, function(e) {
  ...
  t.TypeScriptWorker2 = x, t.value = new x
});