define('vs/languages/less/editor/colorContribution', [
  'require',
  'exports',
  'vs/base/lifecycle',
  ...
  var u = function() {
    ...
    return e.prototype.dispose = function(e) {
      e.removeDecoration(this.trackingDecorationId), e.removeDecoration(this.renderingDecorationId);
    ...
    l = function() {
      function e(t) {
        var n = this;
        this._instanceCount = ++e.INSTANCE_COUNT, this._editor = t, this._callOnDispose = [], this._callOnModelChange = [],
          this._currentDecorations = [], this._currentDynamicColors = [], this._scheduler = new i.RunOnceScheduler(
            null, 250), this._currentFindColorDeclarationsPromise = null, this._callOnDispose.push(this._scheduler),
      ...
      return e.prototype.dispose = function() {
        ...
        }), o.removeCSSRulesWithPrefix(this.getCSSRuleName(-1)), this._callOnDispose = n.disposeAll(this._callOnDispose);
        ...
        if (t) {
          ...
          'function' == typeof i.findColorDeclarations && (this._scheduler.setRunner(function() {
            e._currentFindColorDeclarationsPromise && e._currentFindColorDeclarationsPromise.cancel(), e._currentFindColorDeclarationsPromise =
              i.findColorDeclarations(t.getAssociatedResource()), e._currentFindColorDeclarationsPromise.then(
                function(t) {
        ...
        this._editor.changeDecorations(function(l) {
          for (e = 0, t = s._currentDecorations.length; t > e; e++)
            r = s._currentDecorations[e], n = a.getDecorationRange(r.trackingDecorationId), n && !n.isEmpty() ? (u[
                e] = a.getValueInRange(n).replace(/[^%#a-z0-9.,()]/gi, ''), i = a.getDecorationRange(r.renderingDecorationId),
              o = a.validateRange({
        ...
        for (var t; this._currentDynamicColors.length > e.length;)
          o.removeCSSRulesWithPrefix(this.getCSSRuleName(this._currentDynamicColors.length - 1)), this._currentDynamicColors
            .pop();
        for (t = this._currentDynamicColors.length; t < e.length; t++)
          o.createCSSRule(this.getCSSRuleName(t), this.getCSSText(e[t])), this._currentDynamicColors.push(e[t]);
      ...
      }, e.ID = 'css.editor.colorContribution', e.INSTANCE_COUNT = 0, e;
    }();
