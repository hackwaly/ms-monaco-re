define('vs/languages/javascript/javascript.configuration', [
  'require',
  'exports',
  'vs/base/severity',
  'vs/base/collections'
  ...
  var o = function() {
    function e(e) {
      this._lintSettings = e, this._severities = {}, this._severities[2011] = n.fromValue(e.forcedTypeConversion),
        this._severities[2111] = this._severities[2112] = this._severities[2113] = this._severities[2114] = n.fromValue(
          e.mixedTypesArithmetics), this._severities[2121] = this._severities[2120] = n.fromValue(e.primitivesInInstanceOf),
        this._severities[2094] = n.fromValue(e.unknownProperty), this._severities[2095] = n.fromValue(e.undeclaredVariables),
        this._severities[2134] = n.fromValue(e.redeclaredVariables), this._severities[2084] = n.fromValue(e.newOnReturningFunctions);
    }
    return e.prototype.classify = function(e) {
      var t = /.*?(\d+):.*?/.exec(e.message());
      if (!t)
        return n.Severity.Error;
      var o = Number(t[1]);
      return isNaN(o) ? n.Severity.Error : 2000 > o ? n.Severity.Error : 2094 === o && 0 !== i.lookup(this._severities,
        o) && /The property '[\w\d_]+' does not exist on value of type 'any'\./.test(e.text()) ? 0 : i.lookup(this._severities,
        o, 0);
    }, e;
  }();
  t.JavaScriptDiagnosticsClassifier = o, t.defaultLintSettings = {
