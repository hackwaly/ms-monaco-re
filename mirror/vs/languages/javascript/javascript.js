...
define("vs/languages/vsxml/vsxml", ["require", "exports", "vs/base/objects", "vs/base/errors",
  ...
  var o = '<>"=/',
    ...
    u = n.createKeywordMatcher(["type", "path", "name", "locid", "filename", "format", "optional"]),
  ...
  function s(e, t, n) {
    var o, s, a = r.findIndexInSegmentsArray(t, n),
      u = t[a];
...
define("vs/languages/javascript/javascript", ["require", "exports", "vs/base/lib/winjs.base",
  ...
  var l = "+-*%&|^~!=<>/?;:.,",
    ...
    p = r.createKeywordMatcher(["abstract", "boolean", "byte", "catch", "char", "class", "const", "debugger",
      "default", "delete", "double", "enum", "extends", "false", "final", "finally", "float", "for", "function",
      "goto", "implements", "import", "in", "instanceof", "int", "interface", "let", "long", "native", "new",
      "null", "package", "protected", "short", "static", "super", "synchronized", "this", "throws", "transient",
      "true", "try", "typeof", "var", "void", "volatile", "with"
    ]),
    f = r.createKeywordMatcher(["if", "else", "switch", "case", "while", "do", "break", "continue", "throw", "return"]),
    g = r.createKeywordMatcher(["export", "public", "private"]),
    m = function(e) {
      return l.indexOf(e) > -1
    }, v = function(e) {
      function t(t, n, i) {
        e.call(this, t), this.name = n, this.parent = i
      }
      return __extends(t, e), t.prototype.equals = function(n) {
        if (!e.prototype.equals.call(this, n)) return !1;
        var i = n;
        ...
        return e.setTokenRules(c, d), e.skipWhitespace().length > 0 ? {
          type: ""
        } : this.stateTokenize(e)
      }, t.prototype.stateTokenize = function() {
  ...
  var y = function(e) {
    function t(t, n, i, r) {
      e.call(this, t, "string", n), this.isAtBeginning = r, this.delimiter = i
    }
    return __extends(t, e), t.prototype.makeClone = function() {
  ...
  var _ = function(e) {
    function t(t, n, i, r) {
      e.call(this, t, "regexp", n), this.previous = i, this.previousTokenText = r
    }
    return __extends(t, e), t.prototype.makeClone = function() {
  ...
  var b = function(e) {
    function t(t, n, i) {
      e.call(this, t, "number", n), this.firstDigit = i
    }
    return __extends(t, e), t.prototype.makeClone = function() {
      ...
      for (; !e.eos();)
        ...
        if ("." !== t || r || i) {
          if ("e" !== t || r) break;
          r = !0, e.next(), e.eos() || "-" !== e.peek() || e.next()
        } else i = !0, e.next();
        else {
  ...
  var w = function(e) {
    function t(t, n, i) {
      e.call(this, t, "comment", n), this.tokenType = i
    }
    return __extends(t, e), t.prototype.equals = function(t) {
      ...
      for (; !e.eos();) {
        var t = e.next();
        if ("*" === t && !e.eos() && !e.peekWhitespace() && "/" === e.peek()) return e.next(), {
          type: this.tokenType,
          nextState: this.parent
        }
      }
  ...
  var C = function(e) {
    function t(t, n, i, r) {
      e.call(this, t, "expression", n), this.previous = i, this.previousTokenText = r
    }
    return __extends(t, e), t.prototype.equals = function(n) {
      if (!e.prototype.equals.call(this, n)) return !1;
      var i = n;
      ...
      if (o.isDigit(e.peek(), 10)) return this.previous = "number", {
  ...
  var E = function() {
    ...
    return e.prototype.findDeclaration = function(e, t) {
    ...
    S = function(e) {
      function t() {
        ...
        var t = new E(this);
        this.inEditorActionsSupport = t, this.declarationSupport = t, this.referenceSupport = t, this.extraInfoSupport =
          t, this.logicalSelectionSupport = t, this.parameterHintsSupport = t, this.formattingSupport = t, this.outlineSupport =
          this
      }
  ...
  var x = function(e) {
    function t(t, n, i, r, o) {
      e.call(this, t, i, r, o), this.vsState = n
    }
