define(["vs/base/lib/winjs.base", "vs/editor/diff/diffChange"], function(a, b) {
  ...
  var h = a.Class.define(function(b, c, d) {
    ...
    ComputeDiffRecursive: function(a, b, e, f, g) {
      ...
      if (a > b || e > f) {
        var h;
        return e <= f ? (d.Assert(a === b + 1, "originalStart should only be one more than originalEnd"), h = [new c(
          a, 0, e, f - e + 1)]) : a <= b ? (d.Assert(e === f + 1,
          ...
          "modifiedStart should only be one more than modifiedEnd"), h = []), h
      }
      var i = [0],
        j = [0],
      ...
      if (!g[0]) {
        var n = this.ComputeDiffRecursive(a, l, e, m, g),
          o = [];
        return g[0] ? o = [new c(l + 1, b - (l + 1) + 1, m + 1, f - (m + 1) + 1)] : o = this.ComputeDiffRecursive(l +
          1, b, m + 1, f, g), this.ConcatenateChanges(n, o)
      }
    ...
    WALKTRACE: function(a, b, d, e, f, h, i, j, k, l, m, n, o, p, q, r, s, t) {
      ...
      do C = z + a, C === x || C < y && k[C - 1] < k[C + 1] ? (m = k[C + 1], p = m - z - e, m < A && w.MarkNextChange(),
        ...
        A = m - 1, w.AddOriginalElement(m, p + 1), z = C - 1 - a), B >= 0 && (k = this.m_forwardHistory[B], a = k[0],
        x = 1, y = k.length - 1); while (--B >= -1);
      ...
      if (t[0]) {
        ...
        do C = z + f, C === x || C < y && l[C - 1] >= l[C + 1] ? (m = l[C + 1] - 1, p = m - z - j, m > A && w.MarkNextChange(),
          A = m + 1, w.AddOriginalElement(m + 1, p + 1), z = C + 1 - f) : (m = l[C - 1], p = m - z - j, m > A && w.MarkNextChange(),
          A = m, w.AddModifiedElement(m + 1, p + 1), z = C - 1 - f), B >= 0 && (l = this.m_reverseHistory[B], f = l[
          0], x = 1, y = l.length - 1); while (--B >= -1);
        v = w.getChanges()
      }
    ...
    ComputeRecursionPoint: function(a, b, d, g, h, i, j) {
      ...
      for (q = 1; q <= r / 2 + 1; q++) {
        ...
        for (B = m; B <= n; B += 2) {
          ...
          if (!A && Math.abs(B - w) <= q - 1 && k >= u[B]) return h[0] = k, i[0] = l, C <= u[B] && f > 0 && q <= f +
            1 ? this.WALKTRACE(v, m, n, x, w, o, p, y, t, u, k, b, h, l, g, i, A, j) : null
        }
        var F = (D - a + (E - d) - q) / 2;
        if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(D, this.OriginalSequence,
          F)) return j[0] = !0, h[0] = D, i[0] = E, F > 0 && f > 0 && q <= f + 1 ? this.WALKTRACE(v, m, n, x, w, o,
          p, y, t, u, k, b, h, l, g, i, A, j) : (a++, d++, [new c(a, b - a + 1, d, g - d + 1)]);
    ...
    ChangesOverlap: function(a, b, e) {
      ...
      if (a.originalStart + a.originalLength >= b.originalStart || a.modifiedStart + a.modifiedLength >= b.modifiedStart) {
        var f = a.originalStart,
          ...
          h = a.modifiedStart,
          i = a.modifiedLength;
        return a.originalStart + a.originalLength >= b.originalStart && (g = b.originalStart + b.originalLength - a
          .originalStart), a.modifiedStart + a.modifiedLength >= b.modifiedStart && (i = b.modifiedStart + b.modifiedLength -
