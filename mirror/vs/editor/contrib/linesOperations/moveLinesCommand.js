  ...
  var g = function() {
    ...
    a.prototype.getEditOperations = function(a, b) {
      ...
      if (d.startLineNumber === d.endLineNumber && a.getLineMaxColumn(d.startLineNumber) === 1) {
        ...
        var j;
        this._isMovingDown ? (i = d.endLineNumber + 1, j = a.getLineContent(i), b.addEditOperation(new e.Range(i - 1,
          a.getLineMaxColumn(i - 1), i, a.getLineMaxColumn(i)), null), b.addEditOperation(new e.Range(d.startLineNumber,
          1, d.startLineNumber, 1), j + "\n")) : (i = d.startLineNumber - 1, j = a.getLineContent(i), b.addEditOperation(
          new e.Range(i, 1, i + 1, 1), null), b.addEditOperation(new e.Range(d.endLineNumber, a.getLineMaxColumn(d.endLineNumber),
          d.endLineNumber, a.getLineMaxColumn(d.endLineNumber)), "\n" + j));
      }
