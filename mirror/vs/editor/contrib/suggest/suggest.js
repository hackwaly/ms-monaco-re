...
define(["require", "exports", "vs/nls", "vs/editor/contrib/snippet/snippet", "vs/editor/core/constants",
  ...
  var o = c,
    ...
    A = function(a) {
      function b(b, c) {
        var d = this;
        a.call(this, b, c), this.model = new s.SuggestModel(this.editor, function(a, b) {
          p.InsertSnippetHelper.run(d.editor, d.handlerService, a, b)
        }), this.quickSuggestWidget = null, this.suggestWidget = null, this.binding = null, this.triggerCharacterListeners = [],
      ...
      return __extends(b, a), b.prototype.injectHandlerService = function(b) {
        a.prototype.injectHandlerService.call(this, b), this.quickSuggestWidget || (this.quickSuggestWidget = new t.QuickSuggestWidget(
          this.editor, this.handlerService), this.quickSuggestWidget.setModel(this.model))
      }, b.prototype.injectTelemetryService = function(b) {
        a.prototype.injectTelemetryService.call(this, b), this.suggestWidget || (this.suggestWidget = new r.SuggestWidget(
          this.editor, this.telemetryService), this.suggestWidget.setModel(this.model))
            ...
            var c = b.suggestSupport.getTriggerCharacters(),
              d = function() {
                var c = a.editor.getPosition(),
                  d = a.editor.getModel().getLineContent(c.lineNumber),
                  e = a.editor.getModel().getRawLineTokens(c.lineNumber);
        ...
        var b = this;
        return this.binding !== null && (this.binding.dispose(), this.binding = null), this.suggestWidget.setModel(
          this.model), this.binding = this.handlerService.bindGroup(function(a) {
          a({
            key: "Enter"
          }, function() {
            return b.accept()
        ...
        }), this.model.trigger(!1, a), this.editor.focus(), w.Promise.as(!1)
      }, b.prototype.dispose = function() {
        a.prototype.dispose.call(this);
        while (this.triggerCharacterListeners.length > 0) this.triggerCharacterListeners.pop()();
        this.quickSuggestWidget && (this.quickSuggestWidget.destroy(), this.quickSuggestWidget = null), this.suggestWidget &&
          (this.suggestWidget.destroy(), this.suggestWidget = null), this.model && (this.model.destroy(), this.model =
          null), this.binding !== null && (this.binding.dispose(), this.binding = null)
      ...
      }, b.ID = "editor.actions.triggerSuggest", b
    }(x.EditorAction);
  ...
  var B = new z.ActionDescriptor(A, A.ID, o.localize("suggest.trigger.label", "Trigger suggest"), {
    ...
    C = y.Registry.as(x.Extensions.EditorContributions);
