...
define(["require", "exports", "vs/editor/contrib/snippet/snippet", "vs/base/lib/winjs.base", "vs/editor/core/constants",
  ...
  var k = c,
    ...
    s;
  (function(a) {
    a[a.NOT_ACTIVE = 0] = "NOT_ACTIVE", a[a.MANUAL_TRIGGER = 1] = "MANUAL_TRIGGER", a[a.AUTO_TRIGGER = 2] =
      "AUTO_TRIGGER"
  })(s || (s = {}));
  var t = function() {
    function a(a, b) {
      ...
      var c = a.getModel(),
        d = c.getLineContent(b.lineNumber);
      this.wordBefore = "";
      var e = c.getWordAtPosition(b, !1);
      e && (this.wordBefore = d.substring(e.startColumn - 1, b.column - 1)), this.lineNumber = b.lineNumber, this.column =
        b.column, this.lineContentBefore = d.substr(0, b.column - 1), this.lineContentAfter = d.substr(b.column - 1)
    }
    return a.prototype.isValidForAutoSuggest = function() {
    ...
    u = function(a) {
      function b(b, c) {
        var d = this;
        a.call(this), this.editor = b, this.onAccept = c, this.listenersToRemove = [], this.autoSuggestDelay = this.editor
          .getConfiguration().quickSuggestionsDelay;
        ...
        this.triggerAutoSuggestPromise = null, this.state = s.NOT_ACTIVE, this.requestPromise = null, this.suggestions =
          null, this.requestContext = null, this.listenersToRemove.push(this.editor.addListener(m.EventType.CursorSelectionChanged,
            function(a) {
      ...
      return __extends(b, a), b.prototype.cancel = function(a, b) {
        typeof a == "undefined" && (a = !1), typeof b == "undefined" && (b = !1);
        var c = this.state !== s.NOT_ACTIVE;
        return this.triggerAutoSuggestPromise && (this.triggerAutoSuggestPromise.cancel(), this.triggerAutoSuggestPromise =
          null), this.requestPromise && (this.requestPromise.cancel(), this.requestPromise = null), this.state = s.NOT_ACTIVE,
          this.suggestions = null, this.requestContext = null, a || this.emit("cancel", {
            retrigger: b
          }), c
        ...
        this.state === s.NOT_ACTIVE ? (this.cancel(), b.isValidForAutoSuggest() && (this.triggerAutoSuggestPromise =
          l.Promise.timeout(this.autoSuggestDelay), this.triggerAutoSuggestPromise.then(function() {
            a.triggerAutoSuggestPromise = null, a.trigger(!0, !1)
          }))) : this.onNewContext(b)
      }, b.prototype.trigger = function(a, b, c) {
        typeof c == "undefined" && (c = !1);
        var d = this,
          e = this.editor.getModel(),
          f = e.getMode().suggestSupport;
        if (!f) return;
        var g = q.start(q.Topic.EDITOR, "suggest/TRIGGER");
        this.cancel(!1, c), this.state = a ? s.AUTO_TRIGGER : s.MANUAL_TRIGGER, this.emit("loading", {
        ...
        this.requestPromise = f.suggest(e.getAssociatedResource(), this.editor.getPosition()), this.requestPromise.then(
          function(a) {
            h.stop(), d.requestPromise = null, a.suggestions && a.suggestions.length > 0 ? (d.suggestions = a.suggestions,
              d.onNewContext(new t(d.editor))) : d.emit("empty"), g.stop()
          }, function() {
            h.stop(), g.stop()
          })
        ...
        if (this.suggestions) {
          var b = this.editor.getModel().getMode().suggestSupport,
            c = this.suggestions,
            d = b.getFilter();
          d && (c = c.filter(d.bind(null, a.wordBefore))), c = c.sort(function(a, b) {
        ...
        a = a || this.suggestions[0], this.cancel();
        var b = new t(this.editor),
          c = new n.Range(b.lineNumber, b.column - b.wordBefore.length, b.lineNumber, b.column);
        this.onAccept(new k.CodeSnippet(a.codeSnippet), c);
        var d = this.editor.getAction(r.TriggerParameterHintsAction.ID),
          e = d ? d.getModel() : null;
        return e && e.doTrigger(), !0
