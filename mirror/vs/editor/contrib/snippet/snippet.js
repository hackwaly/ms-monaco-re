define(["require", "exports", "vs/base/strings", "vs/editor/core/range", "vs/editor/core/constants",
  ...
  var h = c,
    ...
    m = function() {
      function a(a) {
        this.lines = [], this.placeHolders = [], this.startPlaceHolderIndex = 0, this.finishPlaceHolderIndex = -1,
          this.parseTemplate(a)
      }
      return a.prototype.parseTemplate = function(a) {
        ...
        for (c = 0, d = g.length; c < d; c++) {
          ...
          for (e = 0, f = h.placeHolders.length; e < f; e++) {
            var j = h.placeHolders[e],
              k = new i.Range(c + 1, j.startColumn, c + 1, j.endColumn),
              l;
            b.hasOwnProperty(j.value) ? l = b[j.value] : (l = {
              ...
              1), b[j.value] = l), l.occurences.push(k)
          }
        ...
        var e = [],
          f = [],
          g = this.extractLineIndentation(a, c + 1),
          h, i, j, k, l, m, n, o, p = [];
        for (l = 0, m = this.lines.length; l < m; l++) h = this.lines[l], l === 0 ? (p[l + 1] = c, e[l] = h) : (i =
          this.extractLineIndentation(h), j = h.substr(i.length), k = d.normalizeIndentation(g + i), p[l + 1] = k.length -
          i.length, e[l] = k + j);
        var q, r, s;
        for (l = 0, m = this.placeHolders.length; l < m; l++) {
          q = this.placeHolders[l], s = [];
          for (n = 0, o = q.occurences.length; n < o; n++) r = q.occurences[n], s.push({
  ...
  var n = function() {
    function a(a, b, c, d) {
      this.editor = a, this.handlerService = b, this.finishPlaceHolderIndex = c.finishPlaceHolderIndex, this.trackedPlaceHolders = [],
        this.placeHolderDecorations = [], this.currentPlaceHolderIndex = c.startPlaceHolderIndex, this.highlightDecorationId =
        null, this.isFinished = !1, this.binding = null, this.initialize(c, d)
    }
    return a.prototype.initialize = function(a, b) {
      var c = this,
        d = [],
        e, f, g = this.editor.getModel();
      ...
      this.editor.changeDecorations(function(d) {
        var h = b + a.lines.length - 1,
          j = c.editor.getModel().getLineMaxColumn(h);
      ...
      }), this.listenersToRemove = [], this.listenersToRemove.push(this.editor.getModel().addListener(j.EventType.ModelContentChanged,
        function(a) {
          ...
          if (a.changeType === j.EventType.ModelContentChangedFlush) c.stopAll();
            ...
            var b = a.lineNumber,
              d = c.editor.getModel().getDecorationRange(c.highlightDecorationId);
        ...
        c.stopAll()
      })), this.listenersToRemove.push(this.editor.getModel().addListener(j.EventType.ModelDecorationsChanged,
        function(a) {
          if (c.isFinished) return;
          var b = !0;
          ...
          if (b) c.stopAll();
            ...
            var h = c.placeHolderDecorations[c.finishPlaceHolderIndex],
              i = c.editor.getModel().getDecorationRange(h),
              j = c.editor.getModel().getDecorationOptions(h),
              k = i.isEmpty(),
              l = j.className === "finish-snippet-placeholder",
              m = Number(k) ^ Number(l);
      ...
      this.isFinished = !0, this.listenersToRemove.forEach(function(a) {
        a()
      ...
      this.trackedPlaceHolders = [], this.binding.dispose(), this.editor.changeDecorations(function(b) {
        ...
        a.placeHolderDecorations = [], a.highlightDecorationId = null
      })
    }, a
  }(),
    o = function() {
      function a() {}
      return a.run = function(b, c, d, e) {
        ...
        var j = d.bind(h.getLineContent(i.startLineNumber), i.startLineNumber - 1, i.startColumn - 1, b),
          m = j.lines.join("\n"),
          o = new k.ReplaceCommand(i, m);
        b.executeCommand("editor.contrib.insertSnippetHelper", o);
        var p = a._getSnippetCursorOnly(j);
        p ? b.setSelection(new l.Selection(p.lineNumber, p.column, p.lineNumber, p.column)) : j.placeHolders.length >
          0 && new n(b, c, j, i.startLineNumber)
