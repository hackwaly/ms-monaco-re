define(["require", "exports", "vs/platform/platform", "vs/editor/core/constants", "vs/editor/core/range",
  ...
  var g = c,
    ...
    k = function() {
      function a(a) {
        var b = this;
        this.workerRequestTokenId = 0, this.workerRequest = null, this.workerRequestCompleted = !1, this.workerRequestValue =
          null, this.lastCursorPositionChangeTime = 0, this.renderDecorationsTimer = -1, this.editor = a, this.model =
          this.editor.getModel(), this.toUnhook = [], this.toUnhook.push(a.addListener(h.EventType.CursorPositionChanged,
            function(a) {
              b._onPositionChanged(a)
            })), this.toUnhook.push(a.addListener(h.EventType.ModelChanged, function(a) {
            b._stopAll(), b.model = b.editor.getModel()
          })), this.toUnhook.push(a.addListener("change", function(a) {
            b._stopAll()
          })), this._lastWordRange = null, this._decorationIds = [], this.workerRequestTokenId = 0, this.workerRequest =
          null, this.workerRequestCompleted = !1, this.workerRequestValue = null, this.lastCursorPositionChangeTime =
          0, this.renderDecorationsTimer = -1
      }
      return a.prototype._removeDecorations = function() {
        var a = this;
        ...
        this._lastWordRange = null, this._removeDecorations(), this.renderDecorationsTimer !== -1 && (window.clearTimeout(
          this.renderDecorationsTimer), this.renderDecorationsTimer = -1), this.workerRequest !== null && (this.workerRequest
          .cancel(), this.workerRequest = null), this.workerRequestCompleted || (this.workerRequestTokenId++, this.workerRequestCompleted = !
          0)
        ...
        var d = c.startLineNumber,
          e = c.startColumn,
          f = c.endColumn,
          g = this.model.getWordAtPosition({
            lineNumber: d,
            column: e
          }, !0);
        ...
        var h = new i.Range(d, g.startColumn, d, g.endColumn),
          j = this._lastWordRange && this._lastWordRange.equalsRange(h);
        ...
        if (j) this.workerRequestCompleted && this.renderDecorationsTimer !== -1 && (window.clearTimeout(this.renderDecorationsTimer),
          ...
          this.workerRequestCompleted = !1, this.workerRequest = this.model.getMode().occurrencesSupport.findOccurrences(
            this.model.getAssociatedResource(), this.editor.getPosition()), this.workerRequest.then(function(a) {
        ...
        var a = this,
          b = (new Date).getTime(),
          c = this.lastCursorPositionChangeTime + 250;
        ...
        for (var b = 0, c = this.workerRequestValue.length; b < c; b++) {
          var d = this.workerRequestValue[b],
            e = "wordHighlight",
            f = "rgba(246, 185, 77, 0.7)";
          d.kind && d.kind === "write" && (e += "Strong", f = "rgba(249, 206, 130, 0.7)"), a.push({
            range: d.range,
            options: {
              isOverlay: !1,
              className: e,
    ...
    l = function() {
      ...
      }, a.ID = "editor.contrib.wordHighlighter", a
    }(),
    m = g.Registry.as(j.Extensions.EditorContributions);
