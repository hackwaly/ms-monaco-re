define('vs/editor/contrib/contextmenu/contextmenu', [
  'require',
  'exports',
  ...
  'vs/editor/editor',
  'vs/editor/core/editorState',
  'vs/platform/handlerService',
  'vs/platform/actionRegistry',
  'vs/base/ui/widgets/actionbar',
  'vs/base/lifecycle',
  'vs/base/types',
  'vs/base/arrays',
  ...
  var v = function() {
    function e(e) {
      var t = this;
      this._editor = e, this._toDispose = [], this._contextMenuIsBeingShownCount = 0, this._editorActionsRequest = r.TPromise
        .as(null), this._toDispose.push(this._editor.addListener2(m.EventType.ContextMenu, function(e) {
          return t._onContextMenu(e);
        }));
    }
    return e.prototype.injectContextMenuService = function(e) {
      ...
      if (this._editor.getConfiguration().contextmenu && 12 !== e.target.type && (e.event.preventDefault(), 6 === e.target
        ...
        this._editor.focus(), e.target.position && !this._editor.getSelection().containsPosition(e.target.position) &&
      ...
      if (this.contextMenuService) {
        ...
        if (i && s) {
          ...
          if (a.length > 0) {
            this._editorActionsRequest.cancel(), this._editorState = l.capture(this._editor, 2);
      ...
      if (!a || f.isUndefinedOrNull(a.x) || f.isUndefinedOrNull(a.y)) {
        var u = this._editor.getScrolledVisiblePosition(this._editor.getPosition()),
          l = i.getDomNodePosition(this._editor.getDomNode()),
          d = l.left + u.left,
          p = l.top + u.top + u.height;
        a = {
      ...
      this.contextMenuService.showContextMenu(a, {
        ...
        onHide: function() {
          o._contextMenuIsBeingShownCount--, o._editor.focus(), o._editor.endForcedWidgetFocus(), o._editor.updateOptions({
            hover: s
          });
        }
      });
      ...
      this._contextMenuIsBeingShownCount > 0 && this.contextViewService.hideContextView(), this._toDispose = p.disposeAll(
        this._toDispose);
    }, e.ID = 'editor.contrib.contextmenu', e.MAX_WORKER_WAIT = 100, e.SEPARATOR = 'editor.action.separator', e.PREDEFINED = [
      'editor.actions.previewDeclaration',
      'editor.actions.goToDeclaration',
      'editor.actions.goToTypeDeclaration',
      e.SEPARATOR,
      'editor.actions.referenceSearch.trigger',
      e.SEPARATOR,
      'editor.actions.rename',
      'editor.actions.changeAll'
    ], e;
  }(),
    y = function(e) {
      function t(t, n) {
      ...
      }, t.ID = 'editor.action.showContextMenu', t;
    }(a.EditorAction),
    _ = s.Registry.as(a.Extensions.EditorContributions);
  _.registerEditorContribution(new s.BaseDescriptor(v)), _.registerEditorContribution(new d.ActionDescriptor(y, y.ID,
    n.localize('vs_editor_contrib_contextmenu_contextmenu', 1)));
})