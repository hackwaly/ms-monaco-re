...
define(["require", "exports", "vs/base/ui/widgets/findInput", "./findModel", "vs/base/dom/dom", "vs/base/errors",
  ...
  var y = function(a) {
    ...
    b.prototype.setState = function(a) {
      ...
      a.isReplaceEnabled ? this._enableReplace(!1) : this._disableReplace(!1);
    ...
    b.prototype.setModel = function(a) {
      ...
      a ? (this.model = a, this.modelListenersToRemove.push(this.model.addListener("start", function(a) {
    ...
    b.prototype.onFindValueChange = function() {
      this.findInput.getValue().length === 0 ? (this.$prevBtn.addClass("disabled"), this.$nextBtn.addClass("disabled"),
        this.$replaceBtn.addClass("disabled"), this.$replaceAllBtn.addClass("disabled")) : (this.$prevBtn.removeClass(
          "disabled"), this.$nextBtn.removeClass("disabled"), this.$replaceBtn.removeClass("disabled"), this.$replaceAllBtn
    ...
    b.prototype.buildDomNode = function() {
      ...
      j.addClass("button toggle left").on("click", function(b) {
        var c = new v.MouseEvent(b);
        a.isReplaceVisible ? a._disableReplace(!0) : a._enableReplace(!0);
