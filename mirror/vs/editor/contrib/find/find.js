...
define(["require", "exports", "vs/base/lib/winjs.base", "vs/platform/platform", "vs/platform/actionRegistry",
  ...
  var k = c,
    ...
    s = function() {
      function a(a) {
        var b = this;
        this.editor = a, this.handlerService = null, this.binding = null, this.model = null, this.widget = null, this
          .widgetIsVisible = !1, this.lastState = null, this.widgetListeners = [], this.editorListeners = [], this.editorListeners
          .push(this.editor.addListener(r.EventType.ModelChanged, function() {
            b.disposeBindingAndModel(), b.editor.getModel() && b.lastState && b.widgetIsVisible && b._start(b.lastState
              .isReplaceEnabled, !1, !1)
      ...
      return a.getFindController = function(b) {
        ...
        this.binding && (this.binding.dispose(), this.binding = null), this.widget && this.widget.setModel(null),
        ...
        b && !e.isEmpty() && e.startLineNumber === e.endLineNumber && (this.lastState.searchString = this.editor.getModel()
          .getValueInRange(e)), a && (this.lastState.isReplaceEnabled = a), this.model.start(this.lastState, c), this
          .widgetIsVisible = !0
      ...
      }, a.ID = "editor.contrib.findController", a
    }();
  b.FindController = s;
  var t = function(a) {
    function b(b, c) {
      a.call(this, b, c, n.Precondition.WidgetFocus), this.handlerService = null
    }
    return __extends(b, a), b.prototype.getEnablementState = function() {
      ...
      return this._startController(a), k.Promise.as(!0)
    }, b
  }(n.EditorAction);
  b.StartFindAction = t;
  var u = function(a) {
  ...
  var x = function(a) {
    function b(b, c) {
      a.call(this, b, c, n.Precondition.WidgetFocus), this.label = q.localize("replaceAction",
  ...
  var y = function(a) {
    function b(b, c) {
      a.call(this, b, c, n.Precondition.WidgetFocus), this.label = q.localize("replaceAllAction",
  ...
  z.registerEditorContribution(new m.ActionDescriptor(t, p.START_FIND_ID, q.localize("startFindAction", "Find"), {
    ...
    "Replace this instance"))), z.registerEditorContribution(new m.ActionDescriptor(y, p.REPLACE_ALL_ID, q.localize(
    "replace.replaceAll", "Replace all instances"))), z.registerEditorContribution(new l.BaseDescriptor(s))
})