...
define(["require", "exports", "vs/nls", "./parameterHintsModel", "./parameterHintsWidget", "vs/base/lib/winjs.base",
  ...
  var j = c,
    ...
    q = function(a) {
      function b(b, c) {
        a.call(this, b, c), this.model = new k.ParameterHintsModel(this.editor), this.parameterHintsWidget = null
      }
      return __extends(b, a), b.prototype.getModel = function() {
        return this.model
      }, b.prototype.injectHandlerService = function(b) {
        a.prototype.injectHandlerService.call(this, b), this.parameterHintsWidget || (this.parameterHintsWidget = new l
          .ParameterHintsWidget(this.model, this.editor, this.handlerService))
        ...
        a.prototype.dispose.call(this), this.model && (this.model.dispose(), this.model = null), this.parameterHintsWidget &&
          (this.parameterHintsWidget.destroy(), this.parameterHintsWidget = null)
      }, b.ID = "editor.contrib.parameterHints.trigger", b
    }(n.EditorAction);
