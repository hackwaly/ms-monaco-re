...
define(["require", "exports", "vs/base/lib/winjs.base", "vs/base/types", "vs/platform/platform",
  ...
  var l = c,
    ...
    u = function() {
      function a(a) {
        var b = this;
        this.editor = a, this.callOnDispose = [], this.callOnModel = [], this.callOnDispose.push(a.addListener(q.EventType
      ...
      return a.prototype.update = function() {
        ...
        var a = this,
          ...
          c = this.editor.getPosition().lineNumber,
          d = new p.Range(c, 1, c, b.getLineMaxColumn(c)),
          e = {
            range: d,
            id: b.addTrackedRange(d),
            lineText: b.getLineContent(c)
          }, f = new l.Promise(function(c, d, f) {
            b.getMode().formattingSupport.formatAfterKeystroke(b.getAssociatedResource(), a.editor.getPosition(), a
              .formattingOptions).then(function(a) {
              ...
              e.lineText = a.text, e.range = d, c(e)
            }, d, f)
          });
        f.then(function() {
          var b = new p.Range(e.range.startLineNumber, e.range.startColumn, e.range.endLineNumber, e.range.endColumn),
            c = a.editor.getSelection(),
            d = new t.ReplaceCommandThatPreservesSelection(b, e.lineText, c);
        ...
        while (this.callOnModel.length > 0) this.callOnModel.pop()()
      }, a.ID = "editor.contrib.autoFormat", a
    }(),
    v = function(a) {
      function b(b, c) {
        a.call(this, b, c)
      ...
      return __extends(b, a), b.prototype.getEnablementState = function() {
        ...
        var a = this,
          b = this.editor.getModel(),
          c = b.getMode(),
          d = b.getMode().formattingSupport,
          e = this.editor.getPosition(),
          f = this.editor.getSelection();
        ...
        if (!c.isEmpty()) {
          ...
          var f = a.getModel().getLineCount(),
            g = a.getModel().getLineMaxColumn(f),
            h = new t.ReplaceCommand(new p.Range(1, 1, f, g), d);
          a.executeCommand(this.id, h), a.setSelection(c)
        }
      }, b.ID = "editor.actions.format", b
    }(s.EditorAction);
  b.FormatAction = v;
  var w = new o.ActionDescriptor(v, v.ID, r.localize("formatAction.label", "Format code"), {
    ...
    x = n.Registry.as(s.Extensions.EditorContributions);
  x.registerEditorContribution(w), x.registerEditorContribution(new n.BaseDescriptor(u))
})