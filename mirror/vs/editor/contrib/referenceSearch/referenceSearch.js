...
define(["require", "exports", "vs/nls", "vs/base/lib/winjs.base", "vs/platform/services", "vs/platform/platform",
  ...
  var t = c,
    ...
    K = function(a) {
      function b(c) {
        a.call(this), this._references = c, this._references.sort(b.compare), this._currentReference = null
      }
      return __extends(b, a), b.compare = function(a, b) {
        return a.resourceUrl === b.resourceUrl ? a.range.startLineNumber - b.range.startLineNumber : B.localeCompare(
        ...
        set: function(a) {
          this._currentReference = a, this.emit(b.ON_CURRENT_REF, this)
        },
        enumerable: !0,
        configurable: !0
        ...
        return -1
      }, b.ON_CURRENT_REF = "references.model.onCurrentReferenceChanged", b
    }(C.EventEmitter),
    L = function() {
      function a() {}
      return a.prototype.getId = function(a, b) {
        ...
        var c = [];
        return b instanceof K && (c = b.references), u.Promise.as(c)
      }, a.prototype.hasChildren = function(a, b) {
        return b instanceof K
      }, a.prototype.getParent = function(a, b) {
        var c = null;
        return b instanceof K || (c = a.getInput()), u.Promise.as(c)
      }, a
    }(),
    M = function() {
      function a() {}
    ...
    N = function(a) {
      ...
      return __extends(b, a), b.prototype.onClick = function(c, d, e) {
        var f = a.prototype.onClick.call(this, c, d, e);
        return c.emit(e.detail === 2 ? b.Events.SELECTED : b.Events.FOCUSED, d), f
      }, b.prototype.onEscape = function(a, b) {
        return !1
      }, b.prototype.onEnter = function(c, d) {
        var e = a.prototype.onEnter.call(this, c, d);
        return c.emit(b.Events.SELECTED, c.getFocus()), e
      }, b.prototype.onUp = function(b, c) {
        return a.prototype.onUp.call(this, b, c), this.fakeFocus(b, c), !0
      }, b.prototype.onPageUp = function(b, c) {
        return a.prototype.onPageUp.call(this, b, c), this.fakeFocus(b, c), !0
      }, b.prototype.onLeft = function(b, c) {
        return a.prototype.onLeft.call(this, b, c), this.fakeFocus(b, c), !0
      }, b.prototype.onDown = function(b, c) {
        return a.prototype.onDown.call(this, b, c), this.fakeFocus(b, c), !0
      }, b.prototype.onPageDown = function(b, c) {
        return a.prototype.onPageDown.call(this, b, c), this.fakeFocus(b, c), !0
      }, b.prototype.onRight = function(b, c) {
        return a.prototype.onRight.call(this, b, c), this.fakeFocus(b, c), !0
      }, b.prototype.fakeFocus = function(a, c) {
        var d = a.getFocus();
        a.setSelection([d]), a.emit(b.Events.FOCUSED, d)
      }, b.Events = {
    ...
    O = function() {
      ...
      return a.prototype.getHeight = function(a, b) {
        ...
        var d = b,
          e = this.getHeight(a, b),
          f = d.resourceUrl.lastIndexOf("/"),
          g = (new z.URL(d.resourceUrl)).getScheme() === "inMemory" ? t.localize("references.label.fileNameLine",
            "line") : d.resourceUrl.substring(f + 1),
          h = t.localize("reference.label.lineNumber", ":{0}", d.range.startLineNumber);
        return D.Build.withElement(c).div({
          "class": "reference",
          text: g,
          title: g + h
        }, function(a) {
    ...
    P = function(a) {
      function b(b, c, d) {
        a.call(this, d, {
          frameColor: "#EFEFF2"
        }), this.editorService = b, this.requestService = c, this.toUnhook = [], this.tree = null, this.treeContainer =
          null, this.preview = null, this.previewContainer = null, this.previewDecorations = [], this.lastHeight =
          null, this.create()
      }
      return __extends(b, a), b.prototype.createArrow = function(b, c, d) {
        return a.prototype.createArrow.call(this, b, c, d)
      }, b.prototype.fillContainer = function(a) {
        var b = this,
          c = D.withElement(a);
        c.addClass("reference-zone-widget"), c.div({
          "class": "label"
        }, function(a) {
          ...
          c.readOnly = !0, c.scrollBeyondLastLine = !1, c.scrollbar = {
            useShadows: !1
          }, b.preview = new G.CodeEditorWidget(a.getHTMLElement(), c, null), b.previewContainer = a.hide()
        }), c.div({
          "class": "tree inline"
        }, function(a) {
          var c = {
          ...
          b.tree = new E.Tree(a.getHTMLElement(), c, d), b.treeContainer = a.hide()
        })
        ...
        this.labelContainer.text(t.localize("label.loading", "Loading...")).show(), this.treeContainer.hide(), this.previewContainer
          .hide(), this.show(a, 2)
      }, b.prototype.showNoResultsMessage = function(a) {
        this.labelContainer.text(t.localize("label.noresults", "No References Found")).show(), this.treeContainer.hide(),
          this.previewContainer.hide(), this.show(a, 2)
      }, b.prototype.showAtReference = function(a) {
        this.labelContainer.hide(), this.treeContainer.show(), this.previewContainer.show(), this.show(a.range, 18),
          this.focus()
        ...
        this.editorService.resolveEditorModel(c).done(function(c) {
          b.preview.setModel(c.getTextEditorModel()), b.preview.setSelection(a.range, !0, !0, !0), b.preview.changeDecorations(
            function(c) {
              var d = [],
                e = {
        ...
        }, A.onUnexpectedError), this.tree.setSelection([a]), this.tree.setFocus(a), this.tree.reveal(a)
      }, b.prototype.revealCurrentReference = function() {
        var a = this.model.currentReference.resourceUrl,
          b = this.model.currentReference.range;
        ...
        this.setModel(null), this.preview.destroy(), this.tree.dispose(), a.prototype.dispose.call(this)
      }, b.Events = {
    ...
    Q = function(a) {
      function b(b, c) {
        a.call(this, b, c, I.Precondition.WidgetFocus), this.handlerService = null, this.editorService = null, this.requestIdPool =
          0, this.model = null, this.modelRevealing = !1, this.widget = null, this.callOnClear = [], this.label = t.localize(
            "references.action.label", "Find references"), this.enabled = !1
      }
      return __extends(b, a), b.prototype.injectEditorService = function(a) {
        ...
        return !!this.handlerService && !! this.editorService && !! this.requestService && !! this.messageService &&
          a.prototype.getEnablementState.call(this) && !! this.editor.getModel().getMode().referenceSupport
      }, b.prototype.run = function() {
        var a = this,
          b = this.editor.getSelection(),
          c = this.widget ? this.widget.position : null,
          d = this.clear();
        if (d && !! c && b.containsPosition(c)) return null;
        var e = ++this.requestIdPool,
          f = this.editor.getModel(),
          g = this.editor.getModel().getMode().referenceSupport,
          h = this.telemetryService.start("findReferences", {
            mode: f.getMode().getId()
          });
        return g.findReferences(f.getAssociatedResource(), b.getStartPosition()).then(function(c) {
          if (e !== a.requestIdPool) {
            h.stop();
            return
          }
          if (c.length === 0) {
            a.widget.showNoResultsMessage(b), h.stop();
            return
          }
          a.model = new K(c);
          var d = a.model.findReferenceFromPosition(f.getAssociatedResource().toExternal(), b.getStartPosition());
          a.model.currentReference = a.model.references[d], a.callOnClear.push(a.model.addListener(K.ON_CURRENT_REF,
            function() {
              a.model.currentReference && (a.modelRevealing = !0, a.widget.revealCurrentReference().done(function() {
                a.modelRevealing = !1, window.setTimeout(function() {
                  a.widget.showReferencePreview(a.model.currentReference), a.widget.showAtReference(a.model
                    .currentReference)
                }, 0)
              }, A.onUnexpectedError))
            })), a._startTime = Date.now(), a.widget.setModel(a.model), a.widget.showAtReference(a.model.currentReference),
            a.widget.showReferencePreview(a.model.references[(d + 1) % a.model.references.length]), h.stop()
        }, function(b) {
          a.messageService.show(v.Severity.Error, b), h.stop()
          ...
          once: !0,
          id: "referenceSearch"
        }).dispose), this.callOnClear.push(this.editor.addListener(H.EventType.ModelModeChanged, function() {
          a.clear()
        })), this.callOnClear.push(this.editor.addListener(H.EventType.ModelChanged, function() {
          a.modelRevealing || a.clear()
        })), this.widget = new P(this.editorService, this.requestService, this.editor), this.widget.showLoading(b),
          this.callOnClear.push(this.widget.addListener(P.Events.EditorDoubleClick, function(b) {
            ...
            }).done(null, A.onUnexpectedError), a.clear()
          })), u.Promise.as(this.widget)
      }, b.prototype.clear = function() {
        this.telemetryService.log("zoneWidgetShown", {
          mode: "reference search",
          elapsedTime: Date.now() - this._startTime
        }), y.cAll(this.callOnClear), this.model = null;
        var a = !1;
        return this.widget !== null && (this.widget.dispose(), this.widget = null, a = !0), this.editor.focus(), this
          .requestIdPool += 1, a
      }, b.ID = "editor.actions.referenceSearch.trigger", b
    }(I.EditorAction);
  b.ReferenceAction = Q;
  var R = new x.ActionDescriptor(Q, Q.ID, t.localize("references.action.name", "Show references"), {
    ...
    S = w.Registry.as(I.Extensions.EditorContributions);
