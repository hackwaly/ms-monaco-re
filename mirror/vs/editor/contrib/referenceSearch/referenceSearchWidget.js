define("vs/editor/contrib/referenceSearch/referenceSearchWidget", ["require", "exports", "vs/nls!vs/editor/editor.main",
  "vs/base/collections", "vs/base/lifecycle", "vs/base/dom/dom", "vs/base/lib/winjs.base", "vs/base/strings",
  "vs/base/network", "vs/base/errors", "vs/base/dom/builder", "vs/base/ui/widgets/tree/treeImpl",
  "vs/base/ui/widgets/tree/treeDefaults", "vs/base/ui/widgets/leftRightWidget/leftRightWidget",
  "vs/base/ui/widgets/countBadge/countBadge", "vs/editor/core/range", "vs/editor/editor",
  "vs/editor/core/config/config", "vs/editor/core/constants", "vs/editor/core/embeddedCodeEditorWidget",
  "vs/editor/core/model/model", "vs/editor/contrib/zoneWidget/peekViewWidget", "./referenceSearchModel",
  ...
  var E = function() {
    function e(e, t) {
      ...
      this.decorationIgnoreSet = new i.HashSet;

      this.callOnDispose = [];

      this.callOnModelChange = [];

      this.callOnDispose.push(this.editor.addListener(y.EventType.ModelChanged, function() {
  ...
  var S = function() {
    ...
    e.prototype.getId = function(e, t) {
      return t instanceof w.Model ? "root" : t instanceof w.FileReferences ? t.id : t instanceof w.OneReference ? t.id :
        void 0;
    };
    ...
    e.prototype.getChildren = function(e, t) {
      var n = [];
      t instanceof w.Model ? n = t.children : t instanceof w.FileReferences && (n = t.children);

      return s.Promise.as(n);
    };

    e.prototype.getParent = function(e, t) {
      var n = null;
      t instanceof w.FileReferences ? n = t.parent : t instanceof w.OneReference && (n = t.parent);
  ...
  var x = function(e) {
    ...
    t.prototype.expandCollapse = function(e, t) {
      e.isExpanded(t) ? e.collapse(t).done(null, l.onUnexpectedError) : e.expand(t).done(null, l.onUnexpectedError);
    ...
    t.prototype.onPageUp = function(t, n) {
      e.prototype.onPageUp.call(this, t, n);
    ...
    t.prototype.onLeft = function(t, n) {
      e.prototype.onLeft.call(this, t, n);
    ...
    t.prototype.onPageDown = function(t, n) {
      e.prototype.onPageDown.call(this, t, n);
    ...
    t.prototype.onRight = function(t, n) {
      e.prototype.onRight.call(this, t, n);
  ...
  var L = function() {
    ...
    e.prototype.render = function(e, t, i) {
      if (r.clearNode(i), t instanceof w.FileReferences) {
        ...
        var s = c.$(".reference-file");
        new p.LeftRightWidget(s, function(e) {
          var t = o.resource.toExternal();
          c.$("a.name.plain").href(t).title(t).text(o.name).appendTo(e);

          c.$("span.directory").text(o.directory).appendTo(e);
        ...
        var d = u.preview.text.split(/\r\n|\r|\n/g);

        var h = 20;

        var g = d[u.preview.range.startLineNumber - 1];

        var m = g.replace(/^\s*/g, "");

        var v = g.length - m.length;

        var y = u.preview.range.startColumn - 1 - v;

        var _ = u.preview.range.endColumn - 1 - v;

        var b = new Array;
        b.push("<span>");

        b.push(m.substring(y - h, y));

        b.push("</span>");

        b.push('<span class="referenceMatch">');

        b.push(m.substring(y, _));

        b.push("</span>");

        b.push("<span>");

        b.push(m.substring(_, _ + h));

        b.push("</span>");

        l.innerHtml(b.join(a.empty)).appendTo(i);
      }
      return null;
    };
  ...
  var T = function(e) {
    ...
    t.prototype._onTitleClick = function(e) {
      if (this.preview && this.preview.getModel()) {
        ...
        var i = this.preview.getPosition().lineNumber;

        var o = new o.Range(i, 1, i, n.getLineMaxColumn(i));
    ...
    t.prototype._fillBody = function(e) {
      ...
      var i = c.$(e);
      i.addClass("reference-zone-widget");
      ...
      i.div({
        ...
        t.preview = new _.EmbeddedCodeEditorWidget(t.editor, e.getHTMLElement(), i, t.injectorService);

        t.previewContainer = e.hide();

        t.previewNotAvailableMessage = new b.Model(n.localize(
      ...
      i.div({
        ...
        t.tree = new d.Tree(e.getHTMLElement(), i, o);

        t.treeContainer = e.hide();
      });
    };
    ...
    t.prototype.setModel = function(e) {
      ...
      if (o.disposeAll(this.callOnModel), this.model = e, this.model) {
        this.decorationsManager = new E(this.preview, this.model);
    ...
    t.prototype.showAtReference = function(e) {
      this.container.addClass("results-loaded");
    ...
    t.prototype.dispose = function() {
      ...
      o.disposeAll([this.decorationsManager, this.preview, this.previewNotAvailableMessage, this.tree]);
