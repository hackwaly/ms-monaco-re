define('vs/editor/contrib/referenceSearch/referenceSearchModel', [
  'require',
  'exports',
  'vs/base/collections',
  'vs/base/network',
  ...
  ! function(e) {
    e.OnReferenceRangeChanged = 'refrence.rangeChanged', e.CurrentReferenceChanged = 'reference.currentChanged';
  }(t.EventType || (t.EventType = {}));
  var u = t.EventType,
    l = function() {
      function e(e, t) {
        this._parent = e, this._id = o.generateUuid(), this._range = t.range, this._preview = t.preview;
      }
      return e.prototype.equals = function(t) {
        ...
        set: function(e) {
          this._range = e, this.parent.parent.emit(u.OnReferenceRangeChanged, this);
        },
        enumerable: !0,
        configurable: !0
  ...
  var c = function() {
    function e(e, t, n) {
      this._parent = e, this._resource = t, this._path = n, this._children = [];
    }
  ...
  var d = function(e) {
    function t(t, r) {
      var s = this;
      e.call(this, [
        u.CurrentReferenceChanged,
        u.OnReferenceRangeChanged
      ...
      }), this._references = a.keys.toArray(), this._references.sort(function(e, t) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, 'children', {
      ...
      set: function(e) {
        this._currentReference = e, this.emit(u.CurrentReferenceChanged, this);
      },
      enumerable: !0,
      configurable: !0
    }), t.prototype.nextReference = function(e) {
      var t = e.parent.children.indexOf(e),
        n = e.parent.children.length,
        i = e.parent.parent.children.length;
