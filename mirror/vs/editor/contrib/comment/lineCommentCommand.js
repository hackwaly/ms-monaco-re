...
define(["require", "exports", "vs/editor/contrib/comment/blockCommentCommand", "vs/base/strings",
  ...
  var f = c,
    ...
    i = function(a) {
      function b(b) {
        a.call(this, b), this._hasDelegatedToParent = !1
      }
      return __extends(b, a), b.prototype._hasLineCommentTokensSupportForLines = function(a, b, c) {
        var d, e;
        for (var f = b; f <= c; f++) {
        ...
        this._moveEndPositionDown = !1, d.startLineNumber < d.endLineNumber && d.endColumn === 1 && (this._moveEndPositionDown = !
          0, d = d.setEndPosition(d.endLineNumber - 1, b.getLineMaxColumn(d.endLineNumber - 1)));
        ...
        if (!this._hasLineCommentTokensSupportForLines(b, d.startLineNumber, d.endLineNumber)) {
          ...
          var i = f.blockCommentStartToken,
            j = i.length,
            k = f.blockCommentEndToken,
            l = k.length,
            m = b.getLineContent(d.startLineNumber).lastIndexOf(i, d.startColumn - 1),
            n = b.getLineContent(d.endLineNumber).indexOf(k, d.endColumn - 1);
          m !== -1 && n !== -1 ? (d.startColumn = m + j + 1, d.endColumn = n + 1) : (d.startColumn = 1, d.endColumn =
            b.getLineMaxColumn(d.endLineNumber)), this._hasDelegatedToParent = !0, a.prototype._createOperationsForBlockComment
            .call(this, d, f, b, c);
          return
        }
        var o = !0,
        ...
        for (u = d.startLineNumber; u <= d.endLineNumber; u++) t = b.getModeAtPosition(u, 1).commentsSupport.getCommentsConfiguration()
          .lineCommentTokens[0], r[u - d.startLineNumber] = t, o && (p = b.getLineContent(u), s = g.firstNonWhitespaceIndex(
              p), s === -1 ? o = !1 : this._haystackHasNeedleAtOffset(p, t, s) || (o = !1), q[u - d.startLineNumber] =
            s);
        if (o)
        ...
        return this._moveEndPositionDown && (d = d.setEndPosition(d.endLineNumber + 1, 1)), d
      }, b
