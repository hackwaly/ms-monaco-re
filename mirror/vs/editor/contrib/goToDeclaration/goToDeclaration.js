...
define(["require", "exports", "vs/nls", "vs/base/env", "vs/base/network", "vs/base/async", "vs/base/strings",
  ...
  var t = c,
    ...
    K = function(a) {
      function b(b, c) {
        a.call(this, b, c, F.Precondition.TextFocus), this.editorService = null, this.messageService = null
      }
      return __extends(b, a), b.prototype.injectEditorService = function(a) {
        this.editorService = a, this.updateEnablementState()
      }, b.prototype.injectMessageService = function(a) {
        this.messageService = a, this.updateEnablementState()
      }, b.prototype.injectRequestService = function(a) {
        this.requestService = a
      }, b.prototype.getEnablementState = function() {
        return a.prototype.getEnablementState.call(this) && !! this.editorService && !! this.messageService && !!
          this.editor.getModel().getMode().declarationSupport
      }, b.prototype.run = function() {
        var a = this,
          b = this.editor.getModel(),
          c = this.editor.getModel().getMode().declarationSupport,
          d = this.editor.getPosition(),
          e = this.resolve(b.getAssociatedResource(), {
  ...
  var L = function(a) {
    ...
    }, b.ID = "editor.actions.goToTypeDeclaration", b
  }(K);
  ...
  var M = function(a) {
    ...
    }, b.ID = "editor.actions.goToDeclaration", b
  }(K);
  ...
  var N = function(a) {
    function b(b, c, d) {
      a.call(this, b, {
        ...
        showAbove: !0,
        frameColor: "#EFEFF2"
      }), this.model = c, this.range = d, this.widget = null, this.widgetContainer = null, this.create()
    }
    return __extends(b, a), b.prototype.fillContainer = function(a) {
      ...
      D.withElement(a).addClass("preview-zone-widget").div(function(a) {
        ...
        c.readOnly = !0, c.scrollBeyondLastLine = !1, c.scrollbar = {
          useShadows: !1
        }, b.widget = new E.CodeEditorWidget(a.getHTMLElement(), c, null), b.widget.setModel(b.model), b.reveal()
      })
      ...
      this.widget.destroy(), a.prototype.dispose.call(this)
    }, b
  }(G.ZoneWidget),
    O = function(a) {
      function b(b, c) {
        var d = this;
        a.call(this, b, c, F.Precondition.TextFocus), this.handlerService = null, this.editorService = null, this.toUnhook
          .push(b.addListener(H.EventType.ModelChanged, function() {
            d.clear()
      ...
      return __extends(b, a), b.prototype.injectEditorService = function(a) {
        ...
        return a.prototype.getEnablementState.call(this) && !! this.editorService && !! this.handlerService && !!
          this.editor.getModel().getMode().declarationSupport && !! this.editor.getModel().getMode().declarationSupport
          .findDeclaration
      }, b.prototype.run = function() {
        var a = this;
        this.clear();
        ...
        return c.findDeclaration(b.getAssociatedResource(), e).then(function(b) {
          ...
          return a.editorService.resolveEditorModel(c).then(function(c) {
            a.widget = new N(a.editor, c.getTextEditorModel(), b.range), a.widget.show(d, 18), a.widget.reveal();
            var e = (new Date).getTime();
            a.closeBinding = a.handlerService.bind({
              key: "Escape"
            }, function() {
              return a.telemetryService.log("zoneWidgetShown", {
        ...
        this.closeBinding !== null && (this.closeBinding.dispose(), this.closeBinding = null), this.widget && (this.widget
          .dispose(), this.widget = null)
      }, b.prototype.dispose = function() {
        this.clear(), a.prototype.dispose.call(this)
      }, b.ID = "editor.actions.previewDeclaration", b
    }(F.EditorAction);
  b.PreviewDeclarationAction = O;
  var P = new C.ActionDescriptor(O, O.ID, t.localize("actions.previewDecl.label", "View declaration")),
    Q = new C.ActionDescriptor(M, M.ID, t.localize("actions.goToDecl.label", "Go to definition"), {
      ctrlCmd: !u.browser.isMacintosh,
      key: "F12"
    }),
    R = new C.ActionDescriptor(L, L.ID, t.localize("actions.gotoTypeDecl.label", "Go to type"), {
      ctrlCmd: !0,
      shift: !u.browser.isMacintosh,
      key: "F12"
    }),
    S = A.Registry.as(F.Extensions.EditorContributions);
  S.registerEditorContribution(Q), S.registerEditorContribution(P), S.registerEditorContribution(R);
  var T = function() {
    function a(a) {
      var b = this;
      this.toUnhook = [], this.decorations = [], this.editor = a, this.throttler = new w.Throttler, this.toUnhook.push(
        this.editor.addListener(H.EventType.MouseUp, function(a) {
    ...
    return a.prototype.injectEditorService = function(a) {
      this.editorService = a
      ...
      if (this.isEnabled(b, c)) {
        var e = b.target.position,
          f = e ? this.editor.getModel().getWordAtPosition(e, !1) : null;
        if (!f) {
          this.removeDecorations();
          return
        }
        this.currentWordUnderMouse && this.currentPositionUnderMouse && (this.currentPositionUnderMouse.lineNumber !==
          e.lineNumber || this.currentWordUnderMouse.startColumn !== f.startColumn), this.currentPositionUnderMouse =
          e, this.currentWordUnderMouse = f, this.throttler.queue(function() {
            ...
            if (c && c.range && (c.range.startColumn !== f.startColumn || c.range.startLineNumber !== b.target.position
              ...
              if (c.preview && c.preview.text && c.preview.range) {
                var h = c.preview.text.split("\n"),
                  i = [],
                  j = c.preview.range,
                  k = j.startLineNumber - 1,
                  l = j.endLineNumber - 1;
                if (k < h.length && l < h.length) {
                  var m = null;
                  for (var n = k; i.length < a.MAX_SOURCE_PREVIEW_LINES && n <= l; n++) {
                    var o;
                    m === null ? (o = x.trim(x.trim(h[n], "	")), m = h[n].substr(0, h[n].length - o.length)) : h[n]
                      .indexOf(m) === 0 ? o = h[n].substring(m.length).replace("	", "    ") : o = h[n], o && i.push(
                        o)
                  }
      ...
      this.isEnabled(a) && this.gotoDefinition(a.target).done(function() {
        ...
        b.removeDecorations(), y.onUnexpectedError(a)
      })
      ...
      return this.findDefinition(a).then(function(c) {
        var d = a.position,
          e = b.editor.getModel().getWordAtPosition(d, !1);
    ...
    }, a.ID = "editor.contrib.gotodefinitionwithmouse", a.TRIGGER_MODIFIER = u.browser.isMacintosh ? "metaKey" :
      "ctrlKey", a.TRIGGER_KEY_VALUE = u.browser.isMacintosh ? "Meta" : "Ctrl", a.MAX_SOURCE_PREVIEW_LINES = 7, a
  }();
