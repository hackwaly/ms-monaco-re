define('vs/editor/core/config/config', [
  'require',
  'exports',
  'vs/base/env',
  'vs/editor/core/internalConstants'
], function(e, t, n, i) {
  function o(e, t) {
  ...
  t.ConfigClass = r, t.Config = new r(), t.Config.addKeyBinding(i.Handler.CursorLeft, {
    key: 'LeftArrow'
    ...
    alt: !0,
    key: 'DownArrow'
  }), t.Config.addKeyBinding(i.Handler.CursorWordLeft, o(!1, 'LeftArrow')), t.Config.addKeyBinding(i.Handler.CursorWordLeftSelect,
    o(!0, 'LeftArrow')), t.Config.addKeyBinding(i.Handler.CursorWordRight, o(!1, 'RightArrow')), t.Config.addKeyBinding(
    i.Handler.CursorWordRightSelect, o(!0, 'RightArrow')), t.Config.addKeyBinding(i.Handler.CursorDownSelect, o(!0,
    'DownArrow')), t.Config.addKeyBinding(i.Handler.CursorUpSelect, o(!0, 'UpArrow')), t.Config.addKeyBinding(i.Handler
    .DeleteWordLeft, o(!1, 'Backspace')), t.Config.addKeyBinding(i.Handler.DeleteWordRight, o(!1, 'Delete')), n.browser
    .isMacintosh ? (t.Config.addKeyBinding(i.Handler.CursorTop, {
      ctrlCmd: !0,
      key: 'UpArrow'
      ...
      shift: !0,
      key: 'DownArrow'
    }), n.browser.isOpera ? (t.Config.addKeyBinding(i.Handler.Undo, {
      winCtrl: !0,
      key: 'Z'
