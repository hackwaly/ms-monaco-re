define('vs/editor/core/config/configuration', [
  'require',
  'exports',
  ...
  'vs/platform/configurationRegistry',
  'vs/editor/core/handlerDispatcher',
  ...
  function v(e, t, n) {
    var i = parseInt(e, 10);
    return 'number' == typeof t && (i = Math.max(t, i)), 'number' == typeof n && (i = Math.min(n, i)), i;
  }
  var y = function() {
    function e(e) {
      this._keyBindings = r.clone(o.Config.keyBindings), this._editor = r.clone(o.Config.editor), this._mergeOptionsIn(
        e);
    }
    return e.prototype.getKeyBindings = function() {
      ...
      var t = Object.keys(e);
      t.push('stopLineTokenizationAfter'), t.push('stopRenderingLineAfter');
    ...
    _ = function() {
      function e() {}
      return e.readConfiguration = function(t) {
        return e.CACHE.hasOwnProperty(t) || (e.CACHE[t] = this._actualReadConfiguration(t)), e.CACHE[t];
        ...
        n.className = t, n.style.position = 'absolute', n.style.top = '-50000px', n.style.width = '50000px';
        for (var i = 0, o = e._USUAL_CHARS.length; o > i; i++)
          n.appendChild(document.createElement('br')), n.appendChild(e._createTestElement(i, e._USUAL_CHARS[i]));
        var r = e._testElementId(e._USUAL_CHARS.length),
          s = document.createElement('div');
        return s.id = r, s.appendChild(document.createTextNode('heightTestContent')), n.appendChild(document.createElement(
          'br')), n.appendChild(s), n;
        ...
        var i = e._readFromTestElements(),
          o = document.getElementById(e._testElementId(0)),
          r = f.getComputedStyle(o),
          s = e._getFontFromComputedStyle(r),
          a = parseInt(r.fontSize, 10),
          u = document.getElementById(e._testElementId(e._USUAL_CHARS.length)),
          l = u.clientHeight;
      ...
      }, e._USUAL_CHARS = '0123456789|', e.CACHE = {}, e;
    }(),
    b = function(e) {
      function t(t, n, i) {
        'undefined' == typeof n && (n = null), 'undefined' == typeof i && (i = null);
        var o = this;
        e.call(this, [d.EventType.ConfigurationChanged]), this._configWithDefaults = new y(t), this._indentationGuesser =
          i, this._computedIndentationOptions = null, this._isDominatedByLongLines = !1, this.handlerDispatcher = new l
          .HandlerDispatcher(), this._elementSizeObserver = new g.ElementSizeObserver(n, function() {
            var e = o.editor;
            o.editor = o._computeInternalOptions();
            var t = o._createConfigurationChangedEvent([]);
            t.observedOuterWidth = o.editor.observedOuterWidth !== e.observedOuterWidth, t.observedOuterHeight = o.editor
              .observedOuterHeight !== e.observedOuterHeight, o.emit(d.EventType.ConfigurationChanged, t);
      ...
      return __extends(t, e), t.prototype.observeReferenceElement = function() {
        this._elementSizeObserver.observe();
      }, t.prototype.dispose = function() {
        this._elementSizeObserver.dispose(), e.prototype.dispose.call(this);
        ...
        var e, t = this._configWithDefaults.getEditorOptions(),
          n = v(t.wrappingColumn, -1);
        e = 'undefined' != typeof t.stopLineTokenizationAfter ? v(t.stopLineTokenizationAfter, -1) : n >= 0 ? -1 :
          10000;
        var i;
        i = 'undefined' != typeof t.stopRenderingLineAfter ? v(t.stopRenderingLineAfter, -1) : n >= 0 ? -1 : 10000;
        var o = this._getEditorClassName(t.theme),
          r = _.readConfiguration(o),
          s = this._elementSizeObserver.getWidth(),
          a = this._elementSizeObserver.getHeight();
        return {
        ...
        var t = this,
          n = this._configWithDefaults.getKeyBindings(),
          i = e.bindGroup(function(e) {
            for (var i in n)
        ...
        this.editor = this._computeInternalOptions(), this._computedIndentationOptions = null, t.length > 0 && this.emit(
          d.EventType.ConfigurationChanged, this._createConfigurationChangedEvent(t));
      }, t.prototype._getEditorClassName = function(e) {
        var t = '';
        return i.browser.isIE11orEarlier ? t += 'ie ' : i.browser.isFirefox && (t += 'ff '), i.browser.isIE9 && (t +=
          'ie9 '), i.browser.isMacintosh && (t += 'mac '), 'monaco-editor ' + t + e;
        ...
        this._isDominatedByLongLines = e, this.editor.isDominatedByLongLines = e;
        ...
        var n = !1,
          i = 4;
        return 'auto' === e.tabSize && 'auto' === e.insertSpaces ? t && (n = t.insertSpaces, i = t.tabSize) : 'auto' ===
          e.tabSize ? (n = e.insertSpaces, t && (i = t.tabSize)) : (i = e.tabSize, t && (n = t.insertSpaces)), {
            insertSpaces: n,
            tabSize: i
        };
      }, t.prototype.getIndentationOptions = function() {
        return this._computedIndentationOptions || (this._computedIndentationOptions = this._computeIndentationOptions()),
          this._computedIndentationOptions;
        ...
        var t, n = this.getIndentationOptions(),
          i = 0;
        ...
        var t = p.firstNonWhitespaceIndex(e);
        return -1 === t && (t = e.length), this._normalizeIndentationFromWhitespace(e.substring(0, t)) + e.substring(
          t);
  ...
  var C = function() {
          ...
          for (var o = 0; o < i.length; o++) {
            ...
            if (t[e.LANGUAGES_SECTION]) {
              var p = t[e.LANGUAGES_SECTION],
                f = a.Registry.as(h.Extensions.EditorModes);
              for (var g in p)
    ...
    }, e.EDITOR_SECTION = 'editor', e.TERMINAL_SECTION = 'console', e.LANGUAGES_SECTION = h.LANGUAGE_CONFIGURATION, e;
  }();
