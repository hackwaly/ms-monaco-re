...
define(["require", "exports", "vs/nls", "vs/base/env", "./config", "vs/base/objects", "vs/base/types",
  ...
  var o = c,
    ...
    A = {}, B = function(a) {
      function b(b) {
        a.call(this), this.keyBindings = r.clone(q.Config.keyBindings), this.editor = r.clone(q.Config.editor), this._mergeOptionsIn(
          b), this.handlerDispatcher = new v.HandlerDispatcher, this._readCSSConfiguration()
      }
      return __extends(b, a), b.prototype._mergeOptionsIn = function(a) {
        a = a || {};
        if (a.keyBindings)
        ...
        var c = typeof a.stopLineTokenizationAfter != "undefined",
          d = typeof a.stopRenderingLineAfter != "undefined";
        this.editor = r.mixin(this.editor, a), !c && this.editor.wrappingColumn >= 0 && (this.editor.stopLineTokenizationAfter = -
          1), !d && this.editor.wrappingColumn >= 0 && (this.editor.stopRenderingLineAfter = -1), this._validateOptions()
      }, b.prototype._validateOptions = function() {
        this.editor.tabSize = Math.max(1, this._ensureInteger(this.editor.tabSize)), this.editor.lineNumbersMinChars =
          Math.max(1, this._ensureInteger(this.editor.lineNumbersMinChars))
      }, b.prototype._ensureInteger = function(a) {
        return Math.round(parseInt(a, 10))
      }, b.prototype.bindKeys = function(a) {
        var b = this,
          c = a.bindGroup(function(a) {
        ...
        var b = this.editor.wrappingColumn,
          c = !! this.editor.viewWordWrap;
        this._mergeOptionsIn(a);
        var d = !! this.editor.viewWordWrap,
          e = this.editor.wrappingColumn;
        ...
        var a = "";
        return p.browser.isIE10 ? a += "ie " : p.browser.isFirefox && (a += "ff "), p.browser.isMacintosh && (a +=
          "mac "), "monaco-editor " + a + this.editor.theme
  ...
  var C = function() {
      ...
      return b.getConfiguration().then(function(b) {
        ...
        if (b[a.LANGUAGES_SECTION]) {
          var d = b[a.LANGUAGES_SECTION],
            e = t.Registry.as(z.Extensions.EditorModes);
          for (var f in d)
    ...
    }, a.EDITOR_SECTION = "editor", a.LANGUAGES_SECTION = z.LANGUAGE_CONFIGURATION, a
  }();
