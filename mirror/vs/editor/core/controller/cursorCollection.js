  ...
  function(a, b, c, d, e) {
    ...
    var i = function() {
      function a(a, b, c, d) {
        ...
        this.viewModelHelper = d;

        this.modeConfiguration = this.getModeConfiguration();

        this.primaryCursor = new f.OneCursor(this.editorId, this.model, this.configuration, this.modeConfiguration,
      ...
      a.prototype.getAll = function() {
        var a = [];
        a.push(this.primaryCursor);

        a = a.concat(this.secondaryCursors);
      ...
      a.prototype.getPositions = function() {
        ...
        for (var b = 0, c = this.secondaryCursors.length; b < c; b++) {
          a.push(this.secondaryCursors[b].getPosition());
        }
        return a;
      };
      ...
      a.prototype.getViewPositions = function() {
        ...
        for (var b = 0, c = this.secondaryCursors.length; b < c; b++) {
          a.push(this.secondaryCursors[b].getViewPosition());
        }
        return a;
      };
      ...
      a.prototype.getSelections = function() {
        ...
        for (var b = 0, c = this.secondaryCursors.length; b < c; b++) {
          a.push(this.secondaryCursors[b].getSelection());
        }
        return a;
      };
      ...
      a.prototype.getViewSelections = function() {
        ...
        for (var b = 0, c = this.secondaryCursors.length; b < c; b++) {
          a.push(this.secondaryCursors[b].getViewSelection());
        }
        return a;
      };

      a.prototype.setSelections = function(a) {
        this.primaryCursor.setSelection(a[0]);

        this._setSecondarySelections(a.slice(1));
      };
      ...
      a.prototype.normalize = function() {
        ...
        for (var a = 0, b = this.secondaryCursors.length; a < b; a++) {
          this.secondaryCursors[a].adjustBracketDecorations();
        }
      };
      ...
      a.prototype._setSecondarySelections = function(a) {
        ...
        for (var f = 0; f < c; f++) {
          if (a[f]) {
            this.secondaryCursors[f].setSelection(a[f]);
          }
        }
        return d;
      };
      ...
      a.prototype._removeSecondaryCursor = function(a) {
        if (this.lastAddedCursorIndex >= a + 1) {
          this.lastAddedCursorIndex--;
        }

        this.secondaryCursors[a].dispose();

        this.secondaryCursors.splice(a, 1);
      };
      ...
      a.prototype._mergeCursorsIfNecessary = function() {
        ...
        b.sort(function(a, b) {
          return a.selection.startLineNumber === b.selection.startLineNumber ? a.selection.startColumn - b.selection.startColumn :
        ...
        for (var d = 0; d < b.length - 1; d++) {
          ...
          if (i.getStartPosition().isBeforeOrEqual(h.getEndPosition())) {
            ...
            var q = n.selectionStartLineNumber === n.startLineNumber && n.selectionStartColumn === n.startColumn;

            var r = o.selectionStartLineNumber === o.startLineNumber && o.selectionStartColumn === o.startColumn;

            var s;
            if (l === this.lastAddedCursorIndex) {
              s = q;
            ...
            var t;
            if (s) {
              t = new g.Selection(p.startLineNumber, p.startColumn, p.endLineNumber, p.endColumn);
            } else {
              t = new g.Selection(p.endLineNumber, p.endColumn, p.startLineNumber, p.startColumn);
            }
            ...
            this._removeSecondaryCursor(l - 1);
      ...
      a.prototype.getModeConfiguration = function() {
        ...
        if (this.model.getMode().electricCharacterSupport) try {
          ...
          h.onUnexpectedError(d);

          c = null;
        }
        if (c)
          for (a = 0; a < c.length; a++) {
            b.electricChars[c[a]] = !0;
          }
        var e;
        ...
        if (e)
          for (a = 0; a < e.length; a++) {
            b.autoClosingPairsOpen[e[a].open] = e[a].close;
            b.autoClosingPairsClose[e[a].close] = e[a].open;
          }
        var f;
        if (this.model.getMode().characterPairSupport) try {
        ...
        if (f)
          for (a = 0; a < f.length; a++) {
            b.surroundingPairs[f[a].open] = f[a].close;
          }
        return b;
      };
