define('vs/editor/core/view/parts/zones/zones', [
  'require',
  'exports',
  'vs/base/types',
  ...
  var o = function(e) {
    function t(t, n) {
      e.call(this, t), this._whitespaceManager = n, this.domNode = document.createElement('div'), this.domNode.className =
        'view-zones', this.domNode.style.position = 'absolute', this.domNode.setAttribute('role', 'presentation'),
        this.domNode.setAttribute('aria-hidden', 'true'), this._zones = {};
    }
    return __extends(t, e), t.prototype.dispose = function() {
      e.prototype.dispose.call(this), this._whitespaceManager = null, this._zones = {};
      ...
      var t = this._heightInLinesToPixels(e.heightInLines),
        i = this._whitespaceManager.addWhitespace(this._computeWhitespaceAfterLineNumber(e), t),
        o = {
          whitespaceId: i,
          delegate: e,
          isVisible: !1
        };
      return n.isFunction(o.delegate.onComputedHeight) && o.delegate.onComputedHeight(t), this._requestModificationFrame(
        function() {
          o.delegate.domNode.style.position = 'absolute', o.delegate.domNode.style.height = t + 'px', o.delegate.domNode
            .style.width = '100%', o.delegate.domNode.style.display = 'none';
        }), this._zones[o.whitespaceId.toString()] = o, this.domNode.appendChild(o.delegate.domNode), o.whitespaceId;
    }, t.prototype.removeZone = function(e) {
      if (this._zones.hasOwnProperty(e.toString())) {
        var t = this._zones[e.toString()];
        return delete this._zones[e.toString()], this._whitespaceManager.removeWhitespace(t.whitespaceId), this._requestModificationFrame(
          function() {
      ...
      var i = this,
        o = this._whitespaceManager.getWhitespaceViewportData();
      t && (t.renderedViewZones += o.length), this._requestModificationFrame(function() {
        var t, r, s = {}, a = !1;
        for (t = 0, r = o.length; r > t; t++)
          s[o[t].id.toString()] = o[t], a = !0;
        var u, l;
        for (u in i._zones)
          i._zones.hasOwnProperty(u) && (l = i._zones[u], s.hasOwnProperty(u) ? (l.delegate.domNode.style.top = e.getScrolledTopFromAbsoluteTop(
            ...
            .onDomNodeTop(e.getScrolledTopFromAbsoluteTop(-1000000))));
