define('vs/editor/core/view/parts/overviewRuler/overviewRuler', [
  'require',
  'exports',
  ...
  var o = function(e) {
    function t(t, i, o, r, s, a) {
      e.call(this), this._context = t, this._overviewRuler = new n.OverviewRulerImpl(0, i, o, this._context.configuration
        .editor.lineHeight, r, s, a), this._context.addEventHandler(this);
    }
    return __extends(t, e), t.prototype.destroy = function() {
      this.dispose();
    }, t.prototype.dispose = function() {
      this._context.removeEventHandler(this), this._overviewRuler.dispose();
      ...
      return this._overviewRuler.setScrollHeight(e, !0), !0;
