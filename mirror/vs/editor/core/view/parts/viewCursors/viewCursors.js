define('vs/editor/core/view/parts/viewCursors/viewCursors', [
  'require',
  'exports',
  'vs/editor/core/view/parts/viewCursors/viewCursor',
  ...
  var r = function(e) {
    function t(t) {
      e.call(this, t), this._primaryCursor = new n.ViewCursor(this._context, !1), this._secondaryCursors = [], this._domNode =
        document.createElement('div'), this._domNode.className = 'cursors-layer', this._domNode.appendChild(this._primaryCursor
          .getDomNode()), this._blinkTimer = -1, this._editorHasFocus = !1, this._updateBlinking();
    }
    return __extends(t, e), t.prototype.dispose = function() {
      e.prototype.dispose.call(this), -1 !== this._blinkTimer && (window.clearInterval(this._blinkTimer), this._blinkTimer = -
        1);
      ...
      return this._secondaryCursors = [], !0;
      ...
      if (this._primaryCursor.onCursorPositionChanged(e.position, e.isInEditableRange), this._updateBlinking(), this._secondaryCursors
        ...
        for (var r = this._secondaryCursors.length - e.secondaryPositions.length, i = 0; r > i; i++)
          this._secondaryCursors[0].getDomNode().parentNode.removeChild(this._secondaryCursors[0].getDomNode()), this
            ._secondaryCursors.splice(0, 1);
      ...
      return this._editorHasFocus = e, this._updateBlinking(), !1;
      ...
      1 === n || 2 === n ? this._show() : this._hide(), 2 === n && (this._blinkTimer = window.setInterval(function() {
        return e._blink();
      }, t.BLINK_INTERVAL));
