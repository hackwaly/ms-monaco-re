...
define(["require", "exports", "vs/editor/core/view/viewContext", "vs/editor/editor",
  ...
  var i = function(a) {
    function b(b) {
      ...
      this.domNode.className = f.ClassNames.OVERLAY_WIDGETS;
    ...
    b.prototype.onLayoutChanged = function(a) {
      this.verticalScrollbarWidth = a.verticalScrollbarWidth;
    ...
    b.prototype._renderWidget = function(a) {
      ...
      if (a.preference === g.OverlayWidgetPositionPreference.TOP_RIGHT_CORNER) {
        ...
        b.style.right = 2 * this.verticalScrollbarWidth + "px";
      }
    };
    ...
    b.prototype.render = function(a, b) {
      ...
      for (c in this.widgets) {
        if (this.widgets.hasOwnProperty(c)) {
          this._renderWidget(this.widgets[c]);
        }
      }
    };
