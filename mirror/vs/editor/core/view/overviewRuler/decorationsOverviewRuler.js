...
define(["require", "exports", "vs/editor/core/view/overviewRuler/overviewRulerImpl",
  ...
  var e = c,
    ...
    g = function(a) {
      function b(c, d, f) {
        a.call(this), this.context = c, this.overviewRuler = new e.OverviewRulerImpl("decorationsOverviewRuler", d,
          this.context.configuration.editor.lineHeight, b.DECORATION_HEIGHT, b.DECORATION_HEIGHT, f), this.shouldUpdateDecorations = !
          0, this.hasDecorations = !1, this.context.addEventHandler(this)
      }
      return __extends(b, a), b.prototype.dispose = function() {
        ...
        return this.overviewRuler.setLayout(a.overviewRuler, !1), !0
        ...
        return this.overviewRuler.setScrollHeight(a, !1), !0
        ...
        if (this.shouldUpdateDecorations) {
          ...
          var b = this.context.model.getAllDecorations(),
            c = [],
            d, e, f;
          for (d = 0, e = b.length; d < e; d++) f = b[d], f.options.showInOverviewRuler && c.push({
            startLineNumber: f.range.startLineNumber,
            endLineNumber: f.range.endLineNumber,
            color: f.options.showInOverviewRuler
          });
          this.hasDecorations = c.length > 0, this.overviewRuler.setZones(c, !1)
        }
        return null
      }, b.prototype.render = function(a, b) {
        if (!this.shouldRender) return;
        this.shouldRender = !1, this.overviewRuler.render();
        if (this.hasDecorations && e.hasCanvas) {
          var c = this.overviewRuler.getDomNode().getContext("2d");
          c.fillStyle = "rgba(197,197,197,0.4)", c.fillRect(0, 0, this.overviewRuler.getWidth(), 1), c.fillRect(0, 0,
            1, this.overviewRuler.getHeight()), c.fillRect(0, this.overviewRuler.getHeight() - 1, this.overviewRuler.getWidth(),
            1)
        }
      }, b.DECORATION_HEIGHT = 4, b
    }(f.ViewEventHandler);
