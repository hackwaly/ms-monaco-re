...
define(["require", "exports", "vs/base/types", "vs/editor/core/view/viewEventHandler"], function(a, b, c, d) {
  var e = c,
    ...
    g = function(a) {
      function b(b, c) {
        a.call(this), this.context = b, this.whitespaceManager = c, this.domNode = document.createElement("div"),
          this.domNode.className = "view-zones", this.domNode.style.position = "absolute", this.domNode.setAttribute(
            "role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this.zones = {}, this.context.addEventHandler(
            this)
      }
      return __extends(b, a), b.prototype.dispose = function() {
        ...
        var b = this.heightInLinesToPixels(a.heightInLines),
          c = this.whitespaceManager.addWhitespace(this.computeWhitespaceAfterLineNumber(a), b),
          d = {
            whitespaceId: c,
            delegate: a,
            isVisible: !1
          };
        return e.isFunction(d.delegate.onComputedHeight) && d.delegate.onComputedHeight(b), d.delegate.domNode.style.position =
          "absolute", d.delegate.domNode.style.height = b + "px", d.delegate.domNode.style.width = "100%", d.delegate
          .domNode.style.display = "none", this.zones[d.whitespaceId.toString()] = d, this.domNode.appendChild(d.delegate
            .domNode), d.whitespaceId
      }, b.prototype.removeZone = function(a) {
        if (this.zones.hasOwnProperty(a.toString())) {
          var b = this.zones[a.toString()];
          return delete this.zones[a.toString()], b.delegate.domNode.parentNode && b.delegate.domNode.parentNode.removeChild(
            b.delegate.domNode), this.whitespaceManager.removeWhitespace(b.whitespaceId), !0
        }
        return !1
        ...
        var c = {}, d, f, g = !1;
        for (d = 0, f = a.data.length; d < f; d++) c[a.data[d].id.toString()] = a.data[d], g = !0;
        var h, i;
