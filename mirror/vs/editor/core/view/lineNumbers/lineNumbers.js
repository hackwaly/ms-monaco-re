...
define(["require", "exports", "vs/editor/core/view/viewContext", "vs/editor/core/view/viewEventHandler",
  ...
  var e = c,
    ...
    g = function(a) {
      function b(b) {
        a.call(this), this.context = b, this.lineNumbersLeft = 0, this.lineNumbersWidth = 0, this.previousRender = [],
      ...
      return __extends(b, a), b.prototype.dispose = function() {
        ...
        return this.lineNumbersLeft = a.lineNumbersLeft, this.lineNumbersWidth = a.lineNumbersWidth, !0
        ...
        var c, d;
        b.push('<div class="'), b.push(e.ClassNames.LINE_NUMBERS), b.push('" style="left:'), b.push(this.lineNumbersLeft
          .toString()), b.push("px;width:"), b.push(this.lineNumbersWidth.toString()), b.push("px;height:"), b.push(a
        ...
        for (d = a.visibleRange.startLineNumber; d <= a.visibleRange.endLineNumber; d++) c = a.getViewportVerticalOffsetForLineNumber(
          d), b.push('<div style="top:'), b.push(c.toString()), b.push('px;">'), b.push(this.context.model.getLineRenderLineNumber(
          d)), b.push("</div>");
        return b.push("</div>"), b
