...
define(["require", "exports", "vs/editor/core/view/viewContext", "vs/editor/core/view/viewEventHandler",
  ...
  var g = function(a) {
    ...
    b.prototype.onLayoutChanged = function(a) {
      this.decorationsLeft = a.decorationsLeft;

      this.decorationsWidth = a.decorationsWidth;
    ...
    b.prototype.actualRender = function(a) {
      ...
      b.push(e.ClassNames.LINES_DECORATIONS);

      b.push('" style="left:');

      b.push(this.decorationsLeft.toString());

      b.push("px;width:");

      b.push(this.decorationsWidth.toString());
