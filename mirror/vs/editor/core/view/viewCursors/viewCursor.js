define(["require", "exports"], function(a, b) {
  var c = function() {
    function a(a, b) {
      this.context = a, this.isInEditableRange = !0, this.domNode = this._createCursorDomNode(b), this.isVisible = !0,
        this.updatePosition({
          lineNumber: 1,
          column: 1
        })
    }
    return a.prototype._createCursorDomNode = function(a) {
      var b = document.createElement("div");
      return b.className = "cursor", a && (b.className += " secondary"), b.style.height = this.context.configuration.editor
        .lineHeight + "px", b.style.top = "0px", b.style.left = "0px", b.setAttribute("role", "presentation"), b.setAttribute(
          "aria-hidden", "true"), b
      ...
      return this.updatePosition({
        lineNumber: 1,
        column: 1
      }), this.isInEditableRange = !0, !0
    }, a.prototype.onCursorPositionChanged = function(a, b) {
      return this.updatePosition(a), this.isInEditableRange = b, !0
      ...
      this.domNode.style.left = this.positionLeft - a.viewportLeft + "px", this.domNode.style.top = this.positionTop +
        "px"
    }, a.prototype.updatePosition = function(a) {
      this.position = a, this.domNode.setAttribute("lineNumber", this.position.lineNumber.toString()), this.domNode.setAttribute(
        "column", this.position.column.toString()), this.positionTop = -1e3, this.positionLeft = -1e3
    }, a
  }();
  b.ViewCursor = c
})