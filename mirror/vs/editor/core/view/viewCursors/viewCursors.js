...
define(["require", "exports", "vs/editor/core/view/viewEventHandler", "vs/editor/core/view/viewCursors/viewCursor",
  ...
  var e = c,
    ...
    g;
  (function(a) {
    a[a.Hidden = 0] = "Hidden", a[a.Visible = 1] = "Visible", a[a.Blink = 2] = "Blink"
  })(g || (g = {}));
  var h = function(a) {
    function b(b) {
      a.call(this), this.context = b, this.primaryCursor = new f.ViewCursor(this.context, !1), this.secondaryCursors = [],
        this.domNode = document.createElement("div"), this.domNode.className = "cursors-layer", this.currentLine =
        document.createElement("div"), this.currentLine.className = "current-line", this.currentLineIsVisible = !0,
        this.currentLine.style.width = "0px", this.currentLine.style.height = this.context.configuration.editor.lineHeight +
        "px", this.domNode.appendChild(this.currentLine), this.domNode.appendChild(this.primaryCursor.getDomNode()),
        this.blinkTimer = -1, this.selectionIsEmpty = !0, this.editorHasFocus = !1, this.updateCurrentLine(), this.updateBlinking(),
        this.context.addEventHandler(this)
    }
    return __extends(b, a), b.prototype.dispose = function() {
      this.context.removeEventHandler(this), this.blinkTimer !== -1 && (window.clearInterval(this.blinkTimer), this.blinkTimer = -
        1)
      ...
      this.primaryCursor.onCursorPositionChanged(a.position, a.isInEditableRange), this.updateBlinking(), this.updateCurrentLine();
      if (this.secondaryCursors.length < a.secondaryPositions.length) {
        ...
        for (var c = 0; c < e; c++) this.secondaryCursors[0].getDomNode().parentNode.removeChild(this.secondaryCursors[
          0].getDomNode()), this.secondaryCursors.splice(0, 1)
      }
      ...
      return this.selectionIsEmpty = a.selection.isEmpty(), this.updateCurrentLine(), !1
      ...
      return this.domNode.style.left = a.contentLeft + "px", !0
      ...
      return this.editorHasFocus = a, this.updateBlinking(), !1
      ...
      c === g.Visible || c === g.Blink ? this._show() : this._hide(), c === g.Blink && (this.blinkTimer = window.setInterval(
        function() {
          return a._blink()
        }, b.BLINK_INTERVAL))
      ...
      if (!this.shouldRender) return;
      this.shouldRender = !1, this.primaryCursor.render(a);
      for (var b = 0, c = this.secondaryCursors.length; b < c; b++) this.secondaryCursors[b].render(a);
      this.currentLine.style.top = this.primaryCursor.getPositionTop() + "px", this.currentLine.style.width = a.scrollWidth +
        "px"
    }, b.BLINK_INTERVAL = 500, b
  }(e.ViewEventHandler);
  b.ViewCursors = h
})