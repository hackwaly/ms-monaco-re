define(["require", "exports", "vs/base/ui/scrollbar/scrollableElement", "vs/editor/core/constants",
  ...
  var p = function() {
    function a(a, b, c, d) {
      ...
      this.privateViewEventBus = b;

      this.linesContent = c;

      this.scrollable = new l.EditorScrollable(c);

      this.toDispose.push(this.scrollable);

      this.toDispose.push(this.scrollable.addScrollListener(function(a) {
      ...
      o(this.configuration.editor.scrollbar, f, "verticalHasArrows");

      o(this.configuration.editor.scrollbar, f, "horizontalHasArrows");

      o(this.configuration.editor.scrollbar, f, "verticalScrollbarSize");

      o(this.configuration.editor.scrollbar, f, "horizontalScrollbarSize");

      o(this.configuration.editor.scrollbar, f, "useShadows");

      o(this.configuration.editor.scrollbar, f, "handleMouseWheel");

      o(this.configuration.editor.scrollbar, f, "arrowSize");

      this.scrollbar = new i.ScrollableElement(c, f);
      ...
      var g = function(a, b, c) {
        if (b) {
          var d = a.scrollTop;
          if (d) {
            e.scrollable.setScrollTop(e.getScrollTop() + d);
            a.scrollTop = 0;
          }
        }
        if (c) {
          var f = a.scrollLeft;
          if (f) {
            e.scrollable.setScrollLeft(e.getScrollLeft() + f);
            a.scrollLeft = 0;
          }
        }
      };
    ...
    a.prototype.dispose = function() {
      this.toDispose = n.disposeAll(this.toDispose);
    ...
    a.prototype.delegateVerticalScrollbarMouseDown = function(a) {
      if (this.scrollbar) {
        this.scrollbar.delegateVerticalScrollbarMouseDown(a);
      }
    };
