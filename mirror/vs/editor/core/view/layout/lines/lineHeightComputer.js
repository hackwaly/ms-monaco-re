define(["require", "exports"], function(a, b) {
  var c = function() {
    ...
    a.prototype.replaceLines = function(a, b) {
      ...
      if (b) {
        this.isAccurate = [];
        for (var c = 0; c < this.heights.length; c++) {
          this.isAccurate[c] = !0;
        }
      } else {
    ...
    a.prototype.resetLineHeightsAndMarkAsValid = function() {
      ...
      var b;
      for (a = 0, b = this.heights.length; a < b; a++) {
        this.heights[a] = 1;
      }
      for (a = 0, b = this.isAccurate.length; a < b; a++) {
        this.isAccurate[a] = !0;
      }
      this.prefixSumValidIndex = 0;
    };
    ...
    a.prototype.onModelLinesDeleted = function(a, b) {
      this.heights.splice(a, b - a + 1);

      this.isAccurate.splice(a, b - a + 1);

      this.prefixSum.splice(a, b - a + 1);
    ...
    a.prototype.onModelLinesInserted = function(a, b, c) {
      for (var d = a; d <= b; d++) {
        this.heights.splice(d, 0, 1);
        this.isAccurate.splice(d, 0, c);
        this.prefixSum.splice(d, 0, 1);
      }
      this.prefixSumValidIndex = Math.min(this.prefixSumValidIndex, a - 1);
    };
    ...
    a.prototype.getAccumulatedHeight = function(a) {
      ...
      if (b === 1) {
        this.prefixSum[1] = this.heights[1];
        b++;
      }
      for (var c = b; c <= a; c++) {
