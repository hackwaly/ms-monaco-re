define(["require", "exports", "vs/base/env"], function(a, b, c) {
  ...
  var e = function() {
    ...
    return a.prototype.doMeasurements = function() {
      ...
      for (var b = 0, c = this.charactersToMeasure.length; b < c; b++) a.appendChild(document.createElement("br")), a
        .appendChild(this._createTestElement(b, this.charactersToMeasure[b]));
      return a
