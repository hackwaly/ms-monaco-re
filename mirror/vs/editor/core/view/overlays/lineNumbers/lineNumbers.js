define("vs/editor/core/view/overlays/lineNumbers/lineNumbers", ["require", "exports", "vs/editor/core/view/viewContext",
  "vs/editor/core/view/viewEventHandler", "vs/css!./lineNumbers"
], function(e, t, n, i) {
  var o = function(e) {
    function t(t) {
      e.call(this);
    ...
    t.prototype.onLayoutChanged = function(e) {
      this._lineNumbersLeft = e.lineNumbersLeft;

      this._lineNumbersWidth = e.lineNumbersWidth;
