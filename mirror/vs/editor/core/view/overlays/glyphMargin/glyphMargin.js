define('vs/editor/core/view/overlays/glyphMargin/glyphMargin', [
  'require',
  'exports',
  ...
  var o = function(e) {
    function t(t) {
      e.call(this), this._context = t, this._glyphMarginLeft = 0, this._glyphMarginWidth = 0, this._previousRender =
    ...
    return __extends(t, e), t.prototype.dispose = function() {
      ...
      return this._glyphMarginLeft = e.glyphMarginLeft, this._glyphMarginWidth = e.glyphMarginWidth, !0;
      ...
      var o, r, s, a, u, l, c, d, h, p, f = this._context.model.getDecorationsInRange(e.visibleRange),
      ...
      for (a = 0, u = f.length; u > a; a++)
        ...
        for (h = 0, p = s.length; p > h; h++)
          l = s[h].top, m.hasOwnProperty(l.toString()) || (m[l.toString()] = {}), m[l.toString()][o.options.glyphMarginClassName] = !
            0;
      t.push('<div class="'), t.push(n.ClassNames.GLYPH_MARGIN), t.push('" style="left:'), t.push(this._glyphMarginLeft
        .toString()), t.push('px;width:'), t.push(this._glyphMarginWidth.toString()), t.push('px;height:'), t.push(e.scrollHeight
        .toString()), t.push('px;">');
      for (c in m) {
        t.push('<div class="cgmr');
        for (d in m[c])
          i++, t.push(' '), t.push(d);
        t.push('" style="top:'), t.push(c), t.push('px;height:'), t.push(g), t.push('px;"></div>');
      }
      return t.push('</div>'), {
        html: t,
        count: i
      ...
      return this.shouldRender && (this._previousRender = this._actualRender(e), this.shouldRender = !1), t && (t.renderedMarginGlyphs +=
        this._previousRender.count), this._previousRender.html;
    }, t;
  }(i.ViewEventHandler);
