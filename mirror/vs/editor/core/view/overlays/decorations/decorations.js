define('vs/editor/core/view/overlays/decorations/decorations', [
  'require',
  'exports',
  ...
  var i = function(e) {
    function t(t) {
      e.call(this), this._context = t, this._contentLeft = 0, this._previousRender = null, this._horizontalScrollChanged = !
        1, this._context.addEventHandler(this);
    }
    return __extends(t, e), t.prototype.dispose = function() {
      ...
      for (d.push('<div class="decorations-layer" style="left:'), d.push(this._contentLeft.toString()), d.push(
        ...
        for (l = 0, c = i.length; c > l; l++)
          o = i[l], m++, d.push('<div class="cdr '), d.push(t.options.className), d.push('" style="top:'), d.push(o.top
            .toString()), d.push('px;left:'), h.push(o.left), p.push(d.length), d.push((o.left - e.viewportLeft).toString()),
            d.push('px;width:'), d.push(o.width.toString()), d.push('px;height:'), d.push(g.toString()), d.push(
              'px;"></div>');
      return d.push('</div>'), {
        html: d,
        lefts: h,
      ...
      return t && (t.renderedDecorationsPieces += this._previousRender.piecesCount), this._previousRender.html;
    }, t;
  }(n.ViewEventHandler);
