define('vs/editor/core/view/overlays/scrollDecoration/scrollDecoration', [
  'require',
  'exports',
  ...
  var o = function(e) {
    function t(t) {
      e.call(this), this._context = t, this._width = 0, this._previousRender = [], this._context.addEventHandler(this);
    }
