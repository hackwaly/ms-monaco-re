...
define(["require", "exports", "vs/nls", "vs/base/dom/dom", "vs/base/eventEmitter", "vs/editor/core/constants",
  ...
  var D = c,
    ...
    cb = function(a) {
      function b(b, c, d, e) {
        var f = this;
        a.call(this), this.outgoingEventBus = new F.EventEmitter;
        var g = new W.ViewController(e, d, this.outgoingEventBus);
        this.listenersToRemove = [], this.listenersToDispose = [], this.eventDispatcher = new T.ViewEventDispatcher(
          function(a) {
            return f._renderOnce(a)
          }), this.linesContent = document.createElement("div"), this.linesContent.className = "lines-content", this.domNode =
          document.createElement("div"), this.domNode.className = d.getEditorClassName(), this.layoutProvider = new R
          .LayoutProvider(c, d, e, this.eventDispatcher, this.linesContent, this.domNode), this.eventDispatcher.addEventHandler(
            this.layoutProvider), this.context = new H.ViewContext(b, d, e, this.eventDispatcher, function(a) {
            return f.eventDispatcher.addEventHandler(a)
          }, function(a) {
            return f.eventDispatcher.removeEventHandler(a)
          }), this.createTextArea(), this.createViewParts(), this.keyboardHandler = new I.KeyboardHandler(this.context,
            g, this.createKeyboardHandlerHelper()), this.pointerHandler = new J.PointerHandler(this.context, g, this.createPointerHandlerHelper()),
          this.hasFocus = !1, this.renderOnceCount = 0, this.isRendering = !1, this.codeEditorHelper = null, this.eventDispatcher
          .addEventHandler(this), this.listenersToRemove.push(e.addBulkListener(function(a) {
            return f.eventDispatcher.emitMany(a)
          }))
      }
      return __extends(b, a), b.prototype.createTextArea = function() {
        var a = this;
        this.textArea = document.createElement("textarea"), this.textArea.className = H.ClassNames.TEXTAREA, this.textArea
          .setAttribute("wrap", "off"), this.textArea.setAttribute("autocorrect", "off"), this.textArea.setAttribute(
            ...
            "aria-label", D.localize("editorViewAccessibleLabel", "Editor content")), this.textArea.style.top = "0px",
          this.textArea.style.left = "0px", this.accessiblilityOutput = document.createElement("div"), this.accessiblilityOutput
          .className = "accessibility-output", this.accessiblilityOutput.setAttribute("aria-live", "assertive"), this
          .accessiblilityOutput.setAttribute("aria-label", D.localize("editorViewAccessibleLabel", "Editor content")),
          this.accessiblilityOutput.setAttribute("role", "alert"), this.listenersToDispose.push(E.addDisposableListener(
          ...
          })), this.textAreaCover = document.createElement("div"), this.context.configuration.editor.glyphMargin ?
          this.textAreaCover.className = H.ClassNames.GLYPH_MARGIN + " " + H.ClassNames.TEXTAREA_COVER : this.context
          .configuration.editor.lineNumbers ? this.textAreaCover.className = H.ClassNames.LINE_NUMBERS + " " + H.ClassNames
          .TEXTAREA_COVER : this.textAreaCover.className = "monaco-editor-background " + H.ClassNames.TEXTAREA_COVER,
          this.textAreaCover.style.position = "absolute", this.textAreaCover.style.width = "4px", this.textAreaCover.style
          .height = "4px", this.textAreaCover.style.top = "0px", this.textAreaCover.style.left = "0px"
      }, b.prototype.createViewParts = function() {
        var a = this;
        this.viewParts = [], this.viewLines = new L.ViewLines(this.context, this.layoutProvider), this.viewZones =
          new K.ViewZones(this.context, this.layoutProvider), this.viewParts.push(this.viewZones);
        ...
        this.viewParts.push(c), c.addDynamicOverlay(new $.GlyphMarginOverlay(this.context)), c.addDynamicOverlay(new _
          .LinesDecorationsOverlay(this.context)), c.addDynamicOverlay(new ab.LineNumbersOverlay(this.context)), c.addDynamicOverlay(
          new Y.SelectionsOverlay(this.context)), c.addDynamicOverlay(new Z.DecorationsOverlay(this.context)), c.addOverlay(
          new O.ViewCursors(this.context)), this.contentWidgets = new P.ViewContentWidgets(this.context), this.viewParts
          .push(this.contentWidgets), this.overlayWidgets = new Q.ViewOverlayWidgets(this.context), this.viewParts.push(
            this.overlayWidgets), this.linesContentContainer = this.layoutProvider.getScrollbarContainerDomNode(),
        ...
        this.linesContent.appendChild(this.viewZones.domNode), this.linesContent.appendChild(this.viewLines.domNode),
          this.linesContent.appendChild(this.contentWidgets.domNode), this.domNode.appendChild(c.domNode), this.domNode
          .appendChild(this.linesContentContainer), this.domNode.appendChild(this.overlayWidgets.domNode), this.domNode
          .appendChild(this.textArea), this.domNode.appendChild(this.accessiblilityOutput), this.domNode.appendChild(
            this.textAreaCover)
        ...
        return {
          ...
          visibleRangeForPositionRelativeToEditor: function(b, c) {
            var d = a.layoutProvider.getLinesViewportData(0),
              e = a.viewLines.visibleRangesForRange2(new U.Range(b, c, b, c), d.visibleRangesDeltaTop, 0, !1);
            if (!e) return null;
            e.next();
            var f = {
              top: e.getTop(),
        ...
        return this.domNode.style.width = a.width + "px", this.domNode.style.height = a.height + "px", this.linesContent
          .style.width = a.contentWidth + "px", this.linesContent.style.height = a.contentHeight + "px", this.linesContentContainer
          .style.left = a.contentLeft + "px", this.linesContentContainer.style.width = a.contentWidth + "px", this.linesContentContainer
          .style.height = a.contentHeight + "px", this.outgoingEventBus.emit(G.EventType.ViewLayoutChanged, a), !1
      }, b.prototype.onConfigurationChanged = function(a) {
        return this.domNode.className = this.context.configuration.getEditorClassName(), !1
        ...
        return E.toggleClass(this.domNode, "focused", a), a ? this.outgoingEventBus.emit(G.EventType.ViewFocusGained, {}) :
          this.outgoingEventBus.emit(G.EventType.ViewFocusLost, {}), !1
      }, b.prototype.dispose = function() {
        this.eventDispatcher.removeEventHandler(this), this.outgoingEventBus.dispose(), this.listenersToRemove.forEach(
          function(a) {
            a()
          }), this.listenersToRemove = [], this.listenersToDispose = bb.disposeAll(this.listenersToDispose), this.keyboardHandler
        ...
        this.textArea.focus(), this._setHasFocus(!0)
        ...
        this._renderOnce(function() {
          var c = !1,
            d = {
              addZone: function(a) {
                return c = !0, b.viewZones.addZone(a)
              },
              removeZone: function(a) {
                c = b.viewZones.removeZone(a) || c
              }
            }, e = a(d);
          return d.addZone = null, d.removeZone = null, c && b.context.privateViewEventBus.emit(G.EventType.ViewZonesChanged,
            null), e
        })
      }, b.prototype.addContentWidget = function(a) {
        var b = this;
        this._renderOnce(function() {
          b.contentWidgets.addWidget(a.widget), b.layoutContentWidget(a)
        })
      }, b.prototype.layoutContentWidget = function(a) {
        var b = this;
        this._renderOnce(function() {
          var c = a.position ? a.position.position : null,
            d = a.position ? a.position.preference : null;
        ...
        this.overlayWidgets.addWidget(a.widget), this.layoutOverlayWidget(a)
        ...
        return this.outgoingEventBus.deferredEmit(function() {
          ...
          if (b.renderOnceCount === 0 && !b.isRendering) try {
            b.isRendering = !0, b.actualRender()
          } finally {
            b.isRendering = !1
          }
          return c
          ...
          e = {
            ...
            getViewportVerticalOffsetForLineNumber: function(a) {
              var c = b.layoutProvider.getVerticalOffsetForLineNumber(a),
                d = b.layoutProvider.getScrolledTopFromAbsoluteTop(c);
              return d
            },
            ...
            visibleRangeForPosition: function(d) {
              var e = b.viewLines.visibleRangesForRange2(new U.Range(d.lineNumber, d.column, d.lineNumber, d.column),
                a.visibleRangesDeltaTop, c, !1);
              if (!e) return null;
              e.next();
              var f = {
                top: e.getTop(),
        ...
        var a, b, c = this.viewLines.render(),
          d = [],
          e = this.createRenderingContext(c);
