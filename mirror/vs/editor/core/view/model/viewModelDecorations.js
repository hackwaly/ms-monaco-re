define("vs/editor/core/view/model/viewModelDecorations", ["require", "exports", "vs/editor/core/range",
  ...
  var o = function() {
    ...
    e.prototype.reset = function(t) {
      ...
      for (this.decorations = [], n = 0, i = s.length; i > n; n++) o = s[n];
    ...
    e.prototype.onModelDecorationsChanged = function(t, n) {
      ...
      for (r = 0, s = t.addedOrChangedDecorations.length; s > r; r++) o = t.addedOrChangedDecorations[r];

      c && o.isForValidation || o.ownerId && o.ownerId !== this.editorId || (l[o.id] = o);
      for (r = 0, s = t.removedDecorations.length; s > r; r++) u[t.removedDecorations[r]] = !0;
      var d;

      var h = {};
      for (r = 0, s = this.decorations.length; s > r; r++) d = this.decorations[r];
      ...
      var p;
      for (p in l)!h.hasOwnProperty(p) && l.hasOwnProperty(p) && (o = l[p], d = {
        id: o.id,
        options: o.options,
        ownerId: o.ownerId,
        modelRange: o.range,
    ...
    e.prototype.onLineMappingChanged = function(t) {
      ...
      var l = !1;
      for (r = 0, a = u.length; a > r; r++) o = u[r];
    ...
    e.prototype.getDecorationsInLines = function(e, t, n) {
      ...
      for (r = 0, s = l.length; s > r && (i = l[r], o = i.range, !(o.startLineNumber > t)); r++) o.endLineNumber < e ||
        (!n || i.options.inlineClassName) && (a[u++] = i);
      return a;
    };
