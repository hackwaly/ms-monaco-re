...
define(["require", "exports", "vs/base/eventEmitter", "vs/editor/core/view/viewContext", "vs/editor/core/constants",
  ...
  var u = function(a) {
    function b(b, c, d, e) {
      ...
      this.decorations = new q.ViewModelDecorations(this.editorId, this.configuration, this);

      this.decorations.reset(this.model);

      this.cursors = new r.ViewModelCursors(this.configuration, this);

      this.listenersToRemove = [];

      this.listenersToRemove.push(this.model.addBulkListener(function(a) {
        return f.onEvents(a);
      }));
    ...
    b.prototype.setTabSize = function(a) {
      ...
      this.deferredEmit(function() {
        ...
        if (c) {
          b.emit(m.EventNames.LineMappingChangedEvent);
          b.decorations.onLineMappingChanged(function(a, c) {
            return b.emit(a, c);
          });
        ...
        for (c = 0, d = a.length; c < d; c++) {
          ...
          switch (e.getType()) {
            ...
            case n.EventType.ConfigurationChanged:
              b.setTabSize(b.configuration.editor.tabSize);
    ...
    b.prototype.onModelLineChanged = function(a) {
      ...
      var c = this.lines.onModelLineChanged(a.lineNumber, a.detail, function(a, c) {
        return b.emit(a, c);
      });
      return c;
    };
    ...
    b.prototype.convertViewRangeToModelRange = function(a) {
      ...
      var c = this.convertViewPositionToModelPosition(a.endLineNumber, a.endColumn);
    ...
    b.prototype.convertModelSelectionToViewSelection = function(a) {
      ...
      var c = this.convertModelPositionToViewPosition(a.positionLineNumber, a.positionColumn);
    ...
    b.prototype.convertModelRangeToViewRange = function(a) {
      ...
      var c = this.convertModelPositionToViewPosition(a.endLineNumber, a.endColumn);
      return new p.Range(b.lineNumber, b.column, c.lineNumber, c.column);
    };
