define('vs/editor/core/model/textModelWithTokens', [
  'require',
  'exports',
  ...
  'vs/editor/core/model/tokenIterator',
  'vs/editor/core/model/textModelWithTokensHelpers'
], function(e, t, n, i, o, r, s, a, u, l, c) {
  var d = function(e) {
    function t(t, n, i) {
      t.push(s.EventType.ModelTokensChanged), e.call(this, t, n), this._stopLineTokenizationAfter = u.Config.editor.stopLineTokenizationAfter,
        this._mode = i ? i : new o.NullMode(), this._revalidateTokensTimeout = -1, this._modeTokenizationFailedTimeout = -
        1, this._initializeTokenizationState();
    }
    return __extends(t, e), t.prototype.dispose = function() {
      this._clearTimers(), this._mode = null, this._lastState = null, e.prototype.dispose.call(this);
    }, t.prototype._reset = function(t, n) {
      this._clearTimers();
      var i = this._mode,
        o = e.prototype._reset.call(this, t);
      return null !== n && (this._mode = n), this._initializeTokenizationState(), i !== this._mode && (o.modeChanged = !
        0), o;
      ...
      -1 !== this._revalidateTokensTimeout && (window.clearTimeout(this._revalidateTokensTimeout), this._revalidateTokensTimeout = -
        1), -1 !== this._modeTokenizationFailedTimeout && (window.clearTimeout(this._modeTokenizationFailedTimeout),
      ...
      if (this._mode.tokenizationSupport)
        try {
          ...
          r.onUnexpectedError(n, t.MODE_TOKENIZATION_FAILED_MSG), this._mode = new o.NullMode();
        }
      e || (e = new o.NullState(this._mode, null)), this._lines[0].state = e, this._lastState = null, this._invalidLineStartIndex =
        0, this._beginBackgroundTokenization();
      ...
      return 'undefined' == typeof t && (t = !1), t || this._updateTokensUntilLine(e, !0), this._lines[e - 1].lineTokens;
    }, t.prototype.getRawLineTokens = function(e) {
      return this._updateTokensUntilLine(e, !0), {
      ...
      return this._updateTokensUntilLine(e, !0), this._lines[e - 1].lineTokens.getTokens().slice(0);
      ...
      var n = this._getLineModeTransitions(e),
        i = a.findIndexInSegmentsArray(n, t - 1);
      return n[i].mode;
    }, t.prototype._invalidateLine = function(e) {
      this._lines[e].isInvalid = !0, e < this._invalidLineStartIndex && (this._invalidLineStartIndex < this._lines.length &&
        (this._lines[this._invalidLineStartIndex].isInvalid = !0), this._invalidLineStartIndex = e, this._beginBackgroundTokenization()
      );
      ...
      for (var e, t = 50, n = this._invalidLineStartIndex + 1, i = Math.min(this._lines.length, this._invalidLineStartIndex +
            1000000), o = 0, r = 0, s = 0, a = this._stopLineTokenizationAfter, u = new Date().getTime(), l = n; i >=
        l; l++) {
      ...
      i >= n && this.emitModelTokensChangedEvent(n, i), this._invalidLineStartIndex < this._lines.length && this._beginBackgroundTokenization();
    }, t.prototype.getStateBeforeLine = function(e) {
      return this._updateTokensUntilLine(e - 1, !0), this._lines[e - 1].state;
    }, t.prototype.getStateAfterLine = function(e) {
      return this._updateTokensUntilLine(e, !0), e < this._lines.length ? this._lines[e - 1].state : this._lastState;
    }, t.prototype._getLineModeTransitions = function(e) {
      return this._updateTokensUntilLine(e, !0), this._lines[e - 1].modeTransitions;
    }, t.prototype._updateTokensUntilLine = function(e, n) {
      var i = this._lines.length,
        s = e - 1,
        a = this._stopLineTokenizationAfter; - 1 === a && (a = 1000000000);
      for (var u = this._invalidLineStartIndex + 1, l = e, c = this._invalidLineStartIndex; s >= c; c++) {
        var d = c + 1,
          h = null,
          p = this._lines[c].text;
        if (this._mode.tokenizationSupport) {
          try {
            h = this._mode.tokenizationSupport.tokenize(this._lines[c].text, this._lines[c].state, 0, a);
          } catch (f) {
            r.onUnexpectedError(f, t.MODE_TOKENIZATION_FAILED_MSG), this._onModeTokenizationFailed();
          }
        ...
        if (h || (h = o.nullTokenize(this._mode, p, this._lines[c].state)), this._updateLineTokens(c, h), this._lines[
          ...
          if (null !== this._lines[d].state && h.endState.equals(this._lines[d].state)) {
            for (var g = c + 1; i > g && !this._lines[g].isInvalid;) {
              if (i > g + 1) {
                if (null === this._lines[g + 1].state)
                  break;
              } else if (null === this._lastState)
                break;
              g++;
            }
      ...
      n && l >= u && this.emitModelTokensChangedEvent(u, l), this._invalidLineStartIndex = Math.max(this._invalidLineStartIndex,
        s + 1);
      ...
      var e = this; - 1 === this._modeTokenizationFailedTimeout && (this._modeTokenizationFailedTimeout = window.setTimeout(
        function() {
          e._modeTokenizationFailedTimeout = -1, e.setMode(new o.NullMode());
        }, 200));
      ...
      return 'undefined' == typeof n && (n = !1), c.WordHelper.getWordAtPosition(this, this.validatePosition(e), t, n);
    }, t.prototype.getWords = function(e, t, n) {
      return 'undefined' == typeof n && (n = !1), c.WordHelper.getWords(this, this.validateLineNumber(e), t, n);
      ...
      return 'undefined' == typeof t && (t = !1), c.BracketsHelper.matchBracket(this, this.validatePosition(e), t);
    }, t.MODE_TOKENIZATION_FAILED_MSG = n.localize('vs_editor_core_model_textModelWithTokens', 0), t;
  }(i.TextModel);
