define('vs/editor/core/model/textModelWithDecorations', [
  'require',
  'exports',
  'vs/editor/editor',
  'vs/editor/core/model/textModelWithTrackedRanges',
  ...
  function a(e, t) {
    ...
    return t && (n.color = t), e && e.color && (n.color = e.color), e && e.hasOwnProperty('position') && (n.position =
      e.position), n;
  }
  ...
  function u(e, t) {
    var n = [
      t.stickiness,
      e.startLineNumber.toString(),
      e.startColumn.toString(),
      e.endLineNumber.toString(),
      e.endColumn.toString(),
      t.className,
      t.hoverMessage,
      t.htmlMessage.reduce(function(e, t) {
        return e + l(t);
      }, ''),
      t.isWholeLine + '',
      t.overviewRuler.color,
      t.overviewRuler.position,
      t.glyphMarginClassName,
  ...
  function l(e) {
    ...
    return e.children && e.children.forEach(function(e, n) {
      t.push('child' + n + '-' + l(e));
    }), t.join('-');
  }
  var c = function() {
    function e() {
      this.changedMarkers = {}, this.oldDecorationRange = {}, this.oldDecorationOptions = {}, this.newOrChangedDecorations = {},
    ...
    return e.prototype.addNewDecoration = function(e) {
      ...
      this.newOrChangedDecorations.hasOwnProperty(e) && delete this.newOrChangedDecorations[e], this.oldDecorationRange
        .hasOwnProperty(e) || (this.oldDecorationRange[e] = n), this.oldDecorationOptions.hasOwnProperty(e) || (this.oldDecorationOptions[
          e] = i), this.removedDecorations[e] = !0;
    }, e.prototype.addMovedDecoration = function(e, t) {
      this.oldDecorationRange.hasOwnProperty(e) || (this.oldDecorationRange[e] = t), this.newOrChangedDecorations[e] = !
        0;
    }, e.prototype.addUpdatedDecoration = function(e, t) {
      this.oldDecorationOptions.hasOwnProperty(e) || (this.oldDecorationOptions[e] = t), this.newOrChangedDecorations[
        e] = !0;
    }, e;
  }();
  ...
  var d = function(e) {
    function t(t, n, i) {
      t.push(o.EventType.ModelDecorationsChanged), e.call(this, t, n, i), this.lastDecorationId = 0, this.decorations = {},
        this.rangeIdToDecorationId = {}, this._currentDeferredEvents = null;
    }
    return __extends(t, e), t.prototype.dispose = function() {
      this.decorations = null, this.rangeIdToDecorationId = null, e.prototype.dispose.call(this);
    }, t.prototype._reset = function(t, n) {
      return this.decorations = {}, this.rangeIdToDecorationId = {}, e.prototype._reset.call(this, t, n);
      ...
      return this._withDeferredEvents(function(i) {
        ...
        return o.addDecoration = null, o.changeDecoration = null, o.removeDecoration = null, o.deltaDecorations =
          null, r;
      });
    }, t.prototype.deltaDecorations = function(e, t, n) {
      return 'undefined' == typeof n && (n = 0), e || (e = []), this.changeDecorations(function(n) {
      ...
      return 'undefined' == typeof t && (t = 0), 'undefined' == typeof n && (n = !1), this.getLinesDecorations(e, e,
        t, n);
    }, t.prototype._getDecorationsInRange = function(e, t, n, i, r, s) {
      var a, u, l, c, d = [],
        h = this.getLinesTrackedRanges(e, n);
      for (u = 0, c = h.length; c > u; u++)
        if (l = h[u], this.rangeIdToDecorationId.hasOwnProperty(l.id)) {
          if (a = this.decorations[this.rangeIdToDecorationId[l.id]], r && a.ownerId && a.ownerId !== r)
            continue;
          if (s && (a.options.className === o.ClassName.EditorErrorDecoration || a.options.className === o.ClassName.EditorWarningDecoration))
            continue;
          if (l.range.startLineNumber === e && l.range.endColumn < t)
            continue;
          if (l.range.endLineNumber === n && l.range.startColumn > i)
            continue;
          d.push({
            id: a.id,
            ownerId: a.ownerId,
      ...
      return 'undefined' == typeof n && (n = 0), 'undefined' == typeof i && (i = !1), this._getDecorationsInRange(e,
        1, t, Number.MAX_VALUE, n, i);
      ...
      for (n in this.decorations)
        if (this.decorations.hasOwnProperty(n)) {
          if (i = this.decorations[n], e && i.ownerId && i.ownerId !== e)
            continue;
      ...
      var t = this._getMarkersInMap(e.changedMarkers),
        n = this._onChangedMarkers(t);
      this._onChangedRanges(e, n), this._handleCollectedDecorationsEvents(e);
      for (var i = 0, o = t.length; o > i; i++)
        t[i].oldLineNumber = 0, t[i].oldColumn = 0;
      ...
      if (this.decorations.hasOwnProperty(t)) {
        var i = this.decorations[t],
          o = this.getTrackedRange(i.rangeId);
        this.changeTrackedRange(i.rangeId, n), e.addMovedDecoration(t, o);
      }
    }, t.prototype._changeDecorationOptionsImpl = function(e, t, n) {
      if (n = s(n), this.decorations.hasOwnProperty(t)) {
        var i = this.decorations[t],
          o = i.options;
        o.stickiness !== n.stickiness && this.changeTrackedRangeStickiness(i.rangeId, n.stickiness), i.options = n, e
          .addUpdatedDecoration(t, o);
      }
    }, t.prototype._removeDecorationImpl = function(e, t) {
      if (this.decorations.hasOwnProperty(t)) {
        var n = this.decorations[t],
          i = null;
        e && (i = this.getTrackedRange(n.rangeId)), this.removeTrackedRange(n.rangeId), delete this.rangeIdToDecorationId[
          n.rangeId], delete this.decorations[t], e && e.addRemovedDecoration(t, n.ownerId, i, n.options);
      }
    }, t.prototype._deltaDecorationsImpl = function(e, t, n, i) {
      var o, r, a = [],
        u = [];
      for (o = 0, r = i.length; r > o; o++)
        a[o] = s(i[o].options), u[o] = this.validateRange(i[o].range);
