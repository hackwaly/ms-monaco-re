define('vs/editor/core/model/textModelWithMarkers', [
  'require',
  'exports',
  'vs/editor/core/model/textModelWithTokens',
  'vs/editor/core/position'
], function(e, t, n, i) {
  var o = function(e) {
    function t(t, n, i) {
      e.call(this, t, n, i), this._lastMarkerId = 0, this._markerIdToMarker = {};
    }
    return __extends(t, e), t.prototype.dispose = function() {
      this._markerIdToMarker = null, e.prototype.dispose.call(this);
    }, t.prototype._reset = function(t, n) {
      return this._markerIdToMarker = {}, e.prototype._reset.call(this, t, n);
      ...
      return this._markerIdToMarker[r.id] = r, this._lines[o.lineNumber - 1].addMarker(r), r.id;
    }, t.prototype._changeMarker = function(e, t, n) {
      if (this._markerIdToMarker.hasOwnProperty(e)) {
        var o = this._markerIdToMarker[e],
          r = this.validatePosition(new i.Position(t, n));
        r.lineNumber !== o.line.lineNumber && (o.line.removeMarker(o), this._lines[r.lineNumber - 1].addMarker(o)), o
          .column = r.column;
      }
      ...
      if (this._markerIdToMarker.hasOwnProperty(e)) {
        var t = this._markerIdToMarker[e];
        t.line.removeMarker(t), delete this._markerIdToMarker[e];
      }
