...
define(["require", "exports", "./model", "vs/editor/core/position", "vs/editor/core/range", "vs/editor/modes/modes"],
  function(a, b, c, d, e, f) {
    var g = c,
      ...
      k = function(a) {
        function b(b, c, d, e) {
          typeof d == "undefined" && (d = null), typeof e == "undefined" && (e = null), a.call(this, "", c, d), this.promptText =
            "", this.modes = {}, this.forceAppendOutputColumn = 0, this.foceCurrentMode = 0, this.appendOutput(b)
        }
        return __extends(b, a), b.prototype.setValue = function(b, c) {
          typeof c == "undefined" && (c = null), a.prototype.setValue.call(this, "", c), this.modes = {}, this.forceAppendOutputColumn =
            0, this.foceCurrentMode = 0, this.appendOutput(b)
        }, b.prototype.appendOutputPiece = function(a, b, c) {
          if (b.length > 0) {
            var d = this.getEditableRange().getEndPosition(),
              e = d.lineNumber,
              f = this.forceAppendOutputColumn > 0 ? this.forceAppendOutputColumn : d.column,
              g = this.foceCurrentMode,
              j, k, l, m = this.getLineContent(e);
            ...
            for (var k = 0, l = b.length; k < l; k++) {
              ...
              if (b.charCodeAt(k) === 27) {
                ...
                if (o && o === "[") {
                  var p = null;
                  o = ++n < l ? b.charAt(n) : null, o && o >= "0" && o <= "9" && (p = o, o = ++n < l ? b.charAt(n) :
                    null), o && o >= "0" && o <= "9" && (p += o, o = ++n < l ? b.charAt(n) : null), p === null && (p =
                    "0");
                  if (o === "m") {
                    g = parseInt(p, 10), k = n;
                    continue
                  ...
                  if (o === "K") {
                    m = m.substring(0, f - 1), j.splice(f - 1, j.length - f + 1), k = n;
                    continue
                  }
                  if (o === "G") {
                    k = n;
              ...
              m = m.substring(0, f - 1) + b.charAt(k) + m.substr(f), j[f - 1] = g, f++
            }
            d = a.insertText(new h.Position(e, 1), m, !0), a.deleteText(new i.Range(e, d.column, e, this.getLineMaxColumn(
              e))), this.modes[e.toString()] = j, this.forceAppendOutputColumn = f, this.foceCurrentMode = g
          }
          if (c) {
          ...
          this.change(function(c) {
            var d = 0;
            for (var e = 0, f = a.length; e < f; e++) a.charAt(e) === "\n" && (b.appendOutputPiece(c, a.substring(d,
              e), !0), d = e + 1);
            d < f && b.appendOutputPiece(c, a.substr(d), !1)
          })
        }, b.prototype.appendPrompt = function() {
          var a = this.promptText,
            b = this.getLineContent(this.getLineCount());
          b !== "" && (a = "\n" + a), this.forceAppendOutputColumn = 0, this.foceCurrentMode = 0, this.appendOutput(a)
          ...
          }), this.promptText = a || "", this.forceAppendOutputColumn = 0
