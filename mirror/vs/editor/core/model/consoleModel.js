define('vs/editor/core/model/consoleModel', [
  'require',
  'exports',
  './model',
  ...
  var r = function(e) {
    function t(t, n, i, o) {
      'undefined' == typeof i && (i = null), 'undefined' == typeof o && (o = null), e.call(this, '', n, i), this.promptText =
        '', this.modes = {}, this.forceAppendOutputColumn = 0, this.foceCurrentMode = 0, this.appendOutput(t);
    }
    return __extends(t, e), t.prototype.setValue = function(t, n) {
      'undefined' == typeof n && (n = null), e.prototype.setValue.call(this, '', n), this.modes = {}, this.forceAppendOutputColumn =
        0, this.foceCurrentMode = 0, this.appendOutput(t);
      ...
      if (t.length > 0) {
        var r, s, a, u = this.getEditableRange().getEndPosition(),
          l = u.lineNumber,
          c = this.forceAppendOutputColumn > 0 ? this.forceAppendOutputColumn : u.column,
          d = this.foceCurrentMode,
          h = this.getLineContent(l);
          ...
          if ('\r' !== t.charAt(s)) {
            if (27 === t.charCodeAt(s)) {
              ...
              if (f && '[' === f) {
                ...
                if ('K' === f) {
                  h = h.substring(0, c - 1), r.splice(c - 1, r.length - c + 1), s = p;
                  continue;
                }
                if ('G' === f) {
                  s = p;
            ...
            h = h.substring(0, c - 1) + t.charAt(s) + h.substr(c), r[c - 1] = d, c++;
          } else
            c = 1;
        u = e.insertText(new i.Position(l, 1), h, !0), e.deleteText(new o.Range(l, u.column, l, this.getLineMaxColumn(
          l))), this.modes[l.toString()] = r, this.forceAppendOutputColumn = c, this.foceCurrentMode = d;
      }
      if (n) {
