define("vs/editor/core/model/editableTextModel", ["require", "exports", "vs/editor/core/model/textModelWithDecorations",
  "vs/editor/core/model/editStack", "vs/editor/editor", "vs/editor/core/model/modelLine", "vs/editor/core/position",
  "vs/editor/core/constants"
], function(e, t, n, i, o, r, s, a) {
  var u = function(e) {
    function t(t, n, o) {
      t.push(a.EventType.ModelContentChanged);

      e.call(this, t, n, o);

      this._commandManager = new i.EditStack(this);
      ...
      return this._withDeferredEvents(function(n) {
        var i = {
          insertText: function(e, i, o) {
            ...
            return t._insertText(n.changedMarkers, e, i, o);
          },
    ...
    t.prototype.callDeleteTextOnLine = function(e, t, n, i, o, r, s) {
      ...
      s && (this._invalidateLine(t), this._increaseVersionId(), this.emitModelContentChangedLineChangedEvent(t + 1));
    ...
    t.prototype._insertTextOneLine = function(e, t, n, i) {
      ...
      return new s.Position(t.lineNumber, t.column + n.length);
    };
    ...
    t.prototype._insertTextMultiline = function(e, t, n, i) {
      ...
      var u = this.callDeleteTextOnLine(e, t.lineNumber - 1, t.column, Number.MAX_VALUE, !0, i, !1);
      this.callInsertTextOnLine(e, t.lineNumber - 1, t.column, {
        text: n[0],
        markers: null
      }, i, !0);
      ...
      this.callInsertTextOnLine(e, c, Number.MAX_VALUE, u, i, !1);

      this._updateLineNumbers(e, c + 2);

      this._increaseVersionId();

      this.emitModelContentChangedLinesInsertedEvent(t.lineNumber - 1 + 2, c + 1, l + this._lines[c].text);

      return new s.Position(c + 1, 1 + n[n.length - 1].length);
    };
    ...
    t.prototype._deleteTextMultiline = function(e, t) {
      if (1 === t.startColumn) {
        ...
        var i = this._deleteWholeLines(e, t.startColumn, t.startLineNumber - 1, t.endLineNumber - 2);
        this._increaseVersionId();

        this.emitModelContentChangedLinesDeletedEvent(t.startLineNumber, t.endLineNumber - 1);
        var o = this.callDeleteTextOnLine(e, t.startLineNumber - 1, 1, t.endColumn, !1, !1, !0).text;
        this._lines[t.startLineNumber - 1].addMarkers(i.deletedMarkers);

        this._lines[t.startLineNumber - 1].state = n;
        ...
        var u = this.callDeleteTextOnLine(e, t.endLineNumber - 1, t.endColumn, Number.MAX_VALUE, !0, !1, !1);

        var i = this._deleteWholeLines(e, t.startColumn, t.startLineNumber, t.endLineNumber - 1);
        this._lines[t.startLineNumber - 1].addMarkers(i.deletedMarkers);

        this.callInsertTextOnLine(e, t.startLineNumber - 1, Number.MAX_VALUE, u, !1, !0);

        this._updateLineNumbers(e, t.startLineNumber + 1);
