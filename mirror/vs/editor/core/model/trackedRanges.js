  ...
  var e = function() {
    ...
    return a.prototype.clear = function() {
      ...
      if (this.ranges.hasOwnProperty(a)) {
        ...
        var c = this.ranges[a];
        this.model._changeMarker(c.startMarkerId, b.startLineNumber - 1, b.startColumn), this.model._changeMarker(c.endMarkerId,
          b.endLineNumber - 1, b.endColumn), this._setRangeIsMultiLine(c.id, b.startLineNumber !== b.endLineNumber)
      }
      ...
      for (d in this.multiLineTrackedRanges)
        if (this.multiLineTrackedRanges.hasOwnProperty(d)) {
          ...
          if (h < a) continue;
          g = this.model._getMarkerColumn(f, e.startMarkerId), i = this.model._getMarkerColumn(h, e.endMarkerId), c[e
            .id] = {
            startLineNumber: f,
            startColumn: g,
            endLineNumber: h,
