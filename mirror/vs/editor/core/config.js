define(["require", "exports", "vs/base/env", "vs/editor/core/constants"], function(a, b, c, d) {
  ...
  var g = function() {
    ...
    a.prototype.addKeyBinding = function(a, b) {
      this.keyBindings[a] = this.keyBindings[a] || [];

      this.keyBindings[a].push(b);
    };
  ...
  b.Config.addKeyBinding(f.Handler.CursorWordLeft, h(!1, "LeftArrow"));

  b.Config.addKeyBinding(f.Handler.CursorWordLeftSelect, h(!0, "LeftArrow"));

  b.Config.addKeyBinding(f.Handler.CursorWordRight, h(!1, "RightArrow"));

  b.Config.addKeyBinding(f.Handler.CursorWordRightSelect, h(!0, "RightArrow"));

  b.Config.addKeyBinding(f.Handler.CursorDownSelect, h(!0, "DownArrow"));

  b.Config.addKeyBinding(f.Handler.CursorUpSelect, h(!0, "UpArrow"));

  b.Config.addKeyBinding(f.Handler.DeleteWordLeft, h(!1, "Backspace"));
