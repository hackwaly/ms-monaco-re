...
"undefined" == typeof WinJS && (! function(e) {
  ...
  function n(e, n) {
    ...
    var r = e[t];
    r.Namespace || (r.Namespace = Object.create(Object.prototype)), Object.defineProperties(r.Namespace, {
      defineWithParent: {
        value: i,
        writable: !0,
        enumerable: !0,
  ...
  function(e) {
    function t(t, i, o) {
      return t = t || function() {}, e.Utilities.markSupportedForProcessing(t), i && n(t.prototype, i), o && n(t, o),
        t
    }
    ...
    function i(i, o, r, s) {
      if (i) {
        o = o || function() {};
        var a = i.prototype;
        return o.prototype = Object.create(a), e.Utilities.markSupportedForProcessing(o), Object.defineProperty(o.prototype,
          "constructor", {
            value: o,
            writable: !0,
            configurable: !0,
            enumerable: !0
          }), r && n(o.prototype, r), s && n(o, s), o
      }
      return t(o, r, s)
    }
  ...
  t.Namespace.define("WinJS.Utilities", {
    ...
    ready: function(n, i) {
      return new t.Promise(function(o, r) {
        ...
        a || (a = e.document ? document.readyState : "complete"), "complete" === a || e.document && null !==
          document.body ? i ? e.setImmediate(s) : s() : e.addEventListener("DOMContentLoaded", s, !1)
      })
    },
    strictProcessing: {
      get: function() {
  ...
  function e(e, t, n) {
    var r = e;
    return "function" == typeof r && (r = r()), (n && o.test(n) ? "" : n ? n + ": " : "") + (t ? t.replace(i, ":") +
      ": " : "") + r
  }
  ...
  WinJS.Namespace.define("WinJS.Utilities", {
    startLog: function(e) {
      ...
      var o = e.type && new RegExp("^(" + n(e.type).replace(i, " ").split(" ").join("|") + ")$"),
        r = e.excludeTags && new RegExp("(^|\\s)(" + n(e.excludeTags).replace(i, " ").split(" ").join("|") +
          ")(\\s|$)", "i"),
        s = e.tags && new RegExp("(^|\\s)(" + n(e.tags).replace(i, " ").split(" ").join("|") + ")(\\s|$)", "i"),
        a = e.action || t;
  ...
  var i, o = !1,
    r = "contextchanged",
    s = t.Class.mix(t.Class.define(null, {}, {
      supportedForProcessing: !1
  ...
  function i(e, t) {
    var n;
    n = t && "object" == typeof t && "function" == typeof t.then ? k : R, e._value = t, e._setState(n)
  }
  ...
  function d(e, t) {
    ...
    if (i) {
      ...
      for (o = 0, r = Array.isArray(i) ? i.length : 1; r > o; o++) {
        ...
        } else z.prototype.done.call(e, a)
      }
    }
  }
  ...
  function v(e, t, n, i) {
    e._value = t, p(e, t, n, i), e._setState(W)
  }

  function y(e, t) {
    var n;
    n = t && "object" == typeof t && "function" == typeof t.then ? k : P, e._value = t, e._setState(n)
  }
  ...
  N = {
    ...
    enter: function(e) {
      if (e.done = z.prototype.done, e.then = z.prototype.then, e._listeners)
        for (var t, n = [e]; n.length;) t = n.pop(), t._state._notify(t, n);
      e._setState(P)
    },
    cancel: n,
    done: null,
  ...
  var V, F = WinJS.Class.define(null, {
      _listeners: null,
      _nextState: null,
      _state: null,
      _value: null,
    ...
    U = WinJS.Class.derive(F, function(e) {
      T && (T === !0 || T & x.thenPromise) && (this._stack = WinJS.Promise._getStack()), this._creator = e, this._setState(
        N), this._run()
    }, {
      _creator: null,
    ...
    B = WinJS.Class.define(function(e) {
      T && (T === !0 || T & x.errorPromise) && (this._stack = WinJS.Promise._getStack()), this._value = e, p(this,
        e, a)
    }, {
      cancel: function() {},
      done: function(e, t) {
      ...
      then: function(e, t) {
        ...
        var n, i = this._value;
        try {
          t.handlesOnError || p(null, i, r, this, t), n = new z(t(i))
        } catch (o) {
          n = o === i ? this : new q(o)
        }
        return n
    ...
    q = WinJS.Class.derive(B, function(e) {
      T && (T === !0 || T & x.exceptionPromise) && (this._stack = WinJS.Promise._getStack()), this._value = e, p(
        this, e, u)
    }, {}, {
      supportedForProcessing: !1
    }),
    z = WinJS.Class.define(function(e) {
    ...
    j = WinJS.Class.derive(F, function(e, t) {
      T && (T === !0 || T & x.promise) && (this._stack = WinJS.Promise._getStack()), this._oncancel = t, this._setState(
        N), this._run();
      try {
        var n = this._completed.bind(this),
          i = this._error.bind(this),
          o = this._progress.bind(this);
        e(n, i, o)
      } catch (r) {
      ...
      join: function(e) {
        return new j(function(n, i, o) {
          var r = Object.keys(e),
            s = Array.isArray(e) ? [] : {}, a = Array.isArray(e) ? [] : {}, u = 0,
            l = r.length,
            c = function(e) {
              if (0 === --l) {
  ...
  var G = WinJS.Class.derive(F, function(e) {
    this._oncancel = e, this._setState(N), this._run()
  }, {
    _cancelAction: function() {
    ...
    K = WinJS.Class.define(function(e) {
  ...
  WinJS.Namespace.define("WinJS", {
    xhr: function(e) {
      ...
      return new WinJS.Promise(function(n, i, o) {
        ...
        }, t.open(e.type || "GET", e.url, !0, e.user, e.password), t.responseType = e.responseType || "", Object.keys(
          e.headers || {}).forEach(function(n) {
          t.setRequestHeader(n, e.headers[n])
        }), t.setRequestHeader("X-Requested-With", "XMLHttpRequest"), e.customRequestInitializer && e.customRequestInitializer(
          t), t.send(e.data)
      }, function() {
...
}(this)), define("vs/base/lib/raw.winjs.base", [], {}), define("vs/base/types", ["require", "exports"], function(e, t) {
  function n(e) {
  ...
  function o(e, i, o) {
    return "undefined" == typeof o && (o = !0), n.isObject(e) ? (n.isObject(i) && Object.keys(i).forEach(function(r) {
  ...
  function c(e, t) {
    t = t || function() {};
    var n = e.prototype;
    return t.prototype = Object.create(n), Object.defineProperty(t.prototype, "constructor", {
      value: t,
      writable: !0,
      configurable: !0,
      enumerable: !0
  ...
  t.clone = i, t.mixin = o, t.withDefaults = r, t.equals = s, t.ensureProperty = a, t.arrayToHash = u, t.createKeywordMatcher =
    l, t.derive = c
  ...
  var a = function() {
    ...
    return e.prototype.equals = function(e) {
      ...
      return this.asHexCached || (this.asHexCached = [e.toHexString(this.numbers[0], 8), e.toHexString(this.numbers[1],
        4), e.toHexString(this.numbers[2], 4), e.toHexString(this.numbers[3], 4), e.toHexString(this.numbers[4],
        12)].join("-")), this.asHexCached
    }, e.prototype.toString = function() {
      return this.asHex()
    }, e
  }(),
    u = [36863, 40959, 45055, 49151],
    l = 16384;
  t.v4 = r, t.parse = s
  ...
  function a(e) {
    return e || (e = new Date), n.localize("vs_base_strings", 0, t.pad(e.getMonth() + 1, 2), t.pad(e.getDate(), 2), t
      .pad(e.getFullYear(), 4), t.pad(e.getHours(), 2), t.pad(e.getMinutes(), 2), t.pad(e.getSeconds(), 2))
  }

  function u(e) {
    return e || (e = new Date), n.localize("vs_base_strings", 1, t.pad(e.getHours(), 2), t.pad(e.getMinutes(), 2), t.pad(
      e.getSeconds(), 2))
  }
...
}), define("vs/base/network", ["require", "exports", "./assert", "./hash", "./strings", "./types"], function(e, t, n, i,
  o, r) {
  function s(e) {
  ...
  var o = "inject",
    ...
    s = function() {
      ...
      return e.prototype.setParent = function(e) {
        ...
        var s = !1;
        if (i.isArray(e)) return e.forEach(function(e) {
          s = t.injectTo(e) || s
        }), s;
        for (var a in e)
          if (0 === a.indexOf(o)) {
...
define("vs/base/dom/mockDom", ["require", "exports"], function(e, t) {
  ...
  var i = function(e) {
    function t(t) {
      e.call(this), this.ENTITY_REFERENCE_NODE = Node.ENTITY_REFERENCE_NODE, this.ATTRIBUTE_NODE = Node.ATTRIBUTE_NODE,
        ...
        this.DOCUMENT_POSITION_PRECEDING = Node.DOCUMENT_POSITION_PRECEDING, this.nodeName = t, this._childNodes = [],
        this._attributes = []
    }
    return __extends(t, e), Object.defineProperty(t.prototype, "attributes", {
      get: function() {
  ...
  var o = function(e) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, "specified", {
      get: function() {
        return !!this.value
      },
      enumerable: !0,
  ...
  var r = function(e) {
    ...
    return __extends(t, e), t.prototype.getAttribute = function(e) {
      ...
      n.ownerElement = this, n.value = t, this._attributes.push(n)
      ...
      get: function() {
        var e = this,
          t = this._childNodes.filter(function(t) {
            return t.nodeType === e.ELEMENT_NODE
          });
        return t[t.length - 1]
      },
      ...
      throw new Error("Not implemented!")
    }, t.prototype.msZoomTo = function() {}, t.prototype.msRequestFullscreen = function() {}, t.prototype.msGetUntransformedBounds =
      function() {
        throw new Error("Not implemented!")
  ...
  var u = function(e) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, "className", {
      get: function() {
  ...
  var d = function() {
      ...
      return e.prototype.consumeCharacter = function(e) {
        ...
        if (this.tagName && "attribute" !== t)
          if (this.isClosing) {
            ...
            e.openElements.pop(), e.currentNode = e.openElements.length ? e.openElements[e.openElements.length - 1] :
              null
          } else {
            var i = e.document.createElement(this.tagName);
            Object.keys(this.attributes).forEach(function(e) {
              i.setAttribute(e, n.attributes[e])
            }), e.currentNode ? e.currentNode.appendChild(i) : e.root.push(i), e.openElements.push(i), e.currentNode =
              i
          }
      }, e
    }(),
    ...
    v = function() {
      ...
      return e.prototype.parse = function(e) {
        ...
        if (0 !== this.openElements.length) throw new Error("Elements not closed: " + this.openElements.map(function(
          e) {
          return e.tagName
        }).join());
        return this.root
    ...
    y = function() {
      ...
      return e.prototype.print = function(e) {
        ...
        return t.push(">"), t.push(this.printChildren(e)), t.push("</"), t.push(e.tagName), t.push(">"), t.join("")
...
define("vs/platform/markers/markers", ["require", "exports", "vs/base/assert", "vs/base/network"], function(e, t, n, i) {
...
}), define("vs/platform/markers/markersWorker", ["require", "exports", "vs/base/assert", "./markers"], function(e, t, n,
  i) {
  function o(e, t) {
    return new s(e, t)
  }
  ...
  var n = function() {
    ...
    return e.prototype.getCount = function() {
      ...
      this.values.splice(e, 0, t), this.prefixSum.splice(e, 0, 0), e - 1 < this.prefixSumValidIndex && (this.prefixSumValidIndex =
        e - 1)
      ...
      this.values.splice(e, t), this.prefixSum.splice(e, t), e - 1 < this.prefixSumValidIndex && (this.prefixSumValidIndex =
        e - 1)
  ...
  function a(e, t) {
    for (var n, i = 0, o = e.length - 1; o > i;) n = i + Math.ceil((o - i) / 2), e[n].startIndex > t ? o = n - 1 : i =
      n;
    return i
  }
...
}), define("vs/editor/core/model/modelLine", ["require", "exports", "vs/editor/modes/modes", "vs/base/arrays"],
  function(e, t, n, i) {
    var o = function() {
      function e(e, t) {
        this.lineNumber = e, this.text = t, this.state = null, this.modeTransitions = null, this.isInvalid = !1, this.markers = [],
          this._recreateLineTokens(null)
      }
      return e.prototype._recreateLineTokens = function(t) {
        ...
        var r = this.text,
          s = r.length + 1,
          a = this.lineTokens.getTokens(),
          u = i.text.length;
        n = Math.max(1, n), n = Math.min(n, s);
        var l, c;
        if (u > 0) {
          ...
          if (a !== e.DEFAULT_TOKENS_NON_EMPTY_TEXT && a !== e.DEFAULT_TOKENS_EMPTY_TEXT) {
            var h;
            for (l = 0, c = a.length; c > l; l++) h = a[l], h.startIndex >= n - 1 && h.startIndex > 0 && (h.startIndex +=
              u)
          }
          var p;
          for (l = 0, c = this.markers.length; c > l; l++) p = this.markers[l], (p.column > n || p.column === n && (o || !
            p.stickToPreviousCharacter)) && (t[p.id] = !0, p.oldLineNumber = p.oldLineNumber || this.lineNumber, p.oldColumn =
            p.oldColumn || p.column, p.column += u);
          this.text = d, this._recreateLineTokens(a)
        }
        if (i.markers)
          for (l = 0, c = i.markers.length; c > l; l++) p = i.markers[l], t[p.id] = !0, p.oldLineNumber = p.oldLineNumber ||
            this.lineNumber, p.oldColumn = p.oldColumn || p.column, p.line = this, p.column += n - 1, this.markers.push(
              p)
        ...
        var s = i,
          ...
          l = this.text,
          c = l.length + 1,
          d = this.lineTokens.getTokens();
        n = Math.max(1, n), i = Math.max(1, i), n = Math.min(n, c), i = Math.min(i, c);
        var h;
        if (i > n && i > 1 && c > n) {
          ...
          if (d !== e.DEFAULT_TOKENS_NON_EMPTY_TEXT && d !== e.DEFAULT_TOKENS_EMPTY_TEXT) {
            ...
            for (h = 0; h < d.length; h++) {
              var f = d[h].startIndex,
                g = f;
              f >= i - 1 ? g = f - a.length : f >= n - 1 && (g = n - 1), g >= p.length ? (d.splice(h, 1), h--) : (d[h].startIndex =
                g, h > 0 && d[h - 1].startIndex >= g && (d.splice(h - 1, 1), h--))
            }
          }
          this.text = p, this._recreateLineTokens(d)
        }
        var m;
        for (h = 0; h < this.markers.length; h++) m = this.markers[h], m.column > s || m.column === s && (r || !m.stickToPreviousCharacter) ?
          (t[m.id] = !0, m.oldLineNumber = m.oldLineNumber || this.lineNumber, m.oldColumn = m.oldColumn || m.column, m
          .column -= a.length) : (m.column > n || m.column === n && (r || !m.stickToPreviousCharacter)) && (t[m.id] = !
          0, m.oldLineNumber = m.oldLineNumber || this.lineNumber, m.oldColumn = m.oldColumn || m.column, o ? (m.line =
            null, m.column -= n - 1, this.markers.splice(h, 1), h--, u.push(m)) : m.column = n);
        return {
          text: a,
          markers: u
        }
      }, e.prototype.addMarker = function(e) {
        e.line = this, this.markers.push(e)
        ...
        t >= 0 && this.markers.splice(t, 1), e.line = null
      }, e.prototype._indexOfMarkerId = function(e) {
        var t, n, i = this.markers;
  ...
  var r = function() {
    ...
    return e.prototype.register = function(e) {
      if (i.isString(e)) this.table[e] = arguments[1];
      else
        for (var t in e) {
          var n = e[t];
      ...
      if (!this.table[e.type]) return n.Promise.wrapError(new Error("no handler/route for: " + e.type));
      try {
...
define("vs/base/async", ["require", "exports", "vs/base/errors", "vs/base/lib/winjs.base"], function(e, t, n, i) {
  ...
  var o = function() {
    ...
    return e.prototype.dispose = function() {
      this._listeners = {}, this._bulkListeners = [], this._collectedEvents = [], this._deferredCnt = 0, this._allowedEventTypes =
        null
      ...
      for (var t = 0, n = e.length; n > t; t++) {
        var i = e[t];
        this._emitToSpecificTypeListeners(i.getType(), i.getData()), i.getEmitterType() && this._emitToSpecificTypeListeners(
          i.getType() + "/" + i.getEmitterType(), i.getData())
      }
    ...
    h = function(e) {
      ...
      return __extends(t, e), t.prototype.getVersionId = function() {
        ...
        var t, n, i, o = 0,
          r = 0,
          s = this._lines;
        for (t = 0, n = this._lines.length; n > t; t++) i = s[t].text.length, i >= e ? r += i : o += i;
        return r > o
        ...
        for (e = 0, t = p.length; t > e; e++) {
          ...
          if (1 === h && (h = 0), (l > 0 || h > 0) && (f++, l > 0 && y++, h > 0 && (_[h] = (_[h] || 0) + 1)), a) {
            h = 0;
            var b = !0;
            for (n = 0; m > n && u > n; n++) r = g.charCodeAt(n), o = s.charCodeAt(n), b && r !== o && (b = !1), b ||
              (r === c && h++, o === c && h++);
            for (; m > n; n++) r = g.charCodeAt(n), r === c && h++;
            for (; u > n; n++) o = s.charCodeAt(n), o === c && h++;
        ...
        var f = 1,
          g = 0;
        for (l = Math.max(a.length, p.length); l >= 2; l--) c = (p[l] || 0) + (a[l] || 0), c > g && (f = l, g = c);
        return {
          insertSpaces: !0,
          tabSize: f
        }
...
define("vs/editor/core/model/mirrorModel", ["require", "exports", "vs/editor/core/constants",
  ...
  var s = function(e) {
    function t(t, n, i, o, r) {
      e.call(this, t, i), this.wordsRegexp = null, r || (r = {}), this._setVersionId(n), this._associatedResource = o,
        this._extraProperties = r
    }
    return __extends(t, e), t.prototype._constructLines = function(t) {
      ...
      var n = this.getPositionFromOffset(e),
        i = this.getPositionFromOffset(e + t);
      return {
      ...
      return this._lineStarts.getIndexOf(e, t), {
  ...
  var a = function(e) {
    ...
    return __extends(t, e), t.prototype.onEvents = function(e) {
          ...
          case n.EventType.ModelContentChanged:
            ...
            switch (this._lineStarts = null, this._setVersionId(s.versionId), s.changeType) {
              case n.EventType.ModelContentChangedFlush:
                this.emit(n.EventType.OnBeforeModelContentChangedFlush, r), this._onLinesFlushed(s), t = !0;
                break;
              case n.EventType.ModelContentChangedLinesDeleted:
                this.emit(n.EventType.OnBeforeModelContentChangedLinesDeleted, r), this._onLinesDeleted(s), t = !0;
                break;
              case n.EventType.ModelContentChangedLinesInserted:
                this.emit(n.EventType.OnBeforeModelContentChangedLinesInserted, r), this._onLinesInserted(s), t = !0;
                break;
              case n.EventType.ModelContentChangedLineChanged:
                this.emit(n.EventType.OnBeforeModelContentChangedLineChanged, r), this._onLineChanged(s), t = !0
            }
            break;
      ...
      this._lineStarts = null, this._constructLines(e.detail)
      ...
      var t = e.fromLineNumber - 1,
        n = e.toLineNumber - 1;
      this._lineStarts && this._lineStarts.removeValues(t, n - t + 1), this._lines.splice(t, n - t + 1)
    }, t.prototype._onLinesInserted = function(e) {
      var t, n, i = this.getEOL().length,
        o = e.detail.split("\n");
      for (t = e.fromLineNumber - 1, n = 0; t < e.toLineNumber; t++, n++) this._lineStarts && this._lineStarts.insertValue(
        t, o[n].length + i), this._lines.splice(t, 0, new r.ModelLine(0, o[n]))
    }, t
  }(s);
  t.MirrorModel = a
});
...
define("vs/base/collections", ["require", "exports", "vs/base/errors"], function(e, t, n) {
  ...
  t.lookup = i, t.lookupOrInsert = o, t.contains = r, t.keys = s, t.values = a, t.forEach = u, t.groupBy = l, t.fromArray =
    c, t.EmptyIterable = {
      forEach: function() {}
  }, t.combine = d, t.singleton = h;
  var p = function() {
    function e() {}
  ...
  var g = function(e) {
    function t() {
      e.apply(this, arguments), this._dict = new _
    }
    return __extends(t, e), t.prototype.forEach = function(e) {
      ...
      var t = this.length;
      return this._dict.remove(e), t !== this.length
  ...
  var m = function(e) {
    function t(t) {
      e.call(this), this._dict = new v(t)
    }
    return __extends(t, e), t.prototype.forEach = function(e) {
      this._dict.forEach(function(t) {
        e(t.key)
  ...
  var v = function(e) {
    ...
    return __extends(t, e), t.prototype.forEach = function(e) {
      ...
      var n = this.hashFn(e);
      this._data.hasOwnProperty(n) || (this._count += 1), this._data[n] = {
        key: e,
        value: t
      }
  ...
  var _ = function(e) {
    function t(t) {
      "undefined" == typeof t && (t = 10), e.call(this), this.size = t, this._elements = new Array(this.size), this._count =
        0
    }
    return __extends(t, e), t.wrap = function(e) {
      ...
      this._elements.length = 0, this._elements.length = this.size, this._count = 0
      ...
      if ("undefined" == typeof o) this._elements[i] = [{
        ...
        for (var r = 0; r < o.length; r++)
          if (e.equals(o[r].key)) return o[r].key = e, o[r].value = n, void 0;
        o.push({
          key: e,
          value: n
        }), this._count += 1
      ...
      if ("undefined" != typeof i)
        for (var o = 0; o < i.length; o++)
          if (e.equals(i[o].key)) return i.splice(o, 1), this._count -= 1, !0;
      return !1
    }, t.prototype.containsKey = function(e) {
      e = t.wrap(e);
      var n = this.indexOf(e),
...
define("vs/base/performance/timer", ["require", "exports", "vs/base/env", "vs/base/eventEmitter",
  ...
  var l = function() {
    function e(e, t, n, i) {
      if (this.timeKeeper = e, this.name = t, this.topic = n, this.stopTime = null, i) return this.startTime = i,
        void 0;
  ...
  var c = function(e) {
    function i() {
      e.call(this), this.timeoutId = null, this.collectedEvents = [], this.eventCacheLimit = 1e3, this.maxTimerLength =
...
define("vs/platform/services", ["require", "exports", "vs/base/lib/winjs.base", "vs/base/async", "vs/base/strings",
  ...
  var p = function(e) {
    function t(t, n) {
      ...
      e.call(this, i), this._moduleName = t, this._functionName = n
    }
    return __extends(t, e), Object.defineProperty(t.prototype, "moduleName", {
      get: function() {
    ...
    return e.prototype.injectTelemetryService = function(e) {
      ...
      if (!this.contextService)
        if (this.contextService = e, this.contextService.getConfiguration()) {
          ...
          t && t.length > 0 && (this.origin = this.origin.substring(0, this.origin.length - t.length + 1)), o.endsWith(
      ...
      var t = a.nullEvent;
      return e.headers = u.mixin(e.headers, this.getAdditionalHeaders()), this._telemetryService && (t = this._telemetryService
        .start("WorkbenchXHR", {
          url: e.url
        }, !1)), i.always(n.xhr(e), function(e) {
      ...
      function i(e) {
        if (c) return r("canceled"), void 0;
        var n = e.indexOf("\r\n\r\n", u);
        if (-1 !== n) {
          for (var i = []; - 1 !== n;) {
            var o = t(e.substring(u, n)),
              a = Number(o["Content-Length"]);
            if (n + 4 + a > e.length) break;
            var d = {
              header: o,
              body: e.substr(n + 4, a)
            };
            l.push(d), i.push(d), u = n + 4 + a, n = e.indexOf("\r\n\r\n", u)
          }
          s(i)
        }
      }
      ...
      return new n.Promise(function(t, n, u) {
        o = t, r = n, s = u, a.makeRequest(e).done(function(e) {
          i(e.responseText), o(l)
        }, function(e) {
          r(e)
        }, function(e) {
  ...
  var m = function() {
    ...
    return Object.defineProperty(e.prototype, "selection", {
      get: function() {
  ...
  var y = (t.Severity, function() {
    function e() {}
    return e.SERVICE_CHANGED = "service-changed", e.SET_CHANGED = "set-changed", e.SET_ADDED = "set-added", e.SET_REMOVED =
      "set-removed", e
  }());
  ...
  var b = function(e) {
    function t(t, n, i) {
      e.call(this), this._id = t, this._name = n, this._description = i, this._enabled = !1
    }
  ...
  t.ConfigurationServiceEventTypes = C, t.ResourceEvents = {
  ...
  var c = function() {
    function e(e) {
      var t = this;
      this._services = e, this._active = 0, this._diContainer = new u.Container, a.forEach(this._services, function(e) {
  ...
  function s(e) {
    var t = new i.Container,
      n = new c(t),
      o = r.create(e);
    return n._instantiationService = o, n._diContainer.registerService(c._instantiationServiceName, o), a(e, t), u(e,
      t), n
  }
  ...
  var c = function() {
    function e(t) {
      this._diContainer = t, this._diContainer.registerService(e._injectorServiceName, this)
    }
    return e.prototype.injectTo = function(e) {
      this._diContainer.injectTo(e), l(e)
    }, e.prototype.createChild = function(t) {
      var n = this._diContainer.createChild();
      a(t, n);
      var i = new e(n);
      return i._instantiationService = this._instantiationService.createChild(t), n.registerService(e._injectorServiceName,
        i), n.registerService(e._instantiationServiceName, i._instantiationService), u(t, n), i
    }, e._injectorServiceName = "injectorService", e._instantiationServiceName = "instantiationService", e._fnInjectionDone =
      "injectionDone", e
  }();
  t.create = s
});
...
define("vs/editor/worker/resourceService", ["require", "exports", "vs/base/eventEmitter", "vs/base/types",
  ...
  var s = function(e) {
    ...
    return __extends(t, e), t.prototype.insert = function(e, t) {
      ...
      for (var n = e.toString(), r = this.data[n][0]; this.unbinds[n].length > 0;) this.unbinds[n].pop()();
...
define("vs/base/time/idleMonitor", ["require", "exports", "vs/base/dom/dom", "vs/base/lifecycle",
  ...
  var r = function() {
    ...
    return e.prototype.addOneTimeActiveListener = function(e) {
  ...
  var s = function() {
    ...
    return e.prototype.increment = function() {
      0 === this.referenceCount && this.construct(), this.referenceCount++
    ...
    a = function(e) {
      ...
      return __extends(r, e), r.prototype.construct = function() {
        var e = this;
        this.status = null, this.idleCheckTimeout = -1, this.toDispose = [], this.eventEmitter = new o.EventEmitter,
          this.toDispose.push(this.eventEmitter), this.toDispose.push(n.addDisposableListener(document, "mousemove",
            function() {
        ...
        this.toDispose = i.disposeAll(this.toDispose), this.cancelIdleCheck()
        ...
        this.lastActiveTime = (new Date).getTime(), 1 !== this.status && (this.status = 1, this.scheduleIdleCheck(),
        ...
        if (-1 === this.idleCheckTimeout) {
          ...
          this.idleCheckTimeout = setTimeout(function() {
            e.idleCheckTimeout = -1, e.checkIfUserIsIdle()
          }, n - (new Date).getTime())
        }
...
}), define("vs/platform/telemetry/telemetryService", ["require", "exports", "vs/base/strings",
  "vs/base/performance/timer", "vs/base/errors", "vs/base/types", "vs/base/env", "vs/base/time/idleMonitor",
  "vs/base/network"
], function(e, t, n, i, o, r, s, a, u) {
  var l = function() {
    function e(t, r) {
  ...
  t.MyArray = o; // Copyright (C) 2008 Microsoft Corporation
  var r = 1447,
    s = function() {
      function e() {
    ...
    a = function() {
      ...
      return e.prototype.ComputeUniqueIdentifiers = function() {
        ...
        for (s[0] = !1; t >= e && r >= o && this.ElementsAreEqual(e, o);) e++, o++;
        for (; t >= e && r >= o && this.ElementsAreEqual(t, r);) t--, r--;
        if (e > t || o > r) {
          var a;
        ...
        do b = T + e, b === S || L > b && c[b - 1] < c[b + 1] ? (h = c[b + 1], g = h - T - o, x > h && E.MarkNextChange(),
          x = h, E.AddModifiedElement(h + 1, g), T = b + 1 - e) : (h = c[b - 1] + 1, g = h - T - o, x > h && E.MarkNextChange(),
          x = h - 1, E.AddOriginalElement(h, g + 1), T = b - 1 - e), N >= 0 && (c = this.m_forwardHistory[N], e = c[0],
          S = 1, L = c.length - 1); while (--N >= -1);
        if (C = E.getReverseChanges(), _[0]) {
          ...
          do b = T + r, b === S || L > b && d[b - 1] >= d[b + 1] ? (h = d[b + 1] - 1, g = h - T - l, h > x && E.MarkNextChange(),
            x = h + 1, E.AddOriginalElement(h + 1, g + 1), T = b + 1 - r) : (h = d[b - 1], g = h - T - l, h > x && E.MarkNextChange(),
            x = h, E.AddModifiedElement(h + 1, g + 1), T = b - 1 - r), N >= 0 && (d = this.m_reverseHistory[N], r = d[
            0], S = 1, L = d.length - 1); while (--N >= -1);
          w = E.getChanges()
        }
        ...
        for (h = 1; v / 2 + 1 >= h; h++) {
          ...
          for (p = this.ClipDiagonalBound(C - h, h, C, y), f = this.ClipDiagonalBound(C + h, h, C, y), x = p; f >= x; x +=
            ...
            for (c = x === p || f > x && _[x - 1] < _[x + 1] ? _[x + 1] : _[x - 1] + 1, d = c - (x - C) - E, N = c; t >
              c && s > d && this.ElementsAreEqual(c + 1, d + 1);) c++, d++;
            if (_[x] = c, c + d > M + k && (M = c, k = d), !T && Math.abs(x - w) <= h - 1 && c >= b[x]) return a[0] =
              c, u[0] = d, N <= b[x] && r > 0 && r + 1 >= h ? this.WALKTRACE(C, p, f, E, w, g, m, S, _, b, c, t, a, d,
                s, u, T, l) : null
          }
          var I = (M - e + (k - i) - h) / 2;
          if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(M, this.OriginalSequence,
            I)) return l[0] = !0, a[0] = M, u[0] = k, I > 0 && r > 0 && r + 1 >= h ? this.WALKTRACE(C, p, f, E, w, g,
            m, S, _, b, c, t, a, d, s, u, T, l) : (e++, i++, [new n.DiffChange(e, t - e + 1, i, s - i + 1)]);
          for (g = this.ClipDiagonalBound(w - h, h, w, y), m = this.ClipDiagonalBound(w + h, h, w, y), x = g; m >= x; x +=
            ...
            for (c = x === g || m > x && b[x - 1] >= b[x + 1] ? b[x + 1] - 1 : b[x - 1], d = c - (x - w) - S, N = c; c >
              e && d > i && this.ElementsAreEqual(c, d);) c--, d--;
            if (b[x] = c, T && Math.abs(x - C) <= h && c <= _[x]) return a[0] = c, u[0] = d, N >= _[x] && r > 0 && r +
              1 >= h ? this.WALKTRACE(C, p, f, E, w, g, m, S, _, b, c, t, a, d, s, u, T, l) : null
          }
          if (r >= h) {
...
define("vs/editor/diff/diffComputer", ["require", "exports", "vs/base/diff/diff"], function(e, t, n) {
  function i(e) {
    ...
    var t, n, i, o, s, a, u = [e[0]],
      l = u[0];
    for (t = 1, n = e.length; n > t; t++) a = e[t], i = a.originalStart - (l.originalStart + l.originalLength), o = a
      .modifiedStart - (l.modifiedStart + l.modifiedLength), s = Math.min(i, o), r > s ? (l.originalLength = a.originalStart +
        a.originalLength - l.originalStart, l.modifiedLength = a.modifiedStart + a.modifiedLength - l.modifiedStart) :
      (u.push(a), l = a);
    return u
  }
  var o = 2e3,
    ...
    a = function(e) {
      function t(t, n) {
        var i, o, r, s, a, u = "",
          l = [],
          c = [];
        for (r = 0, i = 0, o = t.length; o > i; i++) u += t[i], s = 1, a = t[i].length + 1, n && (s = this._getFirstNonBlankColumn(
          t[i], 1), a = this._getLastNonBlankColumn(t[i], 1)), l.push({
          offset: r + s - 1,
          lineNumber: i + 1,
          column: s
        }), c.push({
      ...
      return __extends(t, e), t.prototype._getFirstNonBlankColumn = function(e, t) {
    ...
    u = function() {
      function e(e, t, n) {
        0 === e.originalLength ? (this.originalStartLineNumber = 0, this.originalStartColumn = 0, this.originalEndLineNumber =
          0, this.originalEndColumn = 0) : (this.originalStartLineNumber = t.getStartLineNumber(e.originalStart),
          this.originalStartColumn = t.getStartColumn(e.originalStart), this.originalEndLineNumber = t.getEndLineNumber(
            e.originalStart + e.originalLength - 1), this.originalEndColumn = t.getEndColumn(e.originalStart + e.originalLength -
            1)), 0 === e.modifiedLength ? (this.modifiedStartLineNumber = 0, this.modifiedStartColumn = 0, this.modifiedEndLineNumber =
          0, this.modifiedEndColumn = 0) : (this.modifiedStartLineNumber = n.getStartLineNumber(e.modifiedStart),
          this.modifiedStartColumn = n.getStartColumn(e.modifiedStart), this.modifiedEndLineNumber = n.getEndLineNumber(
            e.modifiedStart + e.modifiedLength - 1), this.modifiedEndColumn = n.getEndColumn(e.modifiedStart + e.modifiedLength -
            1))
      }
      return e
    }(),
    l = function() {
      function e(e, t, o, r, s) {
        if (0 === e.originalLength ? (this.originalStartLineNumber = t.getStartLineNumber(e.originalStart) - 1, this.originalEndLineNumber =
          0) : (this.originalStartLineNumber = t.getStartLineNumber(e.originalStart), this.originalEndLineNumber =
          t.getEndLineNumber(e.originalStart + e.originalLength - 1)), 0 === e.modifiedLength ? (this.modifiedStartLineNumber =
          o.getStartLineNumber(e.modifiedStart) - 1, this.modifiedEndLineNumber = 0) : (this.modifiedStartLineNumber =
          o.getStartLineNumber(e.modifiedStart), this.modifiedEndLineNumber = o.getEndLineNumber(e.modifiedStart +
            e.modifiedLength - 1)), 0 !== e.originalLength && 0 !== e.modifiedLength && r()) {
          var a = t.getCharSequence(e.originalStart, e.originalStart + e.originalLength - 1),
            l = o.getCharSequence(e.modifiedStart, e.modifiedStart + e.modifiedLength - 1),
            c = new n.LcsDiff(a, l, r),
            d = c.ComputeDiff();
          s && (d = i(d)), this.charChanges = [];
    ...
    c = function() {
      function e(e, t, n, i) {
        this.shouldPostProcessCharChanges = n || !1, this.shouldIgnoreTrimWhitespace = i || !1, this.maximumRunTimeMs =
          o, this.original = new a(e, this.shouldIgnoreTrimWhitespace), this.modified = new a(t, this.shouldIgnoreTrimWhitespace)
      }
      return e.prototype.computeDiff = function() {
        this.computationStartTime = (new Date).getTime();
        for (var e = new n.LcsDiff(this.original, this.modified, this._continueProcessingPredicate.bind(this)), t = e
            .ComputeDiff(), i = [], o = 0, r = t.length; r > o; o++) i.push(new l(t[o], this.original, this.modified,
          this._continueProcessingPredicate.bind(this), this.shouldPostProcessCharChanges));
        return i
...
}), define("vs/editor/worker/modesWorker", ["require", "exports", "vs/base/lib/winjs.base",
  "vs/editor/diff/diffComputer", "vs/editor/modes/modesFilters", "vs/editor/core/model/textModel"
], function(e, t, n, i, o, r) {
  var s = function() {
    function e() {
    ...
    return e.prototype.injectPublisherService = function(e) {
      ...
      if (i) t.startColumn === t.endColumn && (t.endColumn += 1), o = r.getValueInRange(t), s.range = t;
      else {
        var a = {
      ...
      for (t = 1, i = o.getLineCount(); i >= t; t++) {
        for (p = o.getLineContent(t), f = 0, g = p.length, m = null, v = 0, y = a; g > f;) _ = p.charAt(f), C = !1, y ===
          l ? (" " === _ || "	" === _ || _ === m) && (r.push(this.createLink(p, t, v, f)), C = !0) : y === u ? " " ===
          _ || "	" === _ || _ === m ? C = !0 : y = l : s[y].hasOwnProperty(_) ? y = s[y][_] : C = !0, C && (y = a, v =
            f + 1, b = p.charCodeAt(f), m = b < d.length ? d[b] : _), f++;
  ...
  var h = function() {
    ...
    return e.prototype.injectPublisherService = function(e) {
      ...
      for (var e = this.resourceService.all(), t = [], n = 0, i = e.length; i > n; n++) e[n] instanceof c.MirrorModel &&
        t.push(e[n]);
    ...
    p = function() {
      function t() {
        var e = this;
        this.dispatcherService = new u.DispatcherService, this.modePromise = new n.Promise(function(t) {
          e.modeCompleteCallback = t
        })
      }
      return t.prototype.initialize = function(t, i, u, l, c) {
        var p = this;
        try {
          var f = {
          ...
          }, g = !c.workspace || !c.workspace.telemetry;
          ...
          e([c.languageModeModuleId], function(e) {
            if (m.injectTo(e.value), "function" == typeof e.value.setExtraData && e.value.setExtraData(c.extraData ||
              ...
              for (var o = [], r = function(n) {
                ...
                }, s = 0; s < c.participants.length; s++) o.push(new n.Promise(r(c.participants[s])));
              n.Promise.join(o).then(function() {
                p.modeCompleteCallback(e.value), i(null)
              }, function(t) {
                u(p._transformError(t)), p.modeCompleteCallback(e.value), i(null)
              })
            } else p.modeCompleteCallback(e.value), i(null)
          })
        } catch (v) {
          u(this._transformError(v))
        }
      }, t.prototype.request = function(e, t, n, i, o) {
        o.mainThread = e, this.dispatcherService.dispatch(o).then(t, n, i)
        ...
        e.loadModule(s.moduleId, function(e) {
          ...
          t.addWorkerParticipant(a), n(null)
        }, o)
      }, t.prototype._transformError = function(e) {
        var t = {};
        return e.stacktrace ? t.stack = e.stacktrace.split("\n") : e.stack && (t.stack = e.stack.split("\n")), t.message =
          e.toString(), t
      }, t
    }();
  t.EditorWorkerServer = p, t.value = new p
  ...
  function i(e) {
    ...
    e[e.Ignore = 0] = "Ignore", e[e.Info = 1] = "Info", e[e.Warning = 2] = "Warning", e[e.Error = 4] = "Error"
  }(t.Severity || (t.Severity = {}));
  var o = t.Severity,
    r = "error",
    s = "warning",
