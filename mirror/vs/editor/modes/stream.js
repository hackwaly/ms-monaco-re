define(["require", "exports"], function(a, b) {
  var c = function() {
    ...
    a.prototype.stringToArray = function(a) {
      var b = 0;
    ...
    a.prototype.advance = function(a) {
      ...
      return this._source.substring(b, this._pos);
    };
    ...
    a.prototype.advanceToEOS = function() {
      ...
      return this._source.substring(a, this._pos);
    };
    ...
    a.prototype.createPeeker = function(a) {
      ...
      if ((a instanceof String || typeof a == "string") && a) {
        return function() {
          var c = a.length;

          var d = b._pos + c <= b.sourceLength;
          for (var e = 0; d && e < c; e++) {
            d = b._source.charCodeAt(b._pos + e) === a.charCodeAt(e);
          }
          return d ? c : 0;
        };
      }
    ...
    a.prototype.advanceIf = function(a) {
      ...
      if (a instanceof RegExp) {
        ...
        if (d) {
          if (d.index === 0) {
            return this.advance(d[0].length);
          }
        ...
        var f = b + e <= this.sourceLength;
        for (var g = 0; f && g < e; g++) {
          f = c.charCodeAt(b + g) === a.charCodeAt(g);
        }
        if (f) {
          return this.advance(a.length);
        }
      }
      return "";
    };
    ...
    a.prototype.setTokenRules = function(a, b) {
      if (this.separators !== a || this.whitespace !== b) {
        this.separators = a;
        this.separatorsArr = this.stringToArray(this.separators);
        this.whitespace = b;
        this.whitespaceArr = this.stringToArray(this.whitespace);
    ...
    a.prototype.peekToken = function() {
      ...
      var b = this.sourceLength;

      var c = this.whitespaceArr;

      var d = this.separatorsArr;

      var e = this._pos;
      if (e >= b) throw new Error("Stream is at the end");
      while (c[a.charCodeAt(e)] && e < b) {
        e++;
      }
      var f = e;
      if (d[a.charCodeAt(f)] && f < b) {
        f++;
      } else
        while (!d[a.charCodeAt(f)] && !c[a.charCodeAt(f)] && f < b) {
          f++;
        }
      this.tokenStart = e;
    ...
    a.prototype.nextToken = function() {
      if (this._pos >= this.sourceLength) throw new Error("Stream is at the end");
      var a;
      this.tokenStart === -1 ? a = this.peekToken() : a = this._source.substring(this.tokenStart, this.tokenEnd);
