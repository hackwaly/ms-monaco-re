define("vs/editor/modes/monarch/monarch", ["require", "exports", "vs/platform/platform", "vs/editor/modes/stream",
  ...
  function h(e, t, n, i) {
    ...
    if (e.autoIndent) {
      ...
      for (o = 0; o < e.autoIndent.length; o++)
        if (!e.autoIndent[o].match || e.autoIndent[o].match.test(r.pre)) return !e.autoIndent[o].matchAfter || e.autoIndent[
          o].matchAfter.test(r.post) ? {
          indentAction: 2
        } : {
          indentAction: 1
        };
    ...
    var s = [];
    for (o = 0; o < n.length && n[o].startIndex < i; o++) 1 === n[o].bracket ? s.push(o) : -1 === n[o].bracket && s.length >
      0 && s.pop();
    if (0 === s.length) return null;
    var a = s.pop();
    if (e.noindentBrackets) {
      var u = d(t, n, a);
      if (e.noindentBrackets.test(u)) return null;
    }
  ...
  function p(e, t, n, i) {
    ...
    for (var h = 0, p = 0, f = 0; f < n.length && !(n[f].startIndex > i); f++) h = n[f].startIndex;
  ...
  function m(e, t) {
    if (!e || void 0 === e.getMode) return null;
    var n = e.getMode(t);
    if (n) return n;
  ...
  function v(e) {
    ...
    if (b[e]) return b[e].mode;
    var i;
    for (i in b)
      if (b.hasOwnProperty(i))
        for (var o = b[i], s = 0; s < o.mimeTypes.length; s++)
          if (o.mimeTypes[s] === e) return o.mode;
    return null;
  }
  var y = function(e) {
    function t(n, i, o, r) {
    ...
    t.prototype.equals = function(n) {
      ...
      var o;
      for (o in this.stack)
        if (this.stack.hasOwnProperty(o) && this.stack[o] !== i.stack[o]) return !1;
      return !0;
    };
    ...
    t.prototype.tokenize = function(e, t) {
      ...
      var d = null;
      if (this.groupActions) i = this.groupActions.length;
      ...
      0 === this.groupActions.length && (this.groupActions = null, this.groupMatches = null, this.groupMatched = null,
        this.groupRule = null);
      else {
        if (e.eos()) return {
          type: ""
        ...
        } else s.throwError(this.lexer, "tokenizer state is not defined: " + o);
      }
      ...
      var v = null;
      if ("string" == typeof u || u instanceof Array) v = u;
      else if (u.group) v = u.group;
        ...
        if (v = u.token, u.tokenSubst && (v = s.substituteMatches(this.lexer, v, a, r, o)), u.nextEmbedded && ("@pop" ===
          ...
          c = null;
        } else if (u.transform && "function" == typeof u.transform) this.stack = u.transform(this.stack);

        c = null;
        else if (u.next)
          if ("@push" === u.next) this.stack.length >= this.lexer.maxStack ? s.throwError(this.lexer,
          ...
          else if ("@pop" === u.next) this.stack.length <= 1 ? s.throwError(this.lexer,
          "trying to pop an empty stack in rule: " + d.name) : this.stack.shift();
      ...
      if (null === v && (s.throwError(this.lexer, "lexer rule has no well-defined action in rule: " + d.name), v =
        ...
        for (var _ = 0, b = 1; b < r.length; b++) _ += r[b].length;
      ...
      if ("@rematch" === v && (e.goBack(a.length), a = "", r = null, v = ""), 0 === a.length)
        ...
        } else s.throwError(this.lexer, "no progress in tokenizer in rule: " + d.name);
  ...
  var _ = function(e) {
    ...
    t.prototype.getLeavingNestedModeData = function(e, t) {
      for (var n = t, o = new i.LineStream(e); !o.eos() && n.embeddedMode;) n.tokenize(o, !0);
