define('vs/editor/modes/monarch/monarchCompile', [
  'require',
  'exports',
  'vs/base/objects',
  'vs/editor/modes/modes',
  ...
  function c(e, t) {
    ...
    for (var n = 0; t.indexOf('@') >= 0 && 5 > n;)
      n++, t = t.replace(/@(\w+)/g, function(n, i) {
        var r = '';
        return 'string' == typeof e[i] ? r = e[i] : e[i] && e[i] instanceof RegExp ? r = e[i].source : void 0 === e[
          i] ? o.throwError(e, 'language definition does not contain attribute \'' + i + '\', used at: ' + t) : o.throwError(
          e, 'attribute reference \'' + i + '\' must be a string, used at: ' + t), o.empty(r) ? '' : '(?:' + r +
          ')';
      });
  ...
  function h(e, t, i, s) {
    ...
    if ('~' !== h && '!~' !== h || !/^(\w|\|)*$/.test(p))
      if ('@' === h || '!@' === h) {
        var g = e[p];
        g || o.throwError(e, 'the @ match target \'' + p + '\' is not defined, in rule: ' + t), r(function(e) {
          return 'string' == typeof e;
    ...
    if (n) {
      ...
      if (n.token || '' === n.token) {
        if ('string' != typeof n.token)
          return o.throwError(e, 'a \'token\' attribute must be of type string, in rule: ' + t), {
            token: ''
          };
        var i = {
          token: n.token
        ...
        if (n.token.indexOf('$') >= 0 && (i.tokenSubst = !0), 'string' == typeof n.bracket && ('@open' === n.bracket ?
          ...
          if ('string' != typeof n.next)
            ...
            /^(@pop|@push|@popall)$/.test(r) || ('@' === r[0] && (r = r.substr(1)), r.indexOf('$') < 0 && (o.stateExists(
              ...
              '\' is not defined in rule: ' + t))), i.next = r;
          }
        return 'number' == typeof n.goBack && (i.goBack = n.goBack), 'string' == typeof n.switchTo && (i.switchTo = n
          .switchTo), 'string' == typeof n.log && (i.log = n.log), 'string' == typeof n.nextEmbedded && (i.nextEmbedded =
          n.nextEmbedded, e.usesEmbedded = !0), i;
      }
  ...
  function f(e) {
      ...
      for (c in l)
        if (l.hasOwnProperty(c)) {
          var d = l[c],
            h = d.include;
          if (h)
            'string' != typeof h && o.throwError(n, 'an \'include\' attribute must be a string at: ' + r), '@' === h[
              0] && (h = h.substr(1)), e.tokenizer[h] || o.throwError(n, 'include target \'' + h +
              '\' is not defined at: ' + r), t(r + '.' + h, u, e.tokenizer[h]);
          else {
            var p = new g(r);
            if (d instanceof Array && d.length >= 1 && d.length <= 3)
              ...
              d.regex || o.throwError(n,
                'a rule must either be an array, or an object with a \'regex\' or \'include\' field at: ' + r), d.name &&
                (p.name = a(d.name)), d.matchOnlyAtStart && (p.matchOnlyAtLineStart = s(d.matchOnlyAtLineStart)), p.setRegex(
                i, d.regex), p.setAction(i, d.action);
            u.push(p);
          }
        }
    }
    ...
    var n = {};
    n.name = e.name, n.displayName = a(e.displayName, n.name), n.logConsole = a(e.logConsole), n.noThrow = !1, n.maxStack =
      100, n.mimeTypes = l(e.mimeTypes, void 0, function() {
        o.throwError(n, 'the attribute \'mimeTypes\' must be defined as an array of strings');
      }), n.start = a(e.start), n.fileExtensions = l(e.fileExtensions), n.ignoreCase = s(e.ignoreCase, !1), n.lineComment =
      a(e.lineComment, '//'), n.blockCommentStart = a(e.blockCommentStart, '/*'), n.blockCommentEnd = a(e.blockCommentEnd,
        '*/'), n.tokenPostfix = a(e.tokenPostfix, '.' + n.name), n.defaultToken = a(e.defaultToken, 'source',
        function() {
          o.throwError(n, 'the \'defaultToken\' must be a string');
        }), n.editorOptions = e.editorOptions ? e.editorOptions : null, n.workerScriptPath = a(e.workerScriptPath), n
      .usesEmbedded = !1, n.wordDefinition = e.wordDefinition || void 0, !n.lineComment && e.lineComments && (
        'string' == typeof e.lineComments ? n.lineComment = e.lineComments : 'string' == typeof e.lineComments[0] &&
        (n.lineComment = e.lineComments[0]));
    var i = e;
    i.name = n.name, i.displayName = n.displayName, i.ignoreCase = n.ignoreCase, i.noThrow = n.noThrow, i.usesEmbedded =
      n.usesEmbedded, i.stateNames = e.tokenizer, i.logConsole = n.logConsole, i.defaultToken = n.defaultToken, e.tokenizer &&
      'object' == typeof e.tokenizer || o.throwError(n,
        'a language definition must define the \'tokenizer\' attribute as an object'), n.tokenizer = [];
    var r;
    for (r in e.tokenizer)
      if (e.tokenizer.hasOwnProperty(r)) {
        n.start || (n.start = r);
        var d = e.tokenizer[r];
        n.tokenizer[r] = new Array(), t('tokenizer.' + r, n.tokenizer[r], d);
      }
    n.usesEmbedded = i.usesEmbedded, n.nonWordTokens = l(e.nonWordTokens, [
      'delimiter',
    ...
    for (var f in e.brackets)
      if (e.brackets.hasOwnProperty(f)) {
        ...
        m && m instanceof Array && 3 === m.length && (m = {
          ...
          open: m[0],
          close: m[1]
        }), m.open === m.close && o.throwError(n,
          'open and close brackets in a \'brackets\' attribute must be different: ' + m.open +
          '\n hint: use the \'bracket\' attribute if matching on equal brackets is required.'), 'string' == typeof m.open &&
          'string' == typeof m.token ? p.push({
    ...
    return n.electricChars = T.join('') + a(e.outdentTriggers, ''), n.logConsole || (n.logConsole = 'monarchConsole'),
      n.noThrow = !0, n;
  }
  var g = function() {
    function e(e) {
    ...
    return e.prototype.setRegex = function(e, t) {
      ...
      'string' == typeof t ? n = t : t instanceof RegExp ? n = t.source : o.throwError(e,
        'rules must start with a match string or regular expression: ' + this.name), this.matchOnlyAtLineStart = n.length >
        0 && '^' === n[0], this.name = this.name + ': ' + n, this.regex = c(e, '^(?:' + (this.matchOnlyAtLineStart ?
          n.substr(1) : n) + ')');
