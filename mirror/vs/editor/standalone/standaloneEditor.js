...
define(["require", "exports", "vs/editor/core/codeEditorWidget", "vs/editor/diff/diffEditorWidget",
  ...
  var p = c,
    ...
    C = function(a) {
      ...
      return __extends(b, a), b.prototype.getPath = function(a, b) {
        return b.toExternal()
      }, b
    ...
    D = function() {
      ...
      return a.create = function(b) {
        ...
        return y.create(c)
      }, a.markerService = new z.MarkerService, a.messageService = new s.SimpleMessageService, a.contextService = new u
        .BaseContextService({
          uri: null,
          name: null,
        ...
        }), a.requestService = new C, a
    }(),
    E = B.Registry.as(A.Extensions.EditorModes);
  D.create().injectTo(E);
  var F = function(a) {
    function c(c, d) {
      this._editorService = new s.SimpleEditorService(this), this._handlerService = new t.HandlerService(c), this._telemetryService =
        v.nullService, d = d || {}, d.enableTelemetry && (this._telemetryService = new v.TelemetryService);
      var e = {
    ...
    return __extends(c, a), c.prototype.destroy = function() {
      a.prototype.destroy.call(this), this._handlerService.dispose()
      ...
      var b = this.getModel();
      a.prototype._detachModel.call(this), b && this._ownsModel && (b.destroy(), this._ownsModel = !1)
    }, c
  }(p.CodeEditorWidget);
  b.create = G, b.createModel = H, b.createTerminalModel = I, b.createDiffEditor = J, b.createTerminal = K, b.getOrCreateMode =
    L;
  var M = self;
  M.Monaco || (M.Monaco = {});
  var N = M.Monaco;
  N.Editor || (N.Editor = {}), N.Editor.create = b.create, N.Editor.createModel = b.createModel, N.Editor.createTerminalModel =
    b.createTerminalModel, N.Editor.CodeEditor = F, N.Editor.createDiffEditor = b.createDiffEditor, N.Editor.createTerminal =
    b.createTerminal, N.Editor.getOrCreateMode = b.getOrCreateMode
})