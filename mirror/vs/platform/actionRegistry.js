define('vs/platform/actionRegistry', [
  'require',
  'exports',
  ...
  var l = function(e) {
    function t(t, n, i) {
      for (var o = [], r = 0; r < arguments.length - 3; r++)
        o[r] = arguments[r + 3];
      e.call(this, n, i), this._entryPointModule = t, this.appendStaticArguments(o);
    }
    return __extends(t, e), Object.defineProperty(t.prototype, 'entryPointModule', {
      get: function() {
  ...
  var c = function(t) {
    function n(e, n, i, o, r, s) {
      'undefined' == typeof o && (o = ''), 'undefined' == typeof r && (r = ''), 'undefined' == typeof s && (s = !0),
        t.call(this, i, o, r, s), this._instantiationService = e, this._descriptor = n;
    }
    return __extends(n, t), Object.defineProperty(n.prototype, 'cachedAction', {
      get: function() {
      ...
      var t = this,
        n = r.TPromise.as(void 0);
      return this._descriptor instanceof l && (n = new r.TPromise(function(n) {
        ...
        return s.ok(e instanceof o.Action, 'Action must be an instanceof Base Action'), t._cachedAction = e, t._emitterUnbind =
          t.addEmitter(t._cachedAction), e;
      });
    }, n.prototype.dispose = function() {
      this._emitterUnbind && this._emitterUnbind(), this._cachedAction && this._cachedAction.dispose(), t.prototype.dispose
        .call(this);
    }, n;
  }(o.Action);
  t.DeferredAction = c;
