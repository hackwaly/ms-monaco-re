define("vs/platform/contextview/contextviewService", ["require", "exports",
  "vs/base/ui/widgets/contextview/contextview", "vs/platform/contextview/contextmenu"
], function(e, t, n, i) {
  var o = function() {
    function e(e) {
      this.contextView = new n.ContextView(e);

      this.contextMenuHandler = new i.ContextMenuHandler(e);
    }
    ...
    e.prototype.setContainer = function(e) {
      ...
      this.contextMenuHandler.setContainer(e);
    };
