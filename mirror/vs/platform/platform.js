define('vs/platform/platform', [
  ...
  var s = function() {
    ...
    }, e.prototype.assertType = function() {}, e.prototype.describes = function(e) {
  ...
  var a = function() {
    function t(e, t, n) {
      'undefined' == typeof n && (n = []), r.ok(!o.isUndefinedOrNull(e), 'deferred desc must have a moduleId'), r.ok(!
        o.isUndefinedOrNull(t), 'deferred desc must have a ctorName'), this.moduleId = e, this.ctorName = t, this.payload =
        n;
    }
    return t.prototype.getModuleId = function() {
      ...
      return this.payload;
    }, t.prototype.assertType = function() {}, t.prototype.loadAndCreate = function(t) {
      var o, r = this;
      ...
      if (o.isUndefinedOrNull(e[this.ctorName]))
        throw new Error('module ' + this.moduleId + ' does not export ' + this.ctorName);
      var n = this.payload.slice(0);
      n.unshift(e[this.ctorName]);
      var i = o.create.apply(null, n);
      return t && t.injectTo(i), this.assertType(i), i;
  ...
  var u = function(t) {
    function r(e, n, i, r) {
      t.call(this, n, i, r), this.entryModuleIds = o.isString(e) ? [e] : e;
    }
    return __extends(r, t), r.prototype.loadAndCreate = function(t) {
      var r, s = this;
      return new i.Promise(function(n, i) {
        e(s.entryModuleIds, function() {
          e([s.getModuleId()], function(e) {
            ...
            t && t.injectTo(u), s.assertType(u), n(u);
          });
        });
      }, function() {
        r = n.canceled();
  ...
  var l = function() {
    ...
    return e.prototype.add = function(e, t) {
      r.ok(o.isString(e)), r.ok(o.isObject(t)), r.ok(!this.data.hasOwnProperty(e),
        'There is already an extension with this id'), this.data[e] = t;
